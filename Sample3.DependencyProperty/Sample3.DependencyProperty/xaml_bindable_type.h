...
namespace winrt
{
    // TODO : need a xaml_type that doesn't implement INotifyPropertyChanged? -> controls and objects used in XAML that aren't observable
    // TODO : need a xaml_type that ONLY implements INotifyPropertyChanged? -> ViewModels
    ...
    protected:
        ...
        void InitializeComponent(hstring const& uri)
        {
