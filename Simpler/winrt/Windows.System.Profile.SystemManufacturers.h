...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Profile::SystemManufacturers::OemSupportInfo, U>
    {
        static xaml_binding bind(Windows::System::Profile::SystemManufacturers::OemSupportInfo const& object, hstring const& name)
        {
            if (name == L"SupportLink") return
            {
                [object] { return object.SupportLink(); }
            };
            if (name == L"SupportAppLink") return
            {
                [object] { return object.SupportAppLink(); }
            };
            if (name == L"SupportProvider") return
            {
                [object] { return object.SupportProvider(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Profile::SystemManufacturers::SystemSupportDeviceInfo, U>
    {
        static xaml_binding bind(Windows::System::Profile::SystemManufacturers::SystemSupportDeviceInfo const& object, hstring const& name)
        {
