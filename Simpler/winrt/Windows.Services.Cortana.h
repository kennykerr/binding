...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Services::Cortana::CortanaActionableInsights, U>
    {
        static xaml_binding bind(Windows::Services::Cortana::CortanaActionableInsights const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Services::Cortana::CortanaActionableInsightsOptions, U>
    {
        static xaml_binding bind(Windows::Services::Cortana::CortanaActionableInsightsOptions const& object, hstring const& name)
        {
            ...
            if (name == L"SurroundingText") return
            {
                [object] { return object.SurroundingText(); },
                [object](auto&& value) { object.SurroundingText(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::Cortana::CortanaSettings, U>
    {
        static xaml_binding bind(Windows::Services::Cortana::CortanaSettings const& object, hstring const& name)
        {
            if (name == L"HasUserConsentToVoiceActivation") return
            {
                [object] { return object.HasUserConsentToVoiceActivation(); }
            };
            if (name == L"IsVoiceActivationEnabled") return
            {
                [object] { return object.IsVoiceActivationEnabled(); },
                [object](auto&& value) { object.IsVoiceActivationEnabled(value); }
            };
            return {};
        }
    };
