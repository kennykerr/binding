...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketCapabilities, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketCapabilities const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            };
            if (name == L"XmlNamespace") return
            {
                [object] { return object.XmlNamespace(); }
            };
            if (name == L"XmlNode") return
            {
                [object] { return object.XmlNode(); }
            };
            if (name == L"DocumentBindingFeature") return
            {
                [object] { return object.DocumentBindingFeature(); }
            };
            if (name == L"DocumentCollateFeature") return
            {
                [object] { return object.DocumentCollateFeature(); }
            };
            if (name == L"DocumentDuplexFeature") return
            {
                [object] { return object.DocumentDuplexFeature(); }
            };
            if (name == L"DocumentHolePunchFeature") return
            {
                [object] { return object.DocumentHolePunchFeature(); }
            };
            if (name == L"DocumentInputBinFeature") return
            {
                [object] { return object.DocumentInputBinFeature(); }
            };
            if (name == L"DocumentNUpFeature") return
            {
                [object] { return object.DocumentNUpFeature(); }
            };
            if (name == L"DocumentStapleFeature") return
            {
                [object] { return object.DocumentStapleFeature(); }
            };
            if (name == L"JobPasscodeFeature") return
            {
                [object] { return object.JobPasscodeFeature(); }
            };
            if (name == L"PageBorderlessFeature") return
            {
                [object] { return object.PageBorderlessFeature(); }
            };
            if (name == L"PageMediaSizeFeature") return
            {
                [object] { return object.PageMediaSizeFeature(); }
            };
            if (name == L"PageMediaTypeFeature") return
            {
                [object] { return object.PageMediaTypeFeature(); }
            };
            if (name == L"PageOrientationFeature") return
            {
                [object] { return object.PageOrientationFeature(); }
            };
            if (name == L"PageOutputColorFeature") return
            {
                [object] { return object.PageOutputColorFeature(); }
            };
            if (name == L"PageOutputQualityFeature") return
            {
                [object] { return object.PageOutputQualityFeature(); }
            };
            if (name == L"PageResolutionFeature") return
            {
                [object] { return object.PageResolutionFeature(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketFeature, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketFeature const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            ...
            if (name == L"SelectionType") return
            {
                [object] { return object.SelectionType(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketOption, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketOption const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketParameterDefinition, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketParameterDefinition const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            ...
            if (name == L"UnitType") return
            {
                [object] { return object.UnitType(); }
            };
            if (name == L"RangeMin") return
            {
                [object] { return object.RangeMin(); }
            };
            if (name == L"RangeMax") return
            {
                [object] { return object.RangeMax(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketParameterInitializer, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketParameterInitializer const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::PrintTicketValue, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::PrintTicketValue const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicketValidationResult, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicketValidationResult const& object, hstring const& name)
        {
            if (name == L"Validated") return
            {
                [object] { return object.Validated(); }
            };
