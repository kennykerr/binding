...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintCustomItemListOptionDetails2<D>::AddItem(param::hstring const& itemId, param::hstring const& displayName, param::hstring const& description, Windows::Storage::Streams::IRandomAccessStreamWithContentType const& icon) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintOptionDetails<D>::OptionType() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::OptionDetails::IPrintOptionDetails)->get_OptionType(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintOptionDetails<D>::State(Windows::Graphics::Printing::OptionDetails::PrintOptionStates const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintOptionDetails<D>::State() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::OptionDetails::IPrintOptionDetails)->get_State(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintOptionDetails<D>::TrySetValue(Windows::Foundation::IInspectable const& value) const
    {
        bool succeeded;
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintTaskOptionDetails<D>::OptionChanged(Windows::Foundation::TypedEventHandler<Windows::Graphics::Printing::OptionDetails::PrintTaskOptionDetails, Windows::Graphics::Printing::OptionDetails::PrintTaskOptionChangedEventArgs> const& eventHandler) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintTaskOptionDetails<D>::BeginValidation(Windows::Foundation::TypedEventHandler<Windows::Graphics::Printing::OptionDetails::PrintTaskOptionDetails, Windows::Foundation::IInspectable> const& eventHandler) const
    {
        winrt::event_token eventCookie;
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_OptionDetails_IPrintTaskOptionDetailsStatic<D>::GetFromPrintTaskOptions(Windows::Graphics::Printing::PrintTaskOptions const& printTaskOptions) const
    {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintBindingOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintBindingOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
            };
            if (name == L"OptionType") return
            {
                [object] { return object.OptionType(); }
            };
            ...
            if (name == L"State") return
            {
                ...
                [object](auto&& value) { object.State(value); }
            };
            ...
            if (name == L"WarningText") return
            {
                [object] { return object.WarningText(); },
                [object](auto&& value) { object.WarningText(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintBorderingOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintBorderingOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCollationOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCollationOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintColorModeOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintColorModeOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCopiesOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCopiesOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
            ...
            if (name == L"MinValue") return
            {
                [object] { return object.MinValue(); }
            };
            if (name == L"MaxValue") return
            {
                [object] { return object.MaxValue(); }
            };
            if (name == L"WarningText") return
            {
                [object] { return object.WarningText(); },
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCustomItemDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCustomItemDetails const& object, hstring const& name)
        {
            if (name == L"ItemId") return
            {
                [object] { return object.ItemId(); }
            };
            if (name == L"ItemDisplayName") return
            {
                [object] { return object.ItemDisplayName(); },
                [object](auto&& value) { object.ItemDisplayName(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCustomItemListOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCustomItemListOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCustomTextOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCustomTextOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
            ...
            if (name == L"MaxCharacters") return
            {
                [object] { return object.MaxCharacters(); },
                [object](auto&& value) { object.MaxCharacters(value); }
            };
            if (name == L"WarningText") return
            {
                [object] { return object.WarningText(); },
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintCustomToggleOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintCustomToggleOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintDuplexOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintDuplexOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintHolePunchOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintHolePunchOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintMediaSizeOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintMediaSizeOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintMediaTypeOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintMediaTypeOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintOrientationOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintOrientationOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintPageRangeOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintPageRangeOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintQualityOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintQualityOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintStapleOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintStapleOptionDetails const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintTaskOptionChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintTaskOptionChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"OptionId") return
            {
                [object] { return object.OptionId(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::OptionDetails::PrintTaskOptionDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::OptionDetails::PrintTaskOptionDetails const& object, hstring const& name)
        {
            if (name == L"Options") return
            {
                [object] { return object.Options(); }
            };
            if (name == L"DisplayedOptions") return
            {
                [object] { return object.DisplayedOptions(); }
            };
            return {};
        }
    };
