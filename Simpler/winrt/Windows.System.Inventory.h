...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Inventory::InstalledDesktopApp, U>
    {
        static xaml_binding bind(Windows::System::Inventory::InstalledDesktopApp const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"DisplayVersion") return
            {
                [object] { return object.DisplayVersion(); }
            };
            return {};
        }
    };
