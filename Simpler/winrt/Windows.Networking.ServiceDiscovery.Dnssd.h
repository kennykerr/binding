...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult, U>
    {
        static xaml_binding bind(Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult const& object, hstring const& name)
        {
            ...
            if (name == L"HasInstanceNameChanged") return
            {
                [object] { return object.HasInstanceNameChanged(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstance, U>
    {
        static xaml_binding bind(Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstance const& object, hstring const& name)
        {
            if (name == L"DnssdServiceInstanceName") return
            {
                [object] { return object.DnssdServiceInstanceName(); },
                [object](auto&& value) { object.DnssdServiceInstanceName(value); }
            };
            if (name == L"HostName") return
            {
                [object] { return object.HostName(); },
                [object](auto&& value) { object.HostName(value); }
            };
            if (name == L"Port") return
            {
                [object] { return object.Port(); },
                [object](auto&& value) { object.Port(value); }
            };
            ...
            if (name == L"TextAttributes") return
            {
                [object] { return object.TextAttributes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstanceCollection, U>
    {
        static xaml_binding bind(Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstanceCollection const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcher, U>
    {
        static xaml_binding bind(Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcher const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
