...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::ExtendedExecution::Foreground::ExtendedExecutionForegroundRevokedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ExtendedExecution::Foreground::ExtendedExecutionForegroundRevokedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::ExtendedExecution::Foreground::ExtendedExecutionForegroundSession, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ExtendedExecution::Foreground::ExtendedExecutionForegroundSession const& object, hstring const& name)
        {
