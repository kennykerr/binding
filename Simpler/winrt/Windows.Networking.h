...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Networking_IHostName<D>::Type() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Networking::IHostName)->get_Type(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Networking::EndpointPair, U>
    {
        static xaml_binding bind(Windows::Networking::EndpointPair const& object, hstring const& name)
        {
            if (name == L"LocalHostName") return
            {
                [object] { return object.LocalHostName(); },
                [object](auto&& value) { object.LocalHostName(value); }
            };
            if (name == L"LocalServiceName") return
            {
                [object] { return object.LocalServiceName(); },
                [object](auto&& value) { object.LocalServiceName(value); }
            };
            ...
            if (name == L"RemoteServiceName") return
            {
                ...
                [object](auto&& value) { object.RemoteServiceName(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Networking::HostName, U>
    {
        static xaml_binding bind(Windows::Networking::HostName const& object, hstring const& name)
        {
            if (name == L"IPInformation") return
            {
                [object] { return object.IPInformation(); }
            };
            if (name == L"RawName") return
            {
                [object] { return object.RawName(); }
            };
            if (name == L"DisplayName") return
            {
                [object] { return object.DisplayName(); }
            };
            if (name == L"CanonicalName") return
            {
                [object] { return object.CanonicalName(); }
            };
