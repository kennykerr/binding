...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Security_Authorization_AppCapabilityAccess_IAppCapability<D>::CheckAccess() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability)->CheckAccess(put_abi(result)));
        return result;
    }
    ...
    template <typename U> struct bindable<Windows::Security::Authorization::AppCapabilityAccess::AppCapability, U>
    {
        static xaml_binding bind(Windows::Security::Authorization::AppCapabilityAccess::AppCapability const& object, hstring const& name)
        {
            if (name == L"CapabilityName") return
            {
                [object] { return object.CapabilityName(); }
            };
