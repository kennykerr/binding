...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::UserProfile::AdvertisingManagerForUser, U>
    {
        static xaml_binding bind(Windows::System::UserProfile::AdvertisingManagerForUser const& object, hstring const& name)
        {
            if (name == L"AdvertisingId") return
            {
                [object] { return object.AdvertisingId(); }
            };
    ...
    template <typename U> struct bindable<Windows::System::UserProfile::AssignedAccessSettings, U>
    {
        static xaml_binding bind(Windows::System::UserProfile::AssignedAccessSettings const& object, hstring const& name)
        {
            if (name == L"IsEnabled") return
            {
                [object] { return object.IsEnabled(); }
            };
            if (name == L"IsSingleAppKioskMode") return
            {
                [object] { return object.IsSingleAppKioskMode(); }
            };
            if (name == L"User") return
            {
                [object] { return object.User(); }
    ...
    template <typename U> struct bindable<Windows::System::UserProfile::DiagnosticsSettings, U>
    {
        static xaml_binding bind(Windows::System::UserProfile::DiagnosticsSettings const& object, hstring const& name)
        {
            if (name == L"CanUseDiagnosticsToTailorExperiences") return
            {
                [object] { return object.CanUseDiagnosticsToTailorExperiences(); }
            };
            if (name == L"User") return
            {
                [object] { return object.User(); }
    ...
    template <typename U> struct bindable<Windows::System::UserProfile::FirstSignInSettings, U>
    {
        static xaml_binding bind(Windows::System::UserProfile::FirstSignInSettings const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::System::UserProfile::GlobalizationPreferencesForUser, U>
    {
        static xaml_binding bind(Windows::System::UserProfile::GlobalizationPreferencesForUser const& object, hstring const& name)
        {
            if (name == L"User") return
            {
                [object] { return object.User(); }
            };
            if (name == L"Calendars") return
            {
                [object] { return object.Calendars(); }
            };
            if (name == L"Clocks") return
            {
                [object] { return object.Clocks(); }
            };
            if (name == L"Currencies") return
            {
                [object] { return object.Currencies(); }
            };
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); }
            };
            if (name == L"HomeGeographicRegion") return
            {
                [object] { return object.HomeGeographicRegion(); }
            };
            if (name == L"WeekStartsOn") return
            {
                [object] { return object.WeekStartsOn(); }
            };
            return {};
        }
    };
