...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::DataProtection::UserDataBufferUnprotectResult, U>
    {
        static xaml_binding bind(Windows::Security::DataProtection::UserDataBufferUnprotectResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
            };
            if (name == L"UnprotectedBuffer") return
            {
                [object] { return object.UnprotectedBuffer(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::DataProtection::UserDataStorageItemProtectionInfo, U>
    {
        static xaml_binding bind(Windows::Security::DataProtection::UserDataStorageItemProtectionInfo const& object, hstring const& name)
        {
