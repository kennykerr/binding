...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScanner, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScanner const& object, hstring const& name)
        {
            if (name == L"DeviceId") return
            {
                [object] { return object.DeviceId(); }
            };
            if (name == L"DefaultScanSource") return
            {
                [object] { return object.DefaultScanSource(); }
            };
            if (name == L"FlatbedConfiguration") return
            {
                [object] { return object.FlatbedConfiguration(); }
            };
            if (name == L"FeederConfiguration") return
            {
                [object] { return object.FeederConfiguration(); }
            };
            if (name == L"AutoConfiguration") return
            {
                [object] { return object.AutoConfiguration(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScannerAutoConfiguration, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScannerAutoConfiguration const& object, hstring const& name)
        {
            if (name == L"DefaultFormat") return
            {
                [object] { return object.DefaultFormat(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScannerFeederConfiguration, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScannerFeederConfiguration const& object, hstring const& name)
        {
            if (name == L"DefaultFormat") return
            {
                [object] { return object.DefaultFormat(); }
            ...
            if (name == L"MinScanArea") return
            {
                [object] { return object.MinScanArea(); }
            };
            if (name == L"MaxScanArea") return
            {
                [object] { return object.MaxScanArea(); }
            };
            if (name == L"SelectedScanRegion") return
            {
                [object] { return object.SelectedScanRegion(); },
                [object](auto&& value) { object.SelectedScanRegion(value); }
            };
            if (name == L"AutoCroppingMode") return
            {
                [object] { return object.AutoCroppingMode(); },
                [object](auto&& value) { object.AutoCroppingMode(value); }
            };
            if (name == L"MinResolution") return
            {
                [object] { return object.MinResolution(); }
            };
            if (name == L"MaxResolution") return
            {
                [object] { return object.MaxResolution(); }
            };
            if (name == L"OpticalResolution") return
            {
                [object] { return object.OpticalResolution(); }
            };
            if (name == L"DesiredResolution") return
            {
                [object] { return object.DesiredResolution(); },
                [object](auto&& value) { object.DesiredResolution(value); }
            };
            if (name == L"ActualResolution") return
            {
                [object] { return object.ActualResolution(); }
            };
            if (name == L"DefaultColorMode") return
            {
                [object] { return object.DefaultColorMode(); }
            };
            ...
            if (name == L"MinBrightness") return
            {
                [object] { return object.MinBrightness(); }
            };
            if (name == L"MaxBrightness") return
            {
                [object] { return object.MaxBrightness(); }
            };
            if (name == L"BrightnessStep") return
            {
                [object] { return object.BrightnessStep(); }
            };
            if (name == L"DefaultBrightness") return
            {
                [object] { return object.DefaultBrightness(); }
            };
            ...
            if (name == L"MinContrast") return
            {
                [object] { return object.MinContrast(); }
            };
            if (name == L"MaxContrast") return
            {
                [object] { return object.MaxContrast(); }
            };
            if (name == L"ContrastStep") return
            {
                [object] { return object.ContrastStep(); }
            };
            if (name == L"DefaultContrast") return
            {
                [object] { return object.DefaultContrast(); }
            };
            if (name == L"Contrast") return
            {
                [object] { return object.Contrast(); },
                [object](auto&& value) { object.Contrast(value); }
            };
            if (name == L"CanAutoDetectPageSize") return
            {
                [object] { return object.CanAutoDetectPageSize(); }
            };
            if (name == L"AutoDetectPageSize") return
            {
                [object] { return object.AutoDetectPageSize(); },
                [object](auto&& value) { object.AutoDetectPageSize(value); }
            };
            ...
            if (name == L"PageOrientation") return
            {
                [object] { return object.PageOrientation(); },
                [object](auto&& value) { object.PageOrientation(value); }
            };
            if (name == L"PageSizeDimensions") return
            {
                [object] { return object.PageSizeDimensions(); }
            };
            if (name == L"MaxNumberOfPages") return
            {
                [object] { return object.MaxNumberOfPages(); },
                [object](auto&& value) { object.MaxNumberOfPages(value); }
            };
            if (name == L"CanScanDuplex") return
            {
                [object] { return object.CanScanDuplex(); }
            };
            ...
            if (name == L"CanScanAhead") return
            {
                [object] { return object.CanScanAhead(); }
            };
            if (name == L"ScanAhead") return
            {
                [object] { return object.ScanAhead(); },
                [object](auto&& value) { object.ScanAhead(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScannerFlatbedConfiguration, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScannerFlatbedConfiguration const& object, hstring const& name)
        {
            if (name == L"DefaultFormat") return
            {
                [object] { return object.DefaultFormat(); }
    ...
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScannerPreviewResult, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScannerPreviewResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Scanners::ImageScannerScanResult, U>
    {
        static xaml_binding bind(Windows::Devices::Scanners::ImageScannerScanResult const& object, hstring const& name)
        {
            if (name == L"ScannedFiles") return
            {
                [object] { return object.ScannedFiles(); }
            };
            return {};
        }
    };
