...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionControlGroup, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionControlGroup const& object, hstring const& name)
        {
            if (name == L"FrameProviderIds") return
            {
                [object] { return object.FrameProviderIds(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionCorrelation, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionCorrelation const& object, hstring const& name)
        {
            if (name == L"TargetId") return
            {
                [object] { return object.TargetId(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionCorrelationGroup, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionCorrelationGroup const& object, hstring const& name)
        {
            if (name == L"RelativeLocations") return
            {
                [object] { return object.RelativeLocations(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionFaceAuthenticationGroup, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionFaceAuthenticationGroup const& object, hstring const& name)
        {
            if (name == L"FrameProviderIds") return
            {
                [object] { return object.FrameProviderIds(); }
    ...
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionFrame, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionFrame const& object, hstring const& name)
        {
            ...
            if (name == L"FrameData") return
            {
                [object] { return object.FrameData(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionFrameProviderInfo, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionFrameProviderInfo const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"DeviceKind") return
            {
                ...
                [object](auto&& value) { object.DeviceKind(value); }
            };
            if (name == L"FrameKind") return
            {
                [object] { return object.FrameKind(); },
                [object](auto&& value) { object.FrameKind(value); }
            };
            if (name == L"Hidden") return
            {
                [object] { return object.Hidden(); },
                [object](auto&& value) { object.Hidden(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Perception::Provider::PerceptionPropertyChangeRequest, U>
    {
        static xaml_binding bind(Windows::Devices::Perception::Provider::PerceptionPropertyChangeRequest const& object, hstring const& name)
        {
