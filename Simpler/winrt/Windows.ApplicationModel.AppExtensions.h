...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_AppExtensions_IAppExtensionCatalog<D>::PackageInstalled(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::AppExtensions::AppExtensionCatalog, Windows::ApplicationModel::AppExtensions::AppExtensionPackageInstalledEventArgs> const& handler) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_AppExtensions_IAppExtensionCatalog<D>::PackageUpdated(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::AppExtensions::AppExtensionCatalog, Windows::ApplicationModel::AppExtensions::AppExtensionPackageUpdatedEventArgs> const& handler) const
    {
        winrt::event_token token;
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtension, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtension const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtensionPackageInstalledEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtensionPackageInstalledEventArgs const& object, hstring const& name)
        {
            if (name == L"AppExtensionName") return
            {
                [object] { return object.AppExtensionName(); }
            };
            if (name == L"Package") return
            {
                [object] { return object.Package(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtensionPackageStatusChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtensionPackageStatusChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"AppExtensionName") return
            {
                [object] { return object.AppExtensionName(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtensionPackageUninstallingEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtensionPackageUninstallingEventArgs const& object, hstring const& name)
        {
            if (name == L"AppExtensionName") return
            {
                [object] { return object.AppExtensionName(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtensionPackageUpdatedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtensionPackageUpdatedEventArgs const& object, hstring const& name)
        {
            if (name == L"AppExtensionName") return
            {
                [object] { return object.AppExtensionName(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::AppExtensions::AppExtensionPackageUpdatingEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::AppExtensions::AppExtensionPackageUpdatingEventArgs const& object, hstring const& name)
        {
            if (name == L"AppExtensionName") return
            {
                [object] { return object.AppExtensionName(); }
