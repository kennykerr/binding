...
{
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::TrimStartTime(Windows::Foundation::TimeSpan const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::TrimStopTime(Windows::Foundation::TimeSpan const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::AddAudioEffect(param::hstring const& activatableClassId, bool effectRequired, Windows::Foundation::Collections::IPropertySet const& configuration) const
    {
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::AddVideoEffect(param::hstring const& activatableClassId, bool effectRequired, Windows::Foundation::Collections::IPropertySet const& configuration) const
    {
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::PrepareFileTranscodeAsync(Windows::Storage::IStorageFile const& source, Windows::Storage::IStorageFile const& destination, Windows::Media::MediaProperties::MediaEncodingProfile const& profile) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder<D>::PrepareStreamTranscodeAsync(Windows::Storage::Streams::IRandomAccessStream const& source, Windows::Storage::Streams::IRandomAccessStream const& destination, Windows::Media::MediaProperties::MediaEncodingProfile const& profile) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder2<D>::PrepareMediaStreamSourceTranscodeAsync(Windows::Media::Core::IMediaSource const& source, Windows::Storage::Streams::IRandomAccessStream const& destination, Windows::Media::MediaProperties::MediaEncodingProfile const& profile) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder2<D>::VideoProcessingAlgorithm(Windows::Media::Transcoding::MediaVideoProcessingAlgorithm const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IMediaTranscoder2<D>::VideoProcessingAlgorithm() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Transcoding::IMediaTranscoder2)->get_VideoProcessingAlgorithm(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Media_Transcoding_IPrepareTranscodeResult<D>::FailureReason() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::Transcoding::IPrepareTranscodeResult)->get_FailureReason(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Media::Transcoding::MediaTranscoder, U>
    {
        static xaml_binding bind(Windows::Media::Transcoding::MediaTranscoder const& object, hstring const& name)
        {
            if (name == L"TrimStartTime") return
            {
                [object] { return object.TrimStartTime(); },
                [object](auto&& value) { object.TrimStartTime(value); }
            };
            if (name == L"TrimStopTime") return
            {
                [object] { return object.TrimStopTime(); },
                [object](auto&& value) { object.TrimStopTime(value); }
            };
            if (name == L"AlwaysReencode") return
            {
                [object] { return object.AlwaysReencode(); },
                [object](auto&& value) { object.AlwaysReencode(value); }
            };
            if (name == L"HardwareAccelerationEnabled") return
            {
                [object] { return object.HardwareAccelerationEnabled(); },
                [object](auto&& value) { object.HardwareAccelerationEnabled(value); }
            };
            if (name == L"VideoProcessingAlgorithm") return
            {
                [object] { return object.VideoProcessingAlgorithm(); },
                [object](auto&& value) { object.VideoProcessingAlgorithm(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Transcoding::PrepareTranscodeResult, U>
    {
        static xaml_binding bind(Windows::Media::Transcoding::PrepareTranscodeResult const& object, hstring const& name)
        {
            if (name == L"CanTranscode") return
            {
                [object] { return object.CanTranscode(); }
            };
            if (name == L"FailureReason") return
            {
                [object] { return object.FailureReason(); }
            };
            return {};
        }
    };
