...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_ApplicationModel_Search_Core_ISearchSuggestion<D>::Kind() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Search::Core::ISearchSuggestion)->get_Kind(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Search_Core_ISearchSuggestionManager<D>::SetLocalContentSuggestionSettings(Windows::ApplicationModel::Search::LocalContentSuggestionSettings const& settings) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Search_Core_ISearchSuggestionManager<D>::SetQuery(param::hstring const& queryText, param::hstring const& language, Windows::ApplicationModel::Search::SearchQueryLinguisticDetails const& linguisticDetails) const
    {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::Core::SearchSuggestion, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::Core::SearchSuggestion const& object, hstring const& name)
        {
            ...
            if (name == L"DetailText") return
            {
                [object] { return object.DetailText(); }
            };
            if (name == L"Image") return
            {
                [object] { return object.Image(); }
            };
            if (name == L"ImageAlternateText") return
            {
                [object] { return object.ImageAlternateText(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::Core::SearchSuggestionManager, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::Core::SearchSuggestionManager const& object, hstring const& name)
        {
            ...
            if (name == L"Suggestions") return
            {
                [object] { return object.Suggestions(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::Core::SearchSuggestionsRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::Core::SearchSuggestionsRequestedEventArgs const& object, hstring const& name)
        {
