...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::AsymmetricKeyAlgorithmProvider, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::AsymmetricKeyAlgorithmProvider const& object, hstring const& name)
        {
            if (name == L"AlgorithmName") return
            {
                [object] { return object.AlgorithmName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::CryptographicKey, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::CryptographicKey const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::EncryptedAndAuthenticatedData, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::EncryptedAndAuthenticatedData const& object, hstring const& name)
        {
            if (name == L"EncryptedData") return
            {
                [object] { return object.EncryptedData(); }
            };
            if (name == L"AuthenticationTag") return
            {
                [object] { return object.AuthenticationTag(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::HashAlgorithmProvider, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::HashAlgorithmProvider const& object, hstring const& name)
        {
            if (name == L"AlgorithmName") return
            {
                [object] { return object.AlgorithmName(); }
            };
            if (name == L"HashLength") return
            {
                [object] { return object.HashLength(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::KeyDerivationAlgorithmProvider, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::KeyDerivationAlgorithmProvider const& object, hstring const& name)
        {
            if (name == L"AlgorithmName") return
            {
                [object] { return object.AlgorithmName(); }
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::KeyDerivationParameters, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::KeyDerivationParameters const& object, hstring const& name)
        {
            if (name == L"KdfGenericBinary") return
            {
                [object] { return object.KdfGenericBinary(); },
                [object](auto&& value) { object.KdfGenericBinary(value); }
            };
            if (name == L"IterationCount") return
            {
                [object] { return object.IterationCount(); }
            };
            if (name == L"Capi1KdfTargetAlgorithm") return
            {
                [object] { return object.Capi1KdfTargetAlgorithm(); },
                [object](auto&& value) { object.Capi1KdfTargetAlgorithm(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::MacAlgorithmProvider, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::MacAlgorithmProvider const& object, hstring const& name)
        {
            if (name == L"AlgorithmName") return
            {
                [object] { return object.AlgorithmName(); }
            };
            if (name == L"MacLength") return
            {
                [object] { return object.MacLength(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Core::SymmetricKeyAlgorithmProvider, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Core::SymmetricKeyAlgorithmProvider const& object, hstring const& name)
        {
            if (name == L"AlgorithmName") return
            {
                [object] { return object.AlgorithmName(); }
            };
            if (name == L"BlockLength") return
            {
                [object] { return object.BlockLength(); }
            };
            return {};
        }
    };
