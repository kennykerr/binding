...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialGestureRecognizer, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialGestureRecognizer const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialHoldCanceledEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialHoldCanceledEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialHoldCompletedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialHoldCompletedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialHoldStartedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialHoldStartedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteraction, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteraction const& object, hstring const& name)
        {
            if (name == L"SourceState") return
            {
                [object] { return object.SourceState(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionController, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionController const& object, hstring const& name)
        {
            if (name == L"HasTouchpad") return
            {
                [object] { return object.HasTouchpad(); }
            };
            if (name == L"HasThumbstick") return
            {
                [object] { return object.HasThumbstick(); }
            };
            if (name == L"SimpleHapticsController") return
            {
                [object] { return object.SimpleHapticsController(); }
            };
            if (name == L"VendorId") return
            {
                [object] { return object.VendorId(); }
            };
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionControllerProperties, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionControllerProperties const& object, hstring const& name)
        {
            if (name == L"IsTouchpadTouched") return
            {
                [object] { return object.IsTouchpadTouched(); }
            };
            if (name == L"IsTouchpadPressed") return
            {
                [object] { return object.IsTouchpadPressed(); }
            };
            if (name == L"IsThumbstickPressed") return
            {
                [object] { return object.IsThumbstickPressed(); }
            };
            if (name == L"ThumbstickX") return
            {
                [object] { return object.ThumbstickX(); }
            };
            if (name == L"ThumbstickY") return
            {
                [object] { return object.ThumbstickY(); }
            };
            if (name == L"TouchpadX") return
            {
                [object] { return object.TouchpadX(); }
            };
            if (name == L"TouchpadY") return
            {
                [object] { return object.TouchpadY(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionDetectedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionDetectedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
            };
            if (name == L"Interaction") return
            {
                [object] { return object.Interaction(); }
            };
            if (name == L"InteractionSource") return
            {
                [object] { return object.InteractionSource(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionSource, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionSource const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"IsPointingSupported") return
            {
                [object] { return object.IsPointingSupported(); }
            };
            if (name == L"IsMenuSupported") return
            {
                [object] { return object.IsMenuSupported(); }
            };
            if (name == L"IsGraspSupported") return
            {
                [object] { return object.IsGraspSupported(); }
            };
            if (name == L"Controller") return
            {
                [object] { return object.Controller(); }
            };
            if (name == L"Handedness") return
            {
                [object] { return object.Handedness(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionSourceEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionSourceEventArgs const& object, hstring const& name)
        {
            if (name == L"State") return
            {
                [object] { return object.State(); }
            };
            if (name == L"PressKind") return
            {
                [object] { return object.PressKind(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionSourceLocation, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionSourceLocation const& object, hstring const& name)
        {
            if (name == L"Position") return
            {
                [object] { return object.Position(); }
            };
            if (name == L"Velocity") return
            {
                [object] { return object.Velocity(); }
            };
            if (name == L"Orientation") return
            {
                [object] { return object.Orientation(); }
            };
            if (name == L"PositionAccuracy") return
            {
                [object] { return object.PositionAccuracy(); }
            };
            if (name == L"AngularVelocity") return
            {
                [object] { return object.AngularVelocity(); }
            };
            if (name == L"SourcePointerPose") return
            {
                [object] { return object.SourcePointerPose(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionSourceProperties, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionSourceProperties const& object, hstring const& name)
        {
            if (name == L"SourceLossRisk") return
            {
                [object] { return object.SourceLossRisk(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialInteractionSourceState, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialInteractionSourceState const& object, hstring const& name)
        {
            ...
            if (name == L"IsPressed") return
            {
                [object] { return object.IsPressed(); }
            };
            if (name == L"Timestamp") return
            {
                [object] { return object.Timestamp(); }
            };
            if (name == L"IsSelectPressed") return
            {
                [object] { return object.IsSelectPressed(); }
            };
            if (name == L"IsMenuPressed") return
            {
                [object] { return object.IsMenuPressed(); }
            };
            if (name == L"IsGrasped") return
            {
                [object] { return object.IsGrasped(); }
            };
            if (name == L"SelectPressedValue") return
            {
                [object] { return object.SelectPressedValue(); }
            };
            if (name == L"ControllerProperties") return
            {
                [object] { return object.ControllerProperties(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialManipulationCanceledEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialManipulationCanceledEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialManipulationCompletedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialManipulationCompletedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialManipulationDelta, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialManipulationDelta const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialManipulationStartedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialManipulationStartedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialManipulationUpdatedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialManipulationUpdatedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialNavigationCanceledEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialNavigationCanceledEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialNavigationCompletedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialNavigationCompletedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
            };
            if (name == L"NormalizedOffset") return
            {
                [object] { return object.NormalizedOffset(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialNavigationStartedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialNavigationStartedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
            };
            if (name == L"IsNavigatingX") return
            {
                [object] { return object.IsNavigatingX(); }
            };
            if (name == L"IsNavigatingY") return
            {
                [object] { return object.IsNavigatingY(); }
            };
            if (name == L"IsNavigatingZ") return
            {
                [object] { return object.IsNavigatingZ(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialNavigationUpdatedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialNavigationUpdatedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialPointerInteractionSourcePose, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialPointerInteractionSourcePose const& object, hstring const& name)
        {
            if (name == L"Position") return
            {
                [object] { return object.Position(); }
            };
            if (name == L"ForwardDirection") return
            {
                [object] { return object.ForwardDirection(); }
            };
            if (name == L"UpDirection") return
            {
                [object] { return object.UpDirection(); }
            };
            if (name == L"Orientation") return
            {
                [object] { return object.Orientation(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialPointerPose, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialPointerPose const& object, hstring const& name)
        {
            if (name == L"Timestamp") return
            {
                [object] { return object.Timestamp(); }
            };
            if (name == L"Head") return
            {
                [object] { return object.Head(); }
            };
            if (name == L"Eyes") return
            {
                [object] { return object.Eyes(); }
            };
            if (name == L"IsHeadCapturedBySystem") return
            {
                [object] { return object.IsHeadCapturedBySystem(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialRecognitionEndedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialRecognitionEndedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialRecognitionStartedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialRecognitionStartedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Spatial::SpatialTappedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Input::Spatial::SpatialTappedEventArgs const& object, hstring const& name)
        {
            if (name == L"InteractionSourceKind") return
            {
                [object] { return object.InteractionSourceKind(); }
