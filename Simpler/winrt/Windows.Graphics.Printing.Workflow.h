...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowBackgroundSession, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowBackgroundSession const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowBackgroundSetupRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowBackgroundSetupRequestedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowConfiguration, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowConfiguration const& object, hstring const& name)
        {
            if (name == L"SourceAppDisplayName") return
            {
                [object] { return object.SourceAppDisplayName(); }
            };
            if (name == L"JobTitle") return
            {
                [object] { return object.JobTitle(); }
            };
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowForegroundSession, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowForegroundSession const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowForegroundSetupRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowForegroundSetupRequestedEventArgs const& object, hstring const& name)
        {
            if (name == L"Configuration") return
            {
                [object] { return object.Configuration(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedOperation, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedOperation const& object, hstring const& name)
        {
            if (name == L"Configuration") return
            {
                [object] { return object.Configuration(); }
            };
            if (name == L"XpsContent") return
            {
                [object] { return object.XpsContent(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowTarget, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowTarget const& object, hstring const& name)
        {
            if (name == L"TargetAsStream") return
            {
                [object] { return object.TargetAsStream(); }
            };
            if (name == L"TargetAsXpsObjectModelPackage") return
            {
                [object] { return object.TargetAsXpsObjectModelPackage(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowTriggerDetails, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowTriggerDetails const& object, hstring const& name)
        {
            if (name == L"PrintWorkflowSession") return
            {
                [object] { return object.PrintWorkflowSession(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowUIActivatedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowUIActivatedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Printing::Workflow::PrintWorkflowXpsDataAvailableEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Printing::Workflow::PrintWorkflowXpsDataAvailableEventArgs const& object, hstring const& name)
        {
            if (name == L"Operation") return
            {
                [object] { return object.Operation(); }
