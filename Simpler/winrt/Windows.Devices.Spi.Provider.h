...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Spi::Provider::ProviderSpiConnectionSettings, U>
    {
        static xaml_binding bind(Windows::Devices::Spi::Provider::ProviderSpiConnectionSettings const& object, hstring const& name)
        {
