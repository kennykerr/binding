...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::AudioMediaFrame, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::AudioMediaFrame const& object, hstring const& name)
        {
            if (name == L"FrameReference") return
            {
                [object] { return object.FrameReference(); }
            };
            if (name == L"AudioEncodingProperties") return
            {
                [object] { return object.AudioEncodingProperties(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::BufferMediaFrame, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::BufferMediaFrame const& object, hstring const& name)
        {
            if (name == L"FrameReference") return
            {
                [object] { return object.FrameReference(); }
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::DepthMediaFrame, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::DepthMediaFrame const& object, hstring const& name)
        {
            if (name == L"FrameReference") return
            {
                [object] { return object.FrameReference(); }
            };
            if (name == L"VideoMediaFrame") return
            {
                [object] { return object.VideoMediaFrame(); }
            };
            if (name == L"DepthFormat") return
            {
                [object] { return object.DepthFormat(); }
            };
            if (name == L"MaxReliableDepth") return
            {
                [object] { return object.MaxReliableDepth(); }
            };
            if (name == L"MinReliableDepth") return
            {
                [object] { return object.MinReliableDepth(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::DepthMediaFrameFormat, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::DepthMediaFrameFormat const& object, hstring const& name)
        {
            if (name == L"VideoFormat") return
            {
                [object] { return object.VideoFormat(); }
            };
            if (name == L"DepthScaleInMeters") return
            {
                [object] { return object.DepthScaleInMeters(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::InfraredMediaFrame, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::InfraredMediaFrame const& object, hstring const& name)
        {
            if (name == L"FrameReference") return
            {
                [object] { return object.FrameReference(); }
            ...
            if (name == L"IsIlluminated") return
            {
                [object] { return object.IsIlluminated(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameFormat, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameFormat const& object, hstring const& name)
        {
            if (name == L"MajorType") return
            {
                [object] { return object.MajorType(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameReader, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameReader const& object, hstring const& name)
        {
            if (name == L"AcquisitionMode") return
            {
                [object] { return object.AcquisitionMode(); },
                [object](auto&& value) { object.AcquisitionMode(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameReference, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameReference const& object, hstring const& name)
        {
            if (name == L"SourceKind") return
            {
                [object] { return object.SourceKind(); }
            };
            ...
            if (name == L"BufferMediaFrame") return
            {
                [object] { return object.BufferMediaFrame(); }
            };
            if (name == L"VideoMediaFrame") return
            {
                [object] { return object.VideoMediaFrame(); }
            };
            if (name == L"CoordinateSystem") return
            {
                [object] { return object.CoordinateSystem(); }
            };
            if (name == L"AudioMediaFrame") return
            {
                [object] { return object.AudioMediaFrame(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameSource, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameSource const& object, hstring const& name)
        {
            ...
            if (name == L"SupportedFormats") return
            {
                [object] { return object.SupportedFormats(); }
            };
            if (name == L"CurrentFormat") return
            {
                [object] { return object.CurrentFormat(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameSourceController, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameSourceController const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameSourceGetPropertyResult, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameSourceGetPropertyResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameSourceGroup, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameSourceGroup const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"SourceInfos") return
            {
                [object] { return object.SourceInfos(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MediaFrameSourceInfo, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MediaFrameSourceInfo const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"MediaStreamType") return
            {
                [object] { return object.MediaStreamType(); }
            };
            if (name == L"SourceKind") return
            {
                [object] { return object.SourceKind(); }
            ...
            if (name == L"VideoProfileMediaDescription") return
            {
                [object] { return object.VideoProfileMediaDescription(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::MultiSourceMediaFrameReader, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::MultiSourceMediaFrameReader const& object, hstring const& name)
        {
            if (name == L"AcquisitionMode") return
            {
                [object] { return object.AcquisitionMode(); },
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Frames::VideoMediaFrame, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::VideoMediaFrame const& object, hstring const& name)
        {
            if (name == L"FrameReference") return
            {
                [object] { return object.FrameReference(); }
            ...
            if (name == L"InfraredMediaFrame") return
            {
                [object] { return object.InfraredMediaFrame(); }
            };
            if (name == L"DepthMediaFrame") return
            {
                [object] { return object.DepthMediaFrame(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Capture::Frames::VideoMediaFrameFormat, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Frames::VideoMediaFrameFormat const& object, hstring const& name)
        {
            if (name == L"MediaFrameFormat") return
            {
                [object] { return object.MediaFrameFormat(); }
            };
            if (name == L"DepthFormat") return
            {
                [object] { return object.DepthFormat(); }
