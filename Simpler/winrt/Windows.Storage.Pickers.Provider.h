...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::FileOpenPickerUI, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::FileOpenPickerUI const& object, hstring const& name)
        {
            if (name == L"AllowedFileTypes") return
            {
                [object] { return object.AllowedFileTypes(); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::FileRemovedEventArgs, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::FileRemovedEventArgs const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::FileSavePickerUI, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::FileSavePickerUI const& object, hstring const& name)
        {
            if (name == L"Title") return
            {
                [object] { return object.Title(); },
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::PickerClosingEventArgs, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::PickerClosingEventArgs const& object, hstring const& name)
        {
            if (name == L"ClosingOperation") return
            {
                [object] { return object.ClosingOperation(); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::PickerClosingOperation, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::PickerClosingOperation const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::TargetFileRequest, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::TargetFileRequest const& object, hstring const& name)
        {
            if (name == L"TargetFile") return
            {
                [object] { return object.TargetFile(); },
                [object](auto&& value) { object.TargetFile(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::Pickers::Provider::TargetFileRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::Provider::TargetFileRequestedEventArgs const& object, hstring const& name)
        {
