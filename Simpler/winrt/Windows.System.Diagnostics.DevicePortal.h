...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::DevicePortal::DevicePortalConnectionClosedEventArgs, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::DevicePortal::DevicePortalConnectionClosedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::DevicePortal::DevicePortalConnectionRequestReceivedEventArgs, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::DevicePortal::DevicePortalConnectionRequestReceivedEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"IsWebSocketUpgradeRequest") return
            {
                [object] { return object.IsWebSocketUpgradeRequest(); }
            };
            if (name == L"WebSocketProtocolsRequested") return
            {
                [object] { return object.WebSocketProtocolsRequested(); }
            };
            return {};
        }
    };
