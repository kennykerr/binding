...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Printing::AddPagesEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Printing::AddPagesEventArgs const& object, hstring const& name)
        {
            if (name == L"PrintTaskOptions") return
            {
                [object] { return object.PrintTaskOptions(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Xaml::Printing::GetPreviewPageEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Printing::GetPreviewPageEventArgs const& object, hstring const& name)
        {
            if (name == L"PageNumber") return
            {
                [object] { return object.PageNumber(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Xaml::Printing::PaginateEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Printing::PaginateEventArgs const& object, hstring const& name)
        {
            if (name == L"PrintTaskOptions") return
            {
                [object] { return object.PrintTaskOptions(); }
            };
            if (name == L"CurrentPreviewPageNumber") return
            {
                [object] { return object.CurrentPreviewPageNumber(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Xaml::Printing::PrintDocument, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Printing::PrintDocument const& object, hstring const& name)
        {
            if (name == L"DocumentSource") return
            {
                [object] { return object.DocumentSource(); }
            };
