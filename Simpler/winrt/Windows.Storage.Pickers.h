...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FileExtensionVector, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FileExtensionVector const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FileOpenPicker, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FileOpenPicker const& object, hstring const& name)
        {
            ...
            if (name == L"ViewMode") return
            {
                ...
                [object](auto&& value) { object.ViewMode(value); }
            };
            if (name == L"SettingsIdentifier") return
            {
                [object] { return object.SettingsIdentifier(); },
                [object](auto&& value) { object.SettingsIdentifier(value); }
            };
            if (name == L"SuggestedStartLocation") return
            {
                [object] { return object.SuggestedStartLocation(); },
                [object](auto&& value) { object.SuggestedStartLocation(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FilePickerFileTypesOrderedMap, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FilePickerFileTypesOrderedMap const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FilePickerSelectedFilesArray, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FilePickerSelectedFilesArray const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FileSavePicker, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FileSavePicker const& object, hstring const& name)
        {
            if (name == L"ContinuationData") return
            {
                [object] { return object.ContinuationData(); }
            ...
            if (name == L"FileTypeChoices") return
            {
                [object] { return object.FileTypeChoices(); }
            };
            if (name == L"DefaultFileExtension") return
            {
                [object] { return object.DefaultFileExtension(); },
                [object](auto&& value) { object.DefaultFileExtension(value); }
            };
            if (name == L"SuggestedSaveFile") return
            {
                [object] { return object.SuggestedSaveFile(); },
                [object](auto&& value) { object.SuggestedSaveFile(value); }
            };
            if (name == L"SuggestedFileName") return
            {
                [object] { return object.SuggestedFileName(); },
                [object](auto&& value) { object.SuggestedFileName(value); }
            };
            if (name == L"User") return
            {
                [object] { return object.User(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Pickers::FolderPicker, U>
    {
        static xaml_binding bind(Windows::Storage::Pickers::FolderPicker const& object, hstring const& name)
        {
            if (name == L"ContinuationData") return
            {
                [object] { return object.ContinuationData(); }
