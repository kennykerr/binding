...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::I2c::Provider::ProviderI2cConnectionSettings, U>
    {
        static xaml_binding bind(Windows::Devices::I2c::Provider::ProviderI2cConnectionSettings const& object, hstring const& name)
        {
