...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Editing::BackgroundAudioTrack, U>
    {
        static xaml_binding bind(Windows::Media::Editing::BackgroundAudioTrack const& object, hstring const& name)
        {
            if (name == L"TrimTimeFromStart") return
            {
                [object] { return object.TrimTimeFromStart(); },
                [object](auto&& value) { object.TrimTimeFromStart(value); }
            };
            if (name == L"TrimTimeFromEnd") return
            {
                [object] { return object.TrimTimeFromEnd(); },
                [object](auto&& value) { object.TrimTimeFromEnd(value); }
            };
            if (name == L"OriginalDuration") return
            {
                [object] { return object.OriginalDuration(); }
            };
            if (name == L"TrimmedDuration") return
            {
                [object] { return object.TrimmedDuration(); }
            };
            if (name == L"UserData") return
            {
                [object] { return object.UserData(); }
            };
            ...
            if (name == L"AudioEffectDefinitions") return
            {
                [object] { return object.AudioEffectDefinitions(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Editing::MediaClip, U>
    {
        static xaml_binding bind(Windows::Media::Editing::MediaClip const& object, hstring const& name)
        {
            if (name == L"TrimTimeFromStart") return
            {
                [object] { return object.TrimTimeFromStart(); },
            ...
            if (name == L"StartTimeInComposition") return
            {
                [object] { return object.StartTimeInComposition(); }
            };
            if (name == L"EndTimeInComposition") return
            {
                [object] { return object.EndTimeInComposition(); }
            };
            if (name == L"EmbeddedAudioTracks") return
            {
                [object] { return object.EmbeddedAudioTracks(); }
            };
            if (name == L"SelectedEmbeddedAudioTrackIndex") return
            {
                [object] { return object.SelectedEmbeddedAudioTrackIndex(); },
                [object](auto&& value) { object.SelectedEmbeddedAudioTrackIndex(value); }
            };
            if (name == L"Volume") return
            {
                [object] { return object.Volume(); },
            ...
            if (name == L"VideoEffectDefinitions") return
            {
                [object] { return object.VideoEffectDefinitions(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Editing::MediaComposition, U>
    {
        static xaml_binding bind(Windows::Media::Editing::MediaComposition const& object, hstring const& name)
        {
            if (name == L"Duration") return
            {
                [object] { return object.Duration(); }
            };
            if (name == L"Clips") return
            {
                [object] { return object.Clips(); }
            };
            if (name == L"BackgroundAudioTracks") return
            {
                [object] { return object.BackgroundAudioTracks(); }
            };
            if (name == L"UserData") return
            {
                [object] { return object.UserData(); }
            };
            if (name == L"OverlayLayers") return
            {
                [object] { return object.OverlayLayers(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Editing::MediaOverlay, U>
    {
        static xaml_binding bind(Windows::Media::Editing::MediaOverlay const& object, hstring const& name)
        {
            ...
            if (name == L"AudioEnabled") return
            {
                [object] { return object.AudioEnabled(); },
                [object](auto&& value) { object.AudioEnabled(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Editing::MediaOverlayLayer, U>
    {
        static xaml_binding bind(Windows::Media::Editing::MediaOverlayLayer const& object, hstring const& name)
        {
            if (name == L"Overlays") return
            {
                [object] { return object.Overlays(); }
            };
            if (name == L"CustomCompositorDefinition") return
            {
                [object] { return object.CustomCompositorDefinition(); }
            };
            return {};
        }
    };
