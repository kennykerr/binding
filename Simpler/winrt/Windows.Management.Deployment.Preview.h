...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Management::Deployment::Preview::InstalledClassicAppInfo, U>
    {
        static xaml_binding bind(Windows::Management::Deployment::Preview::InstalledClassicAppInfo const& object, hstring const& name)
        {
