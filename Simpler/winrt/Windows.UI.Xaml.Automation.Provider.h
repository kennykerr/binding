...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Automation::Provider::IRawElementProviderSimple, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Automation::Provider::IRawElementProviderSimple const& object, hstring const& name)
        {
