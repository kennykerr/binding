...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Management::Deployment::DeploymentResult, U>
    {
        static xaml_binding bind(Windows::Management::Deployment::DeploymentResult const& object, hstring const& name)
        {
            ...
            if (name == L"IsRegistered") return
            {
                [object] { return object.IsRegistered(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Management::Deployment::PackageManager, U>
    {
        static xaml_binding bind(Windows::Management::Deployment::PackageManager const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Management::Deployment::PackageUserInformation, U>
    {
        static xaml_binding bind(Windows::Management::Deployment::PackageUserInformation const& object, hstring const& name)
        {
            if (name == L"UserSecurityId") return
            {
                [object] { return object.UserSecurityId(); }
            };
    ...
    template <typename U> struct bindable<Windows::Management::Deployment::PackageVolume, U>
    {
        static xaml_binding bind(Windows::Management::Deployment::PackageVolume const& object, hstring const& name)
        {
            if (name == L"IsOffline") return
            {
                [object] { return object.IsOffline(); }
            };
            if (name == L"IsSystemVolume") return
            {
                [object] { return object.IsSystemVolume(); }
            };
            if (name == L"MountPoint") return
            {
                [object] { return object.MountPoint(); }
            };
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            };
            if (name == L"PackageStorePath") return
            {
                [object] { return object.PackageStorePath(); }
            };
            if (name == L"SupportsHardLinks") return
            {
                [object] { return object.SupportsHardLinks(); }
            };
            if (name == L"IsFullTrustPackageSupported") return
            {
                [object] { return object.IsFullTrustPackageSupported(); }
            };
            if (name == L"IsAppxInstallSupported") return
            {
                [object] { return object.IsAppxInstallSupported(); }
            };
            return {};
        }
    };
