...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Background::PhoneCallBlockedTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Background::PhoneCallBlockedTriggerDetails const& object, hstring const& name)
        {
            ...
            if (name == L"CallBlockedReason") return
            {
                [object] { return object.CallBlockedReason(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Background::PhoneCallOriginDataRequestTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Background::PhoneCallOriginDataRequestTriggerDetails const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Background::PhoneIncomingCallDismissedTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Background::PhoneIncomingCallDismissedTriggerDetails const& object, hstring const& name)
        {
            if (name == L"LineId") return
            {
                [object] { return object.LineId(); }
            ...
            if (name == L"DismissalTime") return
            {
                [object] { return object.DismissalTime(); }
            };
            if (name == L"TextReplyMessage") return
            {
                [object] { return object.TextReplyMessage(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Background::PhoneLineChangedTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Background::PhoneLineChangedTriggerDetails const& object, hstring const& name)
        {
            if (name == L"LineId") return
            {
                [object] { return object.LineId(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Background::PhoneNewVoicemailMessageTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Background::PhoneNewVoicemailMessageTriggerDetails const& object, hstring const& name)
        {
            if (name == L"LineId") return
            {
                [object] { return object.LineId(); }
            };
            if (name == L"VoicemailCount") return
            {
                [object] { return object.VoicemailCount(); }
            };
            if (name == L"OperatorMessage") return
            {
                [object] { return object.OperatorMessage(); }
            };
            return {};
        }
    };
