...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::UI::CredentialPickerOptions, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::UI::CredentialPickerOptions const& object, hstring const& name)
        {
            ...
            if (name == L"ErrorCode") return
            {
                ...
                [object](auto&& value) { object.ErrorCode(value); }
            };
            ...
            if (name == L"AuthenticationProtocol") return
            {
                [object] { return object.AuthenticationProtocol(); },
                [object](auto&& value) { object.AuthenticationProtocol(value); }
            };
            if (name == L"CustomAuthenticationProtocol") return
            {
                [object] { return object.CustomAuthenticationProtocol(); },
                [object](auto&& value) { object.CustomAuthenticationProtocol(value); }
            };
            if (name == L"PreviousCredential") return
            {
                [object] { return object.PreviousCredential(); },
                [object](auto&& value) { object.PreviousCredential(value); }
            };
            if (name == L"AlwaysDisplayDialog") return
            {
                [object] { return object.AlwaysDisplayDialog(); },
                [object](auto&& value) { object.AlwaysDisplayDialog(value); }
            };
            if (name == L"CallerSavesCredential") return
            {
                [object] { return object.CallerSavesCredential(); },
                [object](auto&& value) { object.CallerSavesCredential(value); }
            };
            if (name == L"CredentialSaveOption") return
            {
                [object] { return object.CredentialSaveOption(); },
                [object](auto&& value) { object.CredentialSaveOption(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Credentials::UI::CredentialPickerResults, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::UI::CredentialPickerResults const& object, hstring const& name)
        {
            if (name == L"ErrorCode") return
            {
                [object] { return object.ErrorCode(); }
            ...
            if (name == L"CredentialSaved") return
            {
                [object] { return object.CredentialSaved(); }
            };
            if (name == L"Credential") return
            {
                [object] { return object.Credential(); }
            };
            if (name == L"CredentialDomainName") return
            {
                [object] { return object.CredentialDomainName(); }
            };
            if (name == L"CredentialUserName") return
            {
                [object] { return object.CredentialUserName(); }
            };
            if (name == L"CredentialPassword") return
            {
                [object] { return object.CredentialPassword(); }
            };
            return {};
        }
    };
