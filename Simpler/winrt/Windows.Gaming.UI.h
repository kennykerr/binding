...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Gaming::UI::GameChatMessageReceivedEventArgs, U>
    {
        static xaml_binding bind(Windows::Gaming::UI::GameChatMessageReceivedEventArgs const& object, hstring const& name)
        {
            if (name == L"AppId") return
            {
                [object] { return object.AppId(); }
            };
            if (name == L"AppDisplayName") return
            {
                [object] { return object.AppDisplayName(); }
            };
            if (name == L"SenderName") return
            {
                [object] { return object.SenderName(); }
            };
    ...
    template <typename U> struct bindable<Windows::Gaming::UI::GameChatOverlay, U>
    {
        static xaml_binding bind(Windows::Gaming::UI::GameChatOverlay const& object, hstring const& name)
        {
            if (name == L"DesiredPosition") return
            {
                [object] { return object.DesiredPosition(); },
                [object](auto&& value) { object.DesiredPosition(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::UI::GameUIProviderActivatedEventArgs, U>
    {
        static xaml_binding bind(Windows::Gaming::UI::GameUIProviderActivatedEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"GameUIArgs") return
            {
                [object] { return object.GameUIArgs(); }
            };
            return {};
        }
    };
