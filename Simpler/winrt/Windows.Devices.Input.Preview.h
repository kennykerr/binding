...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeDevicePreview, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeDevicePreview const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"CanTrackEyes") return
            {
                [object] { return object.CanTrackEyes(); }
            };
            if (name == L"CanTrackHead") return
            {
                [object] { return object.CanTrackHead(); }
            };
            if (name == L"ConfigurationState") return
            {
                [object] { return object.ConfigurationState(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeDeviceWatcherAddedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeDeviceWatcherAddedPreviewEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeDeviceWatcherRemovedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeDeviceWatcherRemovedPreviewEventArgs const& object, hstring const& name)
        {
            if (name == L"Device") return
            {
                [object] { return object.Device(); }
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeDeviceWatcherUpdatedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeDeviceWatcherUpdatedPreviewEventArgs const& object, hstring const& name)
        {
            if (name == L"Device") return
            {
                [object] { return object.Device(); }
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeEnteredPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeEnteredPreviewEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeExitedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeExitedPreviewEventArgs const& object, hstring const& name)
        {
            if (name == L"Handled") return
            {
                [object] { return object.Handled(); },
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazeMovedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazeMovedPreviewEventArgs const& object, hstring const& name)
        {
            if (name == L"Handled") return
            {
                [object] { return object.Handled(); },
    ...
    template <typename U> struct bindable<Windows::Devices::Input::Preview::GazePointPreview, U>
    {
        static xaml_binding bind(Windows::Devices::Input::Preview::GazePointPreview const& object, hstring const& name)
        {
            if (name == L"SourceDevice") return
            {
                [object] { return object.SourceDevice(); }
            };
            if (name == L"EyeGazePosition") return
            {
                [object] { return object.EyeGazePosition(); }
            };
            if (name == L"HeadGazePosition") return
            {
                [object] { return object.HeadGazePosition(); }
            };
            if (name == L"Timestamp") return
            {
                [object] { return object.Timestamp(); }
            };
            if (name == L"HidInputReport") return
            {
                [object] { return object.HidInputReport(); }
            };
            return {};
        }
    };
