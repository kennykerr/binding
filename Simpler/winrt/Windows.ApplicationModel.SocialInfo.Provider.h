...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::SocialInfo::Provider::SocialDashboardItemUpdater, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::SocialInfo::Provider::SocialDashboardItemUpdater const& object, hstring const& name)
        {
            if (name == L"OwnerRemoteId") return
            {
                [object] { return object.OwnerRemoteId(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::SocialInfo::Provider::SocialFeedUpdater, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::SocialInfo::Provider::SocialFeedUpdater const& object, hstring const& name)
        {
            if (name == L"OwnerRemoteId") return
            {
                [object] { return object.OwnerRemoteId(); }
