...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetector<D>::DetectFacesAsync(Windows::Graphics::Imaging::SoftwareBitmap const& image) const
    {
        void* returnValue{};
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetector<D>::DetectFacesAsync(Windows::Graphics::Imaging::SoftwareBitmap const& image, Windows::Graphics::Imaging::BitmapBounds const& searchArea) const
    {
        void* returnValue{};
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetector<D>::MinDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetector<D>::MaxDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceDetectorStatics<D>::IsBitmapPixelFormatSupported(Windows::Graphics::Imaging::BitmapPixelFormat const& bitmapPixelFormat) const
    {
        bool result;
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTracker<D>::ProcessNextFrameAsync(Windows::Media::VideoFrame const& videoFrame) const
    {
        void* returnValue{};
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTracker<D>::MinDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTracker<D>::MaxDetectableFaceSize(Windows::Graphics::Imaging::BitmapSize const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Media_FaceAnalysis_IFaceTrackerStatics<D>::IsBitmapPixelFormatSupported(Windows::Graphics::Imaging::BitmapPixelFormat const& bitmapPixelFormat) const
    {
        bool result;
    ...
    template <typename U> struct bindable<Windows::Media::FaceAnalysis::DetectedFace, U>
    {
        static xaml_binding bind(Windows::Media::FaceAnalysis::DetectedFace const& object, hstring const& name)
        {
            if (name == L"FaceBox") return
            {
                [object] { return object.FaceBox(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::FaceAnalysis::FaceDetector, U>
    {
        static xaml_binding bind(Windows::Media::FaceAnalysis::FaceDetector const& object, hstring const& name)
        {
            if (name == L"MinDetectableFaceSize") return
            {
                [object] { return object.MinDetectableFaceSize(); },
                [object](auto&& value) { object.MinDetectableFaceSize(value); }
            };
            if (name == L"MaxDetectableFaceSize") return
            {
                [object] { return object.MaxDetectableFaceSize(); },
                [object](auto&& value) { object.MaxDetectableFaceSize(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::FaceAnalysis::FaceTracker, U>
    {
        static xaml_binding bind(Windows::Media::FaceAnalysis::FaceTracker const& object, hstring const& name)
        {
            if (name == L"MinDetectableFaceSize") return
            {
                [object] { return object.MinDetectableFaceSize(); },
