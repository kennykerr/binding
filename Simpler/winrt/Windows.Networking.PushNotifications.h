...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Networking::PushNotifications::PushNotificationChannel, U>
    {
        static xaml_binding bind(Windows::Networking::PushNotifications::PushNotificationChannel const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Networking::PushNotifications::PushNotificationChannelManagerForUser, U>
    {
        static xaml_binding bind(Windows::Networking::PushNotifications::PushNotificationChannelManagerForUser const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Networking::PushNotifications::PushNotificationReceivedEventArgs, U>
    {
        static xaml_binding bind(Windows::Networking::PushNotifications::PushNotificationReceivedEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"ToastNotification") return
            {
                [object] { return object.ToastNotification(); }
            };
            if (name == L"TileNotification") return
            {
                [object] { return object.TileNotification(); }
            };
            if (name == L"BadgeNotification") return
            {
                [object] { return object.BadgeNotification(); }
            };
            if (name == L"RawNotification") return
            {
                [object] { return object.RawNotification(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Networking::PushNotifications::RawNotification, U>
    {
        static xaml_binding bind(Windows::Networking::PushNotifications::RawNotification const& object, hstring const& name)
        {
            ...
            if (name == L"ChannelId") return
            {
                [object] { return object.ChannelId(); }
            };
            return {};
        }
    };
