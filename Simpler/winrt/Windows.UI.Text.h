...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Text::ContentLinkInfo, U>
    {
        static xaml_binding bind(Windows::UI::Text::ContentLinkInfo const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"SecondaryText") return
            {
                [object] { return object.SecondaryText(); },
                [object](auto&& value) { object.SecondaryText(value); }
            };
            ...
            if (name == L"LinkContentKind") return
            {
                [object] { return object.LinkContentKind(); },
                [object](auto&& value) { object.LinkContentKind(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Text::RichEditTextDocument, U>
    {
        static xaml_binding bind(Windows::UI::Text::RichEditTextDocument const& object, hstring const& name)
        {
            if (name == L"AlignmentIncludesTrailingWhitespace") return
            {
                [object] { return object.AlignmentIncludesTrailingWhitespace(); },
                [object](auto&& value) { object.AlignmentIncludesTrailingWhitespace(value); }
            };
            if (name == L"IgnoreTrailingCharacterSpacing") return
            {
                [object] { return object.IgnoreTrailingCharacterSpacing(); },
                [object](auto&& value) { object.IgnoreTrailingCharacterSpacing(value); }
            };
            if (name == L"CaretType") return
            {
                [object] { return object.CaretType(); },
                [object](auto&& value) { object.CaretType(value); }
            };
            if (name == L"DefaultTabStop") return
            {
                [object] { return object.DefaultTabStop(); },
                [object](auto&& value) { object.DefaultTabStop(value); }
            };
            if (name == L"Selection") return
            {
                [object] { return object.Selection(); }
            };
            if (name == L"UndoLimit") return
            {
                [object] { return object.UndoLimit(); },
                [object](auto&& value) { object.UndoLimit(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Text::RichEditTextRange, U>
    {
        static xaml_binding bind(Windows::UI::Text::RichEditTextRange const& object, hstring const& name)
        {
            if (name == L"ContentLinkInfo") return
            {
                [object] { return object.ContentLinkInfo(); },
                [object](auto&& value) { object.ContentLinkInfo(value); }
            };
            if (name == L"Character") return
            {
                [object] { return object.Character(); },
                [object](auto&& value) { object.Character(value); }
            };
            if (name == L"CharacterFormat") return
            {
                [object] { return object.CharacterFormat(); },
                [object](auto&& value) { object.CharacterFormat(value); }
            };
            if (name == L"FormattedText") return
            {
                [object] { return object.FormattedText(); },
                [object](auto&& value) { object.FormattedText(value); }
            };
            if (name == L"EndPosition") return
            {
                [object] { return object.EndPosition(); },
                [object](auto&& value) { object.EndPosition(value); }
            };
            if (name == L"Gravity") return
            {
                [object] { return object.Gravity(); },
                [object](auto&& value) { object.Gravity(value); }
            };
            if (name == L"Length") return
            {
                [object] { return object.Length(); }
            };
            if (name == L"Link") return
            {
                [object] { return object.Link(); },
                [object](auto&& value) { object.Link(value); }
            };
            if (name == L"ParagraphFormat") return
            {
                [object] { return object.ParagraphFormat(); },
                [object](auto&& value) { object.ParagraphFormat(value); }
            };
            if (name == L"StartPosition") return
            {
                [object] { return object.StartPosition(); },
                [object](auto&& value) { object.StartPosition(value); }
            };
            if (name == L"StoryLength") return
            {
                [object] { return object.StoryLength(); }
            };
