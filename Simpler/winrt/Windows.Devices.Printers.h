...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Printers::Print3DDevice, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Print3DDevice const& object, hstring const& name)
        {
            if (name == L"PrintSchema") return
            {
                [object] { return object.PrintSchema(); }
            };
            return {};
        }
    };
