...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::KeyCredential, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::KeyCredential const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::KeyCredentialAttestationResult, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::KeyCredentialAttestationResult const& object, hstring const& name)
        {
            if (name == L"CertificateChainBuffer") return
            {
                [object] { return object.CertificateChainBuffer(); }
            };
            if (name == L"AttestationBuffer") return
            {
                [object] { return object.AttestationBuffer(); }
            };
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::KeyCredentialOperationResult, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::KeyCredentialOperationResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::KeyCredentialRetrievalResult, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::KeyCredentialRetrievalResult const& object, hstring const& name)
        {
            if (name == L"Credential") return
            {
                [object] { return object.Credential(); }
            };
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::PasswordCredential, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::PasswordCredential const& object, hstring const& name)
        {
            if (name == L"Resource") return
            {
                [object] { return object.Resource(); },
                [object](auto&& value) { object.Resource(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::PasswordCredentialPropertyStore, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::PasswordCredentialPropertyStore const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::WebAccount, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::WebAccount const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Credentials::WebAccountProvider, U>
    {
        static xaml_binding bind(Windows::Security::Credentials::WebAccountProvider const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            ...
            if (name == L"DisplayPurpose") return
            {
                [object] { return object.DisplayPurpose(); }
            };
            if (name == L"Authority") return
            {
                [object] { return object.Authority(); }
            };
            if (name == L"User") return
            {
                [object] { return object.User(); }
            };
            if (name == L"IsSystemProvider") return
            {
                [object] { return object.IsSystemProvider(); }
            };
            return {};
        }
    };
