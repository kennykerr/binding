...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Playlists::Playlist, U>
    {
        static xaml_binding bind(Windows::Media::Playlists::Playlist const& object, hstring const& name)
        {
