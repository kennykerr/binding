...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::SpeechSynthesis::SpeechSynthesisStream, U>
    {
        static xaml_binding bind(Windows::Media::SpeechSynthesis::SpeechSynthesisStream const& object, hstring const& name)
        {
            ...
            if (name == L"Markers") return
            {
                [object] { return object.Markers(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::SpeechSynthesis::SpeechSynthesizer, U>
    {
        static xaml_binding bind(Windows::Media::SpeechSynthesis::SpeechSynthesizer const& object, hstring const& name)
        {
            if (name == L"Voice") return
            {
                [object] { return object.Voice(); },
                [object](auto&& value) { object.Voice(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::SpeechSynthesis::SpeechSynthesizerOptions, U>
    {
        static xaml_binding bind(Windows::Media::SpeechSynthesis::SpeechSynthesizerOptions const& object, hstring const& name)
        {
            if (name == L"IncludeWordBoundaryMetadata") return
            {
                [object] { return object.IncludeWordBoundaryMetadata(); },
                [object](auto&& value) { object.IncludeWordBoundaryMetadata(value); }
            };
            if (name == L"IncludeSentenceBoundaryMetadata") return
            {
                [object] { return object.IncludeSentenceBoundaryMetadata(); },
                [object](auto&& value) { object.IncludeSentenceBoundaryMetadata(value); }
            };
            if (name == L"AudioVolume") return
            {
                [object] { return object.AudioVolume(); },
                [object](auto&& value) { object.AudioVolume(value); }
            };
            if (name == L"SpeakingRate") return
            {
                [object] { return object.SpeakingRate(); },
                [object](auto&& value) { object.SpeakingRate(value); }
            };
            if (name == L"AudioPitch") return
            {
                [object] { return object.AudioPitch(); },
                [object](auto&& value) { object.AudioPitch(value); }
            };
            if (name == L"AppendedSilence") return
            {
                [object] { return object.AppendedSilence(); },
                [object](auto&& value) { object.AppendedSilence(value); }
            };
            if (name == L"PunctuationSilence") return
            {
                [object] { return object.PunctuationSilence(); },
                [object](auto&& value) { object.PunctuationSilence(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::SpeechSynthesis::VoiceInformation, U>
    {
        static xaml_binding bind(Windows::Media::SpeechSynthesis::VoiceInformation const& object, hstring const& name)
        {
