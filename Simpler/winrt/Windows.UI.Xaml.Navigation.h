...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Navigation_INavigatingCancelEventArgs<D>::NavigationMode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs)->get_NavigationMode(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::UI::Xaml::Navigation::NavigationMode value;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Navigation::INavigationEventArgs)->get_NavigationMode(put_abi(value)));
        return value;
    }
    ...
    template <typename H> struct delegate<Windows::UI::Xaml::Navigation::LoadCompletedEventHandler, H> : implements_delegate<Windows::UI::Xaml::Navigation::LoadCompletedEventHandler, H>
    {
    ...
    template <typename H> struct delegate<Windows::UI::Xaml::Navigation::NavigatedEventHandler, H> : implements_delegate<Windows::UI::Xaml::Navigation::NavigatedEventHandler, H>
    {
    ...
    template <typename H> struct delegate<Windows::UI::Xaml::Navigation::NavigatingCancelEventHandler, H> : implements_delegate<Windows::UI::Xaml::Navigation::NavigatingCancelEventHandler, H>
    {
    ...
    template <typename H> struct delegate<Windows::UI::Xaml::Navigation::NavigationFailedEventHandler, H> : implements_delegate<Windows::UI::Xaml::Navigation::NavigationFailedEventHandler, H>
    {
    ...
    template <typename H> struct delegate<Windows::UI::Xaml::Navigation::NavigationStoppedEventHandler, H> : implements_delegate<Windows::UI::Xaml::Navigation::NavigationStoppedEventHandler, H>
    {
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Navigation::FrameNavigationOptions, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Navigation::FrameNavigationOptions const& object, hstring const& name)
        {
            if (name == L"IsNavigationStackEnabled") return
            {
                [object] { return object.IsNavigationStackEnabled(); },
                [object](auto&& value) { object.IsNavigationStackEnabled(value); }
            };
            if (name == L"TransitionInfoOverride") return
            {
                [object] { return object.TransitionInfoOverride(); },
                [object](auto&& value) { object.TransitionInfoOverride(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Xaml::Navigation::NavigatingCancelEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Navigation::NavigatingCancelEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"NavigationMode") return
            {
                [object] { return object.NavigationMode(); }
            };
            if (name == L"SourcePageType") return
            {
                [object] { return object.SourcePageType(); }
            };
            if (name == L"Parameter") return
            {
                [object] { return object.Parameter(); }
            };
            if (name == L"NavigationTransitionInfo") return
            {
                [object] { return object.NavigationTransitionInfo(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Xaml::Navigation::NavigationEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Navigation::NavigationEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Navigation::NavigationFailedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Navigation::NavigationFailedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Navigation::PageStackEntry, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Navigation::PageStackEntry const& object, hstring const& name)
        {
            if (name == L"SourcePageType") return
            {
                [object] { return object.SourcePageType(); }
...
namespace winrt::Windows::UI::Xaml::Navigation
{
    ...
    protected:
        ...
        {
            impl::call_factory<FrameNavigationOptions, Windows::UI::Xaml::Navigation::IFrameNavigationOptionsFactory>([&](auto&& f) { f.CreateInstance(*this, this->m_inner); });
        }
    };
}
namespace std
