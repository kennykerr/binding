...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Profile::AnalyticsVersionInfo, U>
    {
        static xaml_binding bind(Windows::System::Profile::AnalyticsVersionInfo const& object, hstring const& name)
        {
            if (name == L"DeviceFamily") return
            {
                [object] { return object.DeviceFamily(); }
            };
            if (name == L"DeviceFamilyVersion") return
            {
                [object] { return object.DeviceFamilyVersion(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Profile::HardwareToken, U>
    {
        static xaml_binding bind(Windows::System::Profile::HardwareToken const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"Signature") return
            {
                [object] { return object.Signature(); }
            };
    ...
    template <typename U> struct bindable<Windows::System::Profile::SystemIdentificationInfo, U>
    {
        static xaml_binding bind(Windows::System::Profile::SystemIdentificationInfo const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::System::Profile::UnsupportedAppRequirement, U>
    {
        static xaml_binding bind(Windows::System::Profile::UnsupportedAppRequirement const& object, hstring const& name)
        {
            if (name == L"Requirement") return
            {
                [object] { return object.Requirement(); }
            };
