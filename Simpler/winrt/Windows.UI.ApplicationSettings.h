...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::AccountsSettingsPaneCommandsRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::AccountsSettingsPaneCommandsRequestedEventArgs const& object, hstring const& name)
        {
            if (name == L"WebAccountProviderCommands") return
            {
                [object] { return object.WebAccountProviderCommands(); }
            };
            if (name == L"WebAccountCommands") return
            {
                [object] { return object.WebAccountCommands(); }
            };
            if (name == L"CredentialCommands") return
            {
                [object] { return object.CredentialCommands(); }
            };
            if (name == L"Commands") return
            {
                [object] { return object.Commands(); }
            };
            if (name == L"HeaderText") return
            {
                [object] { return object.HeaderText(); },
                [object](auto&& value) { object.HeaderText(value); }
            };
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::CredentialCommand, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::CredentialCommand const& object, hstring const& name)
        {
            if (name == L"PasswordCredential") return
            {
                [object] { return object.PasswordCredential(); }
            };
            if (name == L"CredentialDeleted") return
            {
                [object] { return object.CredentialDeleted(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::SettingsCommand, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::SettingsCommand const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::SettingsPaneCommandsRequest, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::SettingsPaneCommandsRequest const& object, hstring const& name)
        {
            if (name == L"ApplicationCommands") return
            {
                [object] { return object.ApplicationCommands(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::SettingsPaneCommandsRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::SettingsPaneCommandsRequestedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::WebAccountCommand, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::WebAccountCommand const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::WebAccountInvokedArgs, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::WebAccountInvokedArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::ApplicationSettings::WebAccountProviderCommand, U>
    {
        static xaml_binding bind(Windows::UI::ApplicationSettings::WebAccountProviderCommand const& object, hstring const& name)
        {
