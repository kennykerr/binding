...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Pwm::PwmController, U>
    {
        static xaml_binding bind(Windows::Devices::Pwm::PwmController const& object, hstring const& name)
        {
            if (name == L"PinCount") return
            {
                [object] { return object.PinCount(); }
            };
            if (name == L"ActualFrequency") return
            {
                [object] { return object.ActualFrequency(); }
            };
            if (name == L"MinFrequency") return
            {
                [object] { return object.MinFrequency(); }
            };
            if (name == L"MaxFrequency") return
            {
                [object] { return object.MaxFrequency(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Pwm::PwmPin, U>
    {
        static xaml_binding bind(Windows::Devices::Pwm::PwmPin const& object, hstring const& name)
        {
