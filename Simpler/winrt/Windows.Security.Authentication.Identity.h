...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Identity::EnterpriseKeyCredentialRegistrationInfo, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Identity::EnterpriseKeyCredentialRegistrationInfo const& object, hstring const& name)
        {
            if (name == L"TenantId") return
            {
                [object] { return object.TenantId(); }
            };
            if (name == L"TenantName") return
            {
                [object] { return object.TenantName(); }
            };
            ...
            if (name == L"KeyName") return
            {
                [object] { return object.KeyName(); }
            };
            return {};
        }
    };
