...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Perception::PerceptionTimestamp, U>
    {
        static xaml_binding bind(Windows::Perception::PerceptionTimestamp const& object, hstring const& name)
        {
            if (name == L"TargetTime") return
            {
                [object] { return object.TargetTime(); }
            };
            if (name == L"PredictionAmount") return
            {
                [object] { return object.PredictionAmount(); }
            };
            if (name == L"SystemRelativeTargetTime") return
            {
                [object] { return object.SystemRelativeTargetTime(); }
            };
            return {};
        }
    };
