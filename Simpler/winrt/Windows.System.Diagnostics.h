...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::DiagnosticActionResult, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::DiagnosticActionResult const& object, hstring const& name)
        {
            if (name == L"ExtendedError") return
            {
                [object] { return object.ExtendedError(); }
            };
            if (name == L"Results") return
            {
                [object] { return object.Results(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::ProcessCpuUsageReport, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::ProcessCpuUsageReport const& object, hstring const& name)
        {
            if (name == L"KernelTime") return
            {
                [object] { return object.KernelTime(); }
            };
            if (name == L"UserTime") return
            {
                [object] { return object.UserTime(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::ProcessDiagnosticInfo, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::ProcessDiagnosticInfo const& object, hstring const& name)
        {
            if (name == L"ProcessId") return
            {
                [object] { return object.ProcessId(); }
            };
            if (name == L"ExecutableFileName") return
            {
                [object] { return object.ExecutableFileName(); }
            };
            if (name == L"Parent") return
            {
                [object] { return object.Parent(); }
            };
            if (name == L"ProcessStartTime") return
            {
                [object] { return object.ProcessStartTime(); }
            };
            if (name == L"DiskUsage") return
            {
                [object] { return object.DiskUsage(); }
            };
            if (name == L"MemoryUsage") return
            {
                [object] { return object.MemoryUsage(); }
            };
            if (name == L"CpuUsage") return
            {
                [object] { return object.CpuUsage(); }
            };
            if (name == L"IsPackaged") return
            {
                [object] { return object.IsPackaged(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::ProcessDiskUsageReport, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::ProcessDiskUsageReport const& object, hstring const& name)
        {
            if (name == L"ReadOperationCount") return
            {
                [object] { return object.ReadOperationCount(); }
            };
            if (name == L"WriteOperationCount") return
            {
                [object] { return object.WriteOperationCount(); }
            };
            if (name == L"OtherOperationCount") return
            {
                [object] { return object.OtherOperationCount(); }
            };
            if (name == L"BytesReadCount") return
            {
                [object] { return object.BytesReadCount(); }
            };
            if (name == L"BytesWrittenCount") return
            {
                [object] { return object.BytesWrittenCount(); }
            };
            if (name == L"OtherBytesCount") return
            {
                [object] { return object.OtherBytesCount(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::ProcessMemoryUsageReport, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::ProcessMemoryUsageReport const& object, hstring const& name)
        {
            if (name == L"NonPagedPoolSizeInBytes") return
            {
                [object] { return object.NonPagedPoolSizeInBytes(); }
            };
            if (name == L"PageFaultCount") return
            {
                [object] { return object.PageFaultCount(); }
            };
            if (name == L"PageFileSizeInBytes") return
            {
                [object] { return object.PageFileSizeInBytes(); }
            };
            if (name == L"PagedPoolSizeInBytes") return
            {
                [object] { return object.PagedPoolSizeInBytes(); }
            };
            if (name == L"PeakNonPagedPoolSizeInBytes") return
            {
                [object] { return object.PeakNonPagedPoolSizeInBytes(); }
            };
            if (name == L"PeakPageFileSizeInBytes") return
            {
                [object] { return object.PeakPageFileSizeInBytes(); }
            };
            if (name == L"PeakPagedPoolSizeInBytes") return
            {
                [object] { return object.PeakPagedPoolSizeInBytes(); }
            };
            if (name == L"PeakVirtualMemorySizeInBytes") return
            {
                [object] { return object.PeakVirtualMemorySizeInBytes(); }
            };
            if (name == L"PeakWorkingSetSizeInBytes") return
            {
                [object] { return object.PeakWorkingSetSizeInBytes(); }
            };
            if (name == L"PrivatePageCount") return
            {
                [object] { return object.PrivatePageCount(); }
            };
            if (name == L"VirtualMemorySizeInBytes") return
            {
                [object] { return object.VirtualMemorySizeInBytes(); }
            };
            if (name == L"WorkingSetSizeInBytes") return
            {
                [object] { return object.WorkingSetSizeInBytes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::SystemCpuUsageReport, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::SystemCpuUsageReport const& object, hstring const& name)
        {
            if (name == L"KernelTime") return
            {
                [object] { return object.KernelTime(); }
            ...
            if (name == L"IdleTime") return
            {
                [object] { return object.IdleTime(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::System::Diagnostics::SystemDiagnosticInfo, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::SystemDiagnosticInfo const& object, hstring const& name)
        {
            if (name == L"MemoryUsage") return
            {
                [object] { return object.MemoryUsage(); }
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::SystemMemoryUsageReport, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::SystemMemoryUsageReport const& object, hstring const& name)
        {
            if (name == L"TotalPhysicalSizeInBytes") return
            {
                [object] { return object.TotalPhysicalSizeInBytes(); }
            };
            if (name == L"AvailableSizeInBytes") return
            {
                [object] { return object.AvailableSizeInBytes(); }
            };
            if (name == L"CommittedSizeInBytes") return
            {
                [object] { return object.CommittedSizeInBytes(); }
            };
            return {};
        }
    };
