...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Storage::AccessCache::AccessListEntryView, U>
    {
        static xaml_binding bind(Windows::Storage::AccessCache::AccessListEntryView const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::AccessCache::ItemRemovedEventArgs, U>
    {
        static xaml_binding bind(Windows::Storage::AccessCache::ItemRemovedEventArgs const& object, hstring const& name)
        {
            if (name == L"RemovedEntry") return
            {
                [object] { return object.RemovedEntry(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::AccessCache::StorageItemAccessList, U>
    {
        static xaml_binding bind(Windows::Storage::AccessCache::StorageItemAccessList const& object, hstring const& name)
        {
            if (name == L"Entries") return
            {
                [object] { return object.Entries(); }
            };
            if (name == L"MaximumItemsAllowed") return
            {
                [object] { return object.MaximumItemsAllowed(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::AccessCache::StorageItemMostRecentlyUsedList, U>
    {
        static xaml_binding bind(Windows::Storage::AccessCache::StorageItemMostRecentlyUsedList const& object, hstring const& name)
        {
            if (name == L"Entries") return
            {
                [object] { return object.Entries(); }
