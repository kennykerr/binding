...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountClientView, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountClientView const& object, hstring const& name)
        {
            if (name == L"ApplicationCallbackUri") return
            {
                [object] { return object.ApplicationCallbackUri(); }
            };
            if (name == L"Type") return
            {
                [object] { return object.Type(); }
            };
            if (name == L"AccountPairwiseId") return
            {
                [object] { return object.AccountPairwiseId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderAddAccountOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderAddAccountOperation const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderDeleteAccountOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderDeleteAccountOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderGetTokenSilentOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderGetTokenSilentOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
            };
            if (name == L"ProviderRequest") return
            {
                [object] { return object.ProviderRequest(); }
            };
            if (name == L"ProviderResponses") return
            {
                [object] { return object.ProviderResponses(); }
            };
            if (name == L"CacheExpirationTime") return
            {
                [object] { return object.CacheExpirationTime(); },
                [object](auto&& value) { object.CacheExpirationTime(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderManageAccountOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderManageAccountOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderRequestTokenOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderRequestTokenOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderRetrieveCookiesOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderRetrieveCookiesOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderSignOutAccountOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderSignOutAccountOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebAccountProviderTriggerDetails, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebAccountProviderTriggerDetails const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebProviderTokenRequest, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebProviderTokenRequest const& object, hstring const& name)
        {
            if (name == L"ClientRequest") return
            {
                [object] { return object.ClientRequest(); }
            };
            if (name == L"WebAccounts") return
            {
                [object] { return object.WebAccounts(); }
            };
            if (name == L"WebAccountSelectionOptions") return
            {
                [object] { return object.WebAccountSelectionOptions(); }
            };
            if (name == L"ApplicationCallbackUri") return
            {
                [object] { return object.ApplicationCallbackUri(); }
            };
            if (name == L"ApplicationPackageFamilyName") return
            {
                [object] { return object.ApplicationPackageFamilyName(); }
            };
            if (name == L"ApplicationProcessName") return
            {
                [object] { return object.ApplicationProcessName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Authentication::Web::Provider::WebProviderTokenResponse, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::Provider::WebProviderTokenResponse const& object, hstring const& name)
        {
            if (name == L"ClientResponse") return
            {
                [object] { return object.ClientResponse(); }
            };
            return {};
        }
    };
