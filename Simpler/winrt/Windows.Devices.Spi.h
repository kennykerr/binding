...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Devices_Spi_ISpiConnectionSettings<D>::Mode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Spi::ISpiConnectionSettings)->get_Mode(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Devices_Spi_ISpiConnectionSettings<D>::SharingMode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Spi::ISpiConnectionSettings)->get_SharingMode(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Devices::Spi::SpiBusInfo, U>
    {
        static xaml_binding bind(Windows::Devices::Spi::SpiBusInfo const& object, hstring const& name)
        {
            if (name == L"ChipSelectLineCount") return
            {
                [object] { return object.ChipSelectLineCount(); }
            };
            if (name == L"MinClockFrequency") return
            {
                [object] { return object.MinClockFrequency(); }
            };
            if (name == L"MaxClockFrequency") return
            {
                [object] { return object.MaxClockFrequency(); }
            };
            if (name == L"SupportedDataBitLengths") return
            {
                [object] { return object.SupportedDataBitLengths(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Spi::SpiConnectionSettings, U>
    {
        static xaml_binding bind(Windows::Devices::Spi::SpiConnectionSettings const& object, hstring const& name)
        {
            if (name == L"ChipSelectLine") return
            {
                [object] { return object.ChipSelectLine(); },
                [object](auto&& value) { object.ChipSelectLine(value); }
            };
            ...
            if (name == L"DataBitLength") return
            {
                [object] { return object.DataBitLength(); },
                [object](auto&& value) { object.DataBitLength(value); }
            };
            if (name == L"ClockFrequency") return
            {
                [object] { return object.ClockFrequency(); },
                [object](auto&& value) { object.ClockFrequency(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Spi::SpiDevice, U>
    {
        static xaml_binding bind(Windows::Devices::Spi::SpiDevice const& object, hstring const& name)
        {
