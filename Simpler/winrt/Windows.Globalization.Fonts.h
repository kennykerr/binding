...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Globalization::Fonts::LanguageFont, U>
    {
        static xaml_binding bind(Windows::Globalization::Fonts::LanguageFont const& object, hstring const& name)
        {
            ...
            if (name == L"ScaleFactor") return
            {
                [object] { return object.ScaleFactor(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Globalization::Fonts::LanguageFontGroup, U>
    {
        static xaml_binding bind(Windows::Globalization::Fonts::LanguageFontGroup const& object, hstring const& name)
        {
            if (name == L"UITextFont") return
            {
                [object] { return object.UITextFont(); }
            };
            if (name == L"UIHeadingFont") return
            {
                [object] { return object.UIHeadingFont(); }
            };
            if (name == L"UITitleFont") return
            {
                [object] { return object.UITitleFont(); }
            };
            if (name == L"UICaptionFont") return
            {
                [object] { return object.UICaptionFont(); }
            };
            if (name == L"UINotificationHeadingFont") return
            {
                [object] { return object.UINotificationHeadingFont(); }
            };
            if (name == L"TraditionalDocumentFont") return
            {
                [object] { return object.TraditionalDocumentFont(); }
            };
            if (name == L"ModernDocumentFont") return
            {
                [object] { return object.ModernDocumentFont(); }
            };
            if (name == L"DocumentHeadingFont") return
            {
                [object] { return object.DocumentHeadingFont(); }
            };
            if (name == L"FixedWidthTextFont") return
            {
                [object] { return object.FixedWidthTextFont(); }
            };
            if (name == L"DocumentAlternate1Font") return
            {
                [object] { return object.DocumentAlternate1Font(); }
            };
            if (name == L"DocumentAlternate2Font") return
            {
                [object] { return object.DocumentAlternate2Font(); }
            };
            return {};
        }
    };
