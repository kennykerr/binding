...
{
    template <> struct category<Windows::Perception::Automation::Core::ICorePerceptionAutomationStatics>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::Perception::Automation::Core::CorePerceptionAutomation>
    {
        using type = class_category;
    };
    template <> struct name<Windows::Perception::Automation::Core::ICorePerceptionAutomationStatics>
    {
        static constexpr auto & value{ L"Windows.Perception.Automation.Core.ICorePerceptionAutomationStatics" };
    };
    template <> struct name<Windows::Perception::Automation::Core::CorePerceptionAutomation>
    {
        static constexpr auto & value{ L"Windows.Perception.Automation.Core.CorePerceptionAutomation" };
    };
    template <> struct guid_storage<Windows::Perception::Automation::Core::ICorePerceptionAutomationStatics>
    {
        static constexpr guid value{ 0x0BB04541,0x4CE2,0x4923,{ 0x9A,0x76,0x81,0x87,0xEC,0xC5,0x91,0x12 } };
    };
