...
{
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewStatics>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs>
    {
        using type = class_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs>
    {
        using type = class_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview>
    {
        using type = class_category;
    };
    template <> struct category<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions>
    {
        using type = class_category;
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INotePlacementChangedPreviewEventArgs" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INoteVisibilityChangedPreviewEventArgs" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INotesWindowManagerPreview" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INotesWindowManagerPreview2" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INotesWindowManagerPreviewShowNoteOptions" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewStatics>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.INotesWindowManagerPreviewStatics" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.NotePlacementChangedPreviewEventArgs" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.NoteVisibilityChangedPreviewEventArgs" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview" };
    };
    template <> struct name<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions>
    {
        static constexpr auto & value{ L"Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreviewShowNoteOptions" };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs>
    {
        static constexpr guid value{ 0x491D57B7,0xF780,0x4E7F,{ 0xA9,0x39,0x9A,0x4C,0xAF,0x96,0x52,0x14 } };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs>
    {
        static constexpr guid value{ 0x0E34649E,0x3815,0x4FF6,{ 0x83,0xB3,0xA1,0x4D,0x17,0x12,0x0E,0x24 } };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>
    {
        static constexpr guid value{ 0xDC2AC23E,0x4850,0x4F13,{ 0x9C,0xC7,0xFF,0x48,0x7E,0xFD,0xFC,0xDE } };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        static constexpr guid value{ 0xEDFE864A,0x1F54,0x4B09,{ 0x98,0x23,0xFF,0x47,0x7F,0x6F,0xA3,0xBC } };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
    {
        static constexpr guid value{ 0x886B09D6,0xA6AE,0x4007,{ 0xA5,0x6D,0x1C,0xA7,0x0C,0x84,0xC0,0xD2 } };
    };
    template <> struct guid_storage<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewStatics>
    {
        static constexpr guid value{ 0x6668CC88,0x0A8E,0x4127,{ 0xA3,0x8E,0x99,0x54,0x45,0x86,0x8A,0x78 } };
    };
    template <> struct default_interface<Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs>
    {
        using type = Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs;
    };
    template <> struct default_interface<Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs>
    {
        using type = Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs;
    };
    template <> struct default_interface<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview>
    {
        using type = Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview;
    };
    template <> struct default_interface<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions>
    {
        using type = Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions;
    };
    ...
    struct consume_Windows_ApplicationModel_Preview_Notes_INotesWindowManagerPreview
    {
        ...
        auto ShowNoteWithPlacement(int32_t noteViewId, Windows::Storage::Streams::IBuffer const& data) const;
        auto HideNote(int32_t noteViewId) const;
        auto GetNotePlacement(int32_t noteViewId) const;
        auto TrySetNoteSize(int32_t noteViewId, Windows::Foundation::Size const& size) const;
        auto SetFocusToNextView() const;
        auto SetNotesThumbnailAsync(Windows::Storage::Streams::IBuffer const& thumbnail) const;
        auto SystemLockStateChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview, Windows::Foundation::IInspectable> const& handler) const;
        ...
        auto NotePlacementChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview, Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs> const& handler) const;
        ...
        auto NoteVisibilityChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview, Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs> const& handler) const;
    ...
    {
        auto ShowNoteRelativeTo(int32_t noteViewId, int32_t anchorNoteViewId, Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions const& options) const;
        auto ShowNoteWithPlacement(int32_t noteViewId, Windows::Storage::Streams::IBuffer const& data, Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions const& options) const;
        auto SetFocusToPreviousView() const;
        auto SetThumbnailImageForTaskSwitcherAsync(Windows::Graphics::Imaging::SoftwareBitmap const& bitmap) const;
    };
