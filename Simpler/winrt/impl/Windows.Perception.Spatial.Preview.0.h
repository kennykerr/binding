...
{
    template <> struct category<Windows::Perception::Spatial::Preview::ISpatialGraphInteropFrameOfReferencePreview>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics2>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::Perception::Spatial::Preview::SpatialGraphInteropFrameOfReferencePreview>
    {
        using type = class_category;
    };
    template <> struct category<Windows::Perception::Spatial::Preview::SpatialGraphInteropPreview>
    {
        using type = class_category;
    };
    template <> struct name<Windows::Perception::Spatial::Preview::ISpatialGraphInteropFrameOfReferencePreview>
    {
        static constexpr auto & value{ L"Windows.Perception.Spatial.Preview.ISpatialGraphInteropFrameOfReferencePreview" };
    };
    template <> struct name<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics>
    {
        static constexpr auto & value{ L"Windows.Perception.Spatial.Preview.ISpatialGraphInteropPreviewStatics" };
    };
    template <> struct name<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics2>
    {
        static constexpr auto & value{ L"Windows.Perception.Spatial.Preview.ISpatialGraphInteropPreviewStatics2" };
    };
    template <> struct name<Windows::Perception::Spatial::Preview::SpatialGraphInteropFrameOfReferencePreview>
    {
        static constexpr auto & value{ L"Windows.Perception.Spatial.Preview.SpatialGraphInteropFrameOfReferencePreview" };
    };
    template <> struct name<Windows::Perception::Spatial::Preview::SpatialGraphInteropPreview>
    {
        static constexpr auto & value{ L"Windows.Perception.Spatial.Preview.SpatialGraphInteropPreview" };
    };
    template <> struct guid_storage<Windows::Perception::Spatial::Preview::ISpatialGraphInteropFrameOfReferencePreview>
    {
        static constexpr guid value{ 0xA8271B23,0x735F,0x5729,{ 0xA9,0x8E,0xE6,0x4E,0xD1,0x89,0xAB,0xC5 } };
    };
    template <> struct guid_storage<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics>
    {
        static constexpr guid value{ 0xC042644C,0x20D8,0x4ED0,{ 0xAE,0xF7,0x68,0x05,0xB8,0xE5,0x3F,0x55 } };
    };
    template <> struct guid_storage<Windows::Perception::Spatial::Preview::ISpatialGraphInteropPreviewStatics2>
    {
        static constexpr guid value{ 0x2490B15F,0x6CBD,0x4B1E,{ 0xB7,0x65,0x31,0xE4,0x62,0xA3,0x2D,0xF2 } };
    };
    template <> struct default_interface<Windows::Perception::Spatial::Preview::SpatialGraphInteropFrameOfReferencePreview>
    {
        using type = Windows::Perception::Spatial::Preview::ISpatialGraphInteropFrameOfReferencePreview;
    };
