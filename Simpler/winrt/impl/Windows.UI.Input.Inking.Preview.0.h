...
{
    template <> struct category<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreview>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>
    {
        using type = interface_category;
    };
    template <> struct category<Windows::UI::Input::Inking::Preview::PalmRejectionDelayZonePreview>
    {
        using type = class_category;
    };
    template <> struct name<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreview>
    {
        static constexpr auto & value{ L"Windows.UI.Input.Inking.Preview.IPalmRejectionDelayZonePreview" };
    };
    template <> struct name<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>
    {
        static constexpr auto & value{ L"Windows.UI.Input.Inking.Preview.IPalmRejectionDelayZonePreviewStatics" };
    };
    template <> struct name<Windows::UI::Input::Inking::Preview::PalmRejectionDelayZonePreview>
    {
        static constexpr auto & value{ L"Windows.UI.Input.Inking.Preview.PalmRejectionDelayZonePreview" };
    };
    template <> struct guid_storage<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreview>
    {
        static constexpr guid value{ 0x62B496CB,0x539D,0x5343,{ 0xA6,0x5F,0x41,0xF5,0x30,0x0E,0xC7,0x0C } };
    };
    template <> struct guid_storage<Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics>
    {
        static constexpr guid value{ 0xCDEF5EE0,0x93D0,0x53A9,{ 0x8F,0x0E,0x9A,0x37,0x9F,0x8F,0x75,0x30 } };
    };
    template <> struct default_interface<Windows::UI::Input::Inking::Preview::PalmRejectionDelayZonePreview>
    {
        using type = Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreview;
    };
