...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Ocr::OcrEngine, U>
    {
        static xaml_binding bind(Windows::Media::Ocr::OcrEngine const& object, hstring const& name)
        {
            if (name == L"RecognizerLanguage") return
            {
                [object] { return object.RecognizerLanguage(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Ocr::OcrLine, U>
    {
        static xaml_binding bind(Windows::Media::Ocr::OcrLine const& object, hstring const& name)
        {
            if (name == L"Words") return
            {
                [object] { return object.Words(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::Ocr::OcrResult, U>
    {
        static xaml_binding bind(Windows::Media::Ocr::OcrResult const& object, hstring const& name)
        {
            if (name == L"Lines") return
            {
                [object] { return object.Lines(); }
            };
            if (name == L"TextAngle") return
            {
                [object] { return object.TextAngle(); }
            };
            if (name == L"Text") return
            {
                [object] { return object.Text(); }
    ...
    template <typename U> struct bindable<Windows::Media::Ocr::OcrWord, U>
    {
        static xaml_binding bind(Windows::Media::Ocr::OcrWord const& object, hstring const& name)
        {
