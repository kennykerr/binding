...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Display::DisplayMonitor, U>
    {
        static xaml_binding bind(Windows::Devices::Display::DisplayMonitor const& object, hstring const& name)
        {
            ...
            if (name == L"ConnectionKind") return
            {
                [object] { return object.ConnectionKind(); }
            };
            if (name == L"PhysicalConnector") return
            {
                [object] { return object.PhysicalConnector(); }
            };
            if (name == L"DisplayAdapterDeviceId") return
            {
                [object] { return object.DisplayAdapterDeviceId(); }
            };
            if (name == L"DisplayAdapterId") return
            {
                [object] { return object.DisplayAdapterId(); }
            };
            if (name == L"DisplayAdapterTargetId") return
            {
                [object] { return object.DisplayAdapterTargetId(); }
            };
            if (name == L"UsageKind") return
            {
                [object] { return object.UsageKind(); }
            };
            if (name == L"NativeResolutionInRawPixels") return
            {
                [object] { return object.NativeResolutionInRawPixels(); }
            };
            if (name == L"PhysicalSizeInInches") return
            {
                [object] { return object.PhysicalSizeInInches(); }
            };
