...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_ICertificateChain<D>::Validate() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICertificateChain)->Validate(put_abi(status)));
        return status;
    }
    ...
    {
        Windows::Security::Cryptography::Certificates::ChainValidationResult status;
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICertificateChain)->ValidateWithParameters(*(void**)(&parameter), put_abi(status)));
        return status;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_ICertificateRequestProperties<D>::Exportable() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICertificateRequestProperties)->get_Exportable(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_ICertificateRequestProperties<D>::KeyUsages() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICertificateRequestProperties)->get_KeyUsages(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_ICertificateRequestProperties<D>::KeyProtectionLevel() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICertificateRequestProperties)->get_KeyProtectionLevel(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_IChainValidationParameters<D>::CertificateChainPolicy() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::IChainValidationParameters)->get_CertificateChainPolicy(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_ICmsAttachedSignature<D>::VerifySignature() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::ICmsAttachedSignature)->VerifySignature(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Security::Cryptography::Certificates::ExportOption value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::IPfxImportParameters)->get_Exportable(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Security::Cryptography::Certificates::KeyProtectionLevel value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::IPfxImportParameters)->get_KeyProtectionLevel(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Cryptography_Certificates_IPfxImportParameters<D>::InstallOptions() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Cryptography::Certificates::IPfxImportParameters)->get_InstallOptions(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::Certificate, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::Certificate const& object, hstring const& name)
        {
            ...
            if (name == L"Issuer") return
            {
                [object] { return object.Issuer(); }
            };
            if (name == L"HasPrivateKey") return
            {
                [object] { return object.HasPrivateKey(); }
            };
            if (name == L"IsStronglyProtected") return
            {
                [object] { return object.IsStronglyProtected(); }
            };
            if (name == L"ValidFrom") return
            {
                [object] { return object.ValidFrom(); }
            };
            if (name == L"ValidTo") return
            {
                [object] { return object.ValidTo(); }
            };
            if (name == L"EnhancedKeyUsages") return
            {
                [object] { return object.EnhancedKeyUsages(); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); },
                [object](auto&& value) { object.FriendlyName(value); }
            };
            if (name == L"IsSecurityDeviceBound") return
            {
                [object] { return object.IsSecurityDeviceBound(); }
            };
            if (name == L"KeyUsages") return
            {
                [object] { return object.KeyUsages(); }
            };
            if (name == L"KeyAlgorithmName") return
            {
                [object] { return object.KeyAlgorithmName(); }
            };
            if (name == L"SignatureAlgorithmName") return
            {
                [object] { return object.SignatureAlgorithmName(); }
            };
            if (name == L"SignatureHashAlgorithmName") return
            {
                [object] { return object.SignatureHashAlgorithmName(); }
            };
            if (name == L"SubjectAlternativeName") return
            {
                [object] { return object.SubjectAlternativeName(); }
            };
            if (name == L"IsPerUser") return
            {
                [object] { return object.IsPerUser(); }
            };
            if (name == L"StoreName") return
            {
                [object] { return object.StoreName(); }
            };
            if (name == L"KeyStorageProviderName") return
            {
                [object] { return object.KeyStorageProviderName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CertificateExtension, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CertificateExtension const& object, hstring const& name)
        {
            if (name == L"ObjectId") return
            {
                [object] { return object.ObjectId(); },
                [object](auto&& value) { object.ObjectId(value); }
            };
            if (name == L"IsCritical") return
            {
                [object] { return object.IsCritical(); },
                [object](auto&& value) { object.IsCritical(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CertificateKeyUsages, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CertificateKeyUsages const& object, hstring const& name)
        {
            if (name == L"EncipherOnly") return
            {
                [object] { return object.EncipherOnly(); },
                [object](auto&& value) { object.EncipherOnly(value); }
            };
            if (name == L"CrlSign") return
            {
                [object] { return object.CrlSign(); },
                [object](auto&& value) { object.CrlSign(value); }
            };
            if (name == L"KeyCertificateSign") return
            {
                [object] { return object.KeyCertificateSign(); },
                [object](auto&& value) { object.KeyCertificateSign(value); }
            };
            if (name == L"KeyAgreement") return
            {
                [object] { return object.KeyAgreement(); },
                [object](auto&& value) { object.KeyAgreement(value); }
            };
            if (name == L"DataEncipherment") return
            {
                [object] { return object.DataEncipherment(); },
                [object](auto&& value) { object.DataEncipherment(value); }
            };
            if (name == L"KeyEncipherment") return
            {
                [object] { return object.KeyEncipherment(); },
                [object](auto&& value) { object.KeyEncipherment(value); }
            };
            if (name == L"NonRepudiation") return
            {
                [object] { return object.NonRepudiation(); },
                [object](auto&& value) { object.NonRepudiation(value); }
            };
            if (name == L"DigitalSignature") return
            {
                [object] { return object.DigitalSignature(); },
                [object](auto&& value) { object.DigitalSignature(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CertificateQuery, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CertificateQuery const& object, hstring const& name)
        {
            if (name == L"EnhancedKeyUsages") return
            {
                [object] { return object.EnhancedKeyUsages(); }
            };
            if (name == L"IssuerName") return
            {
                [object] { return object.IssuerName(); },
                [object](auto&& value) { object.IssuerName(value); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); },
            ...
            if (name == L"Thumbprint") return
            {
                [object] { return object.Thumbprint(); },
                [object](auto&& value) { object.Thumbprint(value); }
            };
            if (name == L"HardwareOnly") return
            {
                [object] { return object.HardwareOnly(); },
                [object](auto&& value) { object.HardwareOnly(value); }
            };
            if (name == L"IncludeDuplicates") return
            {
                [object] { return object.IncludeDuplicates(); },
                [object](auto&& value) { object.IncludeDuplicates(value); }
            };
            if (name == L"IncludeExpiredCertificates") return
            {
                [object] { return object.IncludeExpiredCertificates(); },
                [object](auto&& value) { object.IncludeExpiredCertificates(value); }
            };
            if (name == L"StoreName") return
            {
                [object] { return object.StoreName(); },
                [object](auto&& value) { object.StoreName(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CertificateRequestProperties, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CertificateRequestProperties const& object, hstring const& name)
        {
            if (name == L"Subject") return
            {
                [object] { return object.Subject(); },
            ...
            {
                [object] { return object.KeyAlgorithmName(); },
                [object](auto&& value) { object.KeyAlgorithmName(value); }
            };
            if (name == L"KeySize") return
            {
                [object] { return object.KeySize(); },
                [object](auto&& value) { object.KeySize(value); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); },
            ...
            if (name == L"HashAlgorithmName") return
            {
                [object] { return object.HashAlgorithmName(); },
                [object](auto&& value) { object.HashAlgorithmName(value); }
            };
            if (name == L"Exportable") return
            {
                [object] { return object.Exportable(); },
                [object](auto&& value) { object.Exportable(value); }
            };
            if (name == L"KeyUsages") return
            {
                [object] { return object.KeyUsages(); },
                [object](auto&& value) { object.KeyUsages(value); }
            };
            if (name == L"KeyProtectionLevel") return
            {
                [object] { return object.KeyProtectionLevel(); },
                [object](auto&& value) { object.KeyProtectionLevel(value); }
            };
            if (name == L"KeyStorageProviderName") return
            {
                [object] { return object.KeyStorageProviderName(); },
                [object](auto&& value) { object.KeyStorageProviderName(value); }
            };
            if (name == L"SmartcardReaderName") return
            {
                [object] { return object.SmartcardReaderName(); },
                [object](auto&& value) { object.SmartcardReaderName(value); }
            };
            if (name == L"SigningCertificate") return
            {
                [object] { return object.SigningCertificate(); },
                [object](auto&& value) { object.SigningCertificate(value); }
            };
            if (name == L"AttestationCredentialCertificate") return
            {
                [object] { return object.AttestationCredentialCertificate(); },
                [object](auto&& value) { object.AttestationCredentialCertificate(value); }
            };
            if (name == L"CurveName") return
            {
                [object] { return object.CurveName(); },
                [object](auto&& value) { object.CurveName(value); }
            };
            if (name == L"CurveParameters") return
            {
                [object] { return object.CurveParameters(); },
                [object](auto&& value) { object.CurveParameters(value); }
            };
            if (name == L"ContainerNamePrefix") return
            {
                [object] { return object.ContainerNamePrefix(); },
                [object](auto&& value) { object.ContainerNamePrefix(value); }
            };
            if (name == L"ContainerName") return
            {
                [object] { return object.ContainerName(); },
                [object](auto&& value) { object.ContainerName(value); }
            };
            if (name == L"UseExistingKey") return
            {
                [object] { return object.UseExistingKey(); },
                [object](auto&& value) { object.UseExistingKey(value); }
            };
            if (name == L"SuppressedDefaults") return
            {
                [object] { return object.SuppressedDefaults(); }
            };
            if (name == L"SubjectAlternativeName") return
            {
                [object] { return object.SubjectAlternativeName(); }
            };
            if (name == L"Extensions") return
            {
                [object] { return object.Extensions(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CertificateStore, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CertificateStore const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::ChainBuildingParameters, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::ChainBuildingParameters const& object, hstring const& name)
        {
            if (name == L"EnhancedKeyUsages") return
            {
                [object] { return object.EnhancedKeyUsages(); }
            };
            if (name == L"ValidationTimestamp") return
            {
                [object] { return object.ValidationTimestamp(); },
                [object](auto&& value) { object.ValidationTimestamp(value); }
            };
            if (name == L"RevocationCheckEnabled") return
            {
                [object] { return object.RevocationCheckEnabled(); },
                [object](auto&& value) { object.RevocationCheckEnabled(value); }
            };
            if (name == L"NetworkRetrievalEnabled") return
            {
                [object] { return object.NetworkRetrievalEnabled(); },
                [object](auto&& value) { object.NetworkRetrievalEnabled(value); }
            };
            if (name == L"AuthorityInformationAccessEnabled") return
            {
                [object] { return object.AuthorityInformationAccessEnabled(); },
                [object](auto&& value) { object.AuthorityInformationAccessEnabled(value); }
            };
            if (name == L"CurrentTimeValidationEnabled") return
            {
                [object] { return object.CurrentTimeValidationEnabled(); },
                [object](auto&& value) { object.CurrentTimeValidationEnabled(value); }
            };
            if (name == L"ExclusiveTrustRoots") return
            {
                [object] { return object.ExclusiveTrustRoots(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::ChainValidationParameters, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::ChainValidationParameters const& object, hstring const& name)
        {
            if (name == L"CertificateChainPolicy") return
            {
                [object] { return object.CertificateChainPolicy(); },
                [object](auto&& value) { object.CertificateChainPolicy(value); }
            };
            if (name == L"ServerDnsName") return
            {
                [object] { return object.ServerDnsName(); },
                [object](auto&& value) { object.ServerDnsName(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CmsAttachedSignature, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CmsAttachedSignature const& object, hstring const& name)
        {
            ...
            if (name == L"Signers") return
            {
                [object] { return object.Signers(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CmsDetachedSignature, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CmsDetachedSignature const& object, hstring const& name)
        {
            if (name == L"Certificates") return
            {
                [object] { return object.Certificates(); }
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CmsSignerInfo, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CmsSignerInfo const& object, hstring const& name)
        {
            if (name == L"Certificate") return
            {
                [object] { return object.Certificate(); },
                [object](auto&& value) { object.Certificate(value); }
            };
            if (name == L"HashAlgorithmName") return
            {
                [object] { return object.HashAlgorithmName(); },
            ...
            if (name == L"TimestampInfo") return
            {
                [object] { return object.TimestampInfo(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::CmsTimestampInfo, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::CmsTimestampInfo const& object, hstring const& name)
        {
            if (name == L"SigningCertificate") return
            {
                [object] { return object.SigningCertificate(); }
    ...
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::PfxImportParameters, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::PfxImportParameters const& object, hstring const& name)
        {
            if (name == L"Exportable") return
            {
                [object] { return object.Exportable(); },
            ...
            if (name == L"InstallOptions") return
            {
                [object] { return object.InstallOptions(); },
                [object](auto&& value) { object.InstallOptions(value); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); },
            ...
            if (name == L"ReaderName") return
            {
                [object] { return object.ReaderName(); },
                [object](auto&& value) { object.ReaderName(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::SubjectAlternativeNameInfo, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::SubjectAlternativeNameInfo const& object, hstring const& name)
        {
            if (name == L"EmailName") return
            {
                [object] { return object.EmailName(); }
            };
            if (name == L"IPAddress") return
            {
                [object] { return object.IPAddress(); }
            };
            if (name == L"Url") return
            {
                [object] { return object.Url(); }
            };
            if (name == L"DnsName") return
            {
                [object] { return object.DnsName(); }
            };
            if (name == L"DistinguishedName") return
            {
                [object] { return object.DistinguishedName(); }
            };
            if (name == L"PrincipalName") return
            {
                [object] { return object.PrincipalName(); }
            };
            if (name == L"EmailNames") return
            {
                [object] { return object.EmailNames(); }
            };
            if (name == L"IPAddresses") return
            {
                [object] { return object.IPAddresses(); }
            };
            if (name == L"Urls") return
            {
                [object] { return object.Urls(); }
            };
            if (name == L"DnsNames") return
            {
                [object] { return object.DnsNames(); }
            };
            if (name == L"DistinguishedNames") return
            {
                [object] { return object.DistinguishedNames(); }
            };
            if (name == L"PrincipalNames") return
            {
                [object] { return object.PrincipalNames(); }
            };
            if (name == L"Extension") return
            {
                [object] { return object.Extension(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Cryptography::Certificates::UserCertificateStore, U>
    {
        static xaml_binding bind(Windows::Security::Cryptography::Certificates::UserCertificateStore const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
