...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"HasPreviousContentExpired") return
            {
                [object] { return object.HasPreviousContentExpired(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentCollection, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentCollection const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"Collections") return
            {
                [object] { return object.Collections(); }
            };
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentContainer, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentContainer const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentImage, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentImage const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentItem, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentItem const& object, hstring const& name)
        {
            if (name == L"Path") return
            {
                [object] { return object.Path(); }
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentItemState, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentItemState const& object, hstring const& name)
        {
            if (name == L"ShouldDisplay") return
            {
                [object] { return object.ShouldDisplay(); }
            };
            if (name == L"AppInstallationState") return
            {
                [object] { return object.AppInstallationState(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentObject, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentObject const& object, hstring const& name)
        {
            if (name == L"ObjectKind") return
            {
                [object] { return object.ObjectKind(); }
            };
            if (name == L"Collection") return
            {
                [object] { return object.Collection(); }
            };
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentSubscription, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentSubscription const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentSubscriptionOptions, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentSubscriptionOptions const& object, hstring const& name)
        {
            if (name == L"SubscriptionId") return
            {
                [object] { return object.SubscriptionId(); }
            };
            if (name == L"AllowPartialContentAvailability") return
            {
                [object] { return object.AllowPartialContentAvailability(); },
                [object](auto&& value) { object.AllowPartialContentAvailability(value); }
            };
            if (name == L"CloudQueryParameters") return
            {
                [object] { return object.CloudQueryParameters(); }
            };
            if (name == L"LocalFilters") return
            {
                [object] { return object.LocalFilters(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::TargetedContent::TargetedContentValue, U>
    {
        static xaml_binding bind(Windows::Services::TargetedContent::TargetedContentValue const& object, hstring const& name)
        {
            if (name == L"ValueKind") return
            {
                [object] { return object.ValueKind(); }
            };
            if (name == L"Path") return
            {
                [object] { return object.Path(); }
            };
            if (name == L"String") return
            {
                [object] { return object.String(); }
            };
            ...
            if (name == L"Boolean") return
            {
                [object] { return object.Boolean(); }
            };
            if (name == L"File") return
            {
                [object] { return object.File(); }
            };
            if (name == L"ImageFile") return
            {
                [object] { return object.ImageFile(); }
            };
            if (name == L"Action") return
            {
                [object] { return object.Action(); }
            };
            if (name == L"Strings") return
            {
                [object] { return object.Strings(); }
            };
            if (name == L"Uris") return
            {
                [object] { return object.Uris(); }
            };
            if (name == L"Numbers") return
            {
                [object] { return object.Numbers(); }
            };
            if (name == L"Booleans") return
            {
                [object] { return object.Booleans(); }
            };
            if (name == L"Files") return
            {
                [object] { return object.Files(); }
            };
            if (name == L"ImageFiles") return
            {
                [object] { return object.ImageFiles(); }
            };
