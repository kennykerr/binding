...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Management::Update::PreviewBuildsManager, U>
    {
        static xaml_binding bind(Windows::Management::Update::PreviewBuildsManager const& object, hstring const& name)
        {
            if (name == L"ArePreviewBuildsAllowed") return
            {
                [object] { return object.ArePreviewBuildsAllowed(); },
                [object](auto&& value) { object.ArePreviewBuildsAllowed(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Management::Update::PreviewBuildsState, U>
    {
        static xaml_binding bind(Windows::Management::Update::PreviewBuildsState const& object, hstring const& name)
        {
