...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::CurrencyFormatter, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::CurrencyFormatter const& object, hstring const& name)
        {
            ...
            if (name == L"IntegerDigits") return
            {
                [object] { return object.IntegerDigits(); },
                [object](auto&& value) { object.IntegerDigits(value); }
            };
            if (name == L"FractionDigits") return
            {
                [object] { return object.FractionDigits(); },
                [object](auto&& value) { object.FractionDigits(value); }
            };
            if (name == L"IsGrouped") return
            {
                [object] { return object.IsGrouped(); },
                [object](auto&& value) { object.IsGrouped(value); }
            };
            if (name == L"IsDecimalPointAlwaysDisplayed") return
            {
                [object] { return object.IsDecimalPointAlwaysDisplayed(); },
                [object](auto&& value) { object.IsDecimalPointAlwaysDisplayed(value); }
            };
            ...
            if (name == L"ResolvedGeographicRegion") return
            {
                [object] { return object.ResolvedGeographicRegion(); }
            };
            ...
            if (name == L"SignificantDigits") return
            {
                [object] { return object.SignificantDigits(); },
                [object](auto&& value) { object.SignificantDigits(value); }
            };
            if (name == L"NumberRounder") return
            {
                [object] { return object.NumberRounder(); },
                [object](auto&& value) { object.NumberRounder(value); }
            };
            if (name == L"IsZeroSigned") return
            {
                [object] { return object.IsZeroSigned(); },
                [object](auto&& value) { object.IsZeroSigned(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::DecimalFormatter, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::DecimalFormatter const& object, hstring const& name)
        {
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); }
    ...
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::IncrementNumberRounder, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::IncrementNumberRounder const& object, hstring const& name)
        {
            if (name == L"RoundingAlgorithm") return
            {
                [object] { return object.RoundingAlgorithm(); },
                [object](auto&& value) { object.RoundingAlgorithm(value); }
            };
            if (name == L"Increment") return
            {
                [object] { return object.Increment(); },
                [object](auto&& value) { object.Increment(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::NumeralSystemTranslator, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::NumeralSystemTranslator const& object, hstring const& name)
        {
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); }
    ...
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::PercentFormatter, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::PercentFormatter const& object, hstring const& name)
        {
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); }
    ...
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::PermilleFormatter, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::PermilleFormatter const& object, hstring const& name)
        {
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); }
    ...
    template <typename U> struct bindable<Windows::Globalization::NumberFormatting::SignificantDigitsNumberRounder, U>
    {
        static xaml_binding bind(Windows::Globalization::NumberFormatting::SignificantDigitsNumberRounder const& object, hstring const& name)
        {
            if (name == L"RoundingAlgorithm") return
            {
                [object] { return object.RoundingAlgorithm(); },
