...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Perception_Spatial_Preview_ISpatialGraphInteropPreviewStatics<D>::CreateCoordinateSystemForNode(winrt::guid const& nodeId, Windows::Foundation::Numerics::float3 const& relativePosition) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Perception_Spatial_Preview_ISpatialGraphInteropPreviewStatics<D>::CreateCoordinateSystemForNode(winrt::guid const& nodeId, Windows::Foundation::Numerics::float3 const& relativePosition, Windows::Foundation::Numerics::quaternion const& relativeOrientation) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Perception_Spatial_Preview_ISpatialGraphInteropPreviewStatics2<D>::TryCreateFrameOfReference(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Perception_Spatial_Preview_ISpatialGraphInteropPreviewStatics2<D>::TryCreateFrameOfReference(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem, Windows::Foundation::Numerics::float3 const& relativePosition) const
    {
        void* result{};
    ...
    template <typename U> struct bindable<Windows::Perception::Spatial::Preview::SpatialGraphInteropFrameOfReferencePreview, U>
    {
        static xaml_binding bind(Windows::Perception::Spatial::Preview::SpatialGraphInteropFrameOfReferencePreview const& object, hstring const& name)
        {
            if (name == L"CoordinateSystem") return
            {
                [object] { return object.CoordinateSystem(); }
            };
            if (name == L"NodeId") return
            {
                [object] { return object.NodeId(); }
            };
            if (name == L"CoordinateSystemToNodeTransform") return
            {
                [object] { return object.CoordinateSystemToNodeTransform(); }
            };
            return {};
        }
    };
