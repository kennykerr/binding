...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose<D>::TryGetViewTransform(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose<D>::TryGetCullingFrustum(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose<D>::TryGetVisibleFrustum(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose2<D>::OverrideViewTransform(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem, Windows::Graphics::Holographic::HolographicStereoTransform const& coordinateSystemToViewTransform) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose2<D>::OverrideProjectionTransform(Windows::Graphics::Holographic::HolographicStereoTransform const& projectionTransform) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraPose2<D>::OverrideViewport(Windows::Foundation::Rect const& leftViewport, Windows::Foundation::Rect const& rightViewport) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters<D>::SetFocusPoint(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem, Windows::Foundation::Numerics::float3 const& position) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters<D>::SetFocusPoint(Windows::Perception::Spatial::SpatialCoordinateSystem const& coordinateSystem, Windows::Foundation::Numerics::float3 const& position, Windows::Foundation::Numerics::float3 const& normal) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters2<D>::ReprojectionMode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicCameraRenderingParameters2)->get_ReprojectionMode(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters2<D>::ReprojectionMode(Windows::Graphics::Holographic::HolographicReprojectionMode const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicCameraRenderingParameters2<D>::CommitDirect3D11DepthBuffer(Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicDisplay3<D>::TryGetViewConfiguration(Windows::Graphics::Holographic::HolographicViewConfigurationKind const& kind) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicFrame<D>::GetRenderingParameters(Windows::Graphics::Holographic::HolographicCameraPose const& cameraPose) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicFrame<D>::PresentUsingCurrentPrediction() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicFrame)->PresentUsingCurrentPrediction(put_abi(result)));
        return result;
    }
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicFrame<D>::PresentUsingCurrentPrediction(Windows::Graphics::Holographic::HolographicFramePresentWaitBehavior const& waitBehavior) const
    {
        Windows::Graphics::Holographic::HolographicFramePresentResult result;
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicFrame)->PresentUsingCurrentPredictionWithBehavior(static_cast<int32_t>(waitBehavior), put_abi(result)));
        return result;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicFrame2<D>::GetQuadLayerUpdateParameters(Windows::Graphics::Holographic::HolographicQuadLayer const& layer) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayer<D>::PixelFormat() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicQuadLayer)->get_PixelFormat(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayerFactory<D>::Create(Windows::Foundation::Size const& size) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayerFactory<D>::CreateWithPixelFormat(Windows::Foundation::Size const& size, Windows::Graphics::DirectX::DirectXPixelFormat const& pixelFormat) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayerUpdateParameters<D>::UpdateViewport(Windows::Foundation::Rect const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayerUpdateParameters<D>::UpdateExtents(Windows::Foundation::Numerics::float2 const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicQuadLayerUpdateParameters<D>::UpdateLocationWithDisplayRelativeMode(Windows::Foundation::Numerics::float3 const& position, Windows::Foundation::Numerics::quaternion const& orientation) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace<D>::SetDirect3D11Device(Windows::Graphics::DirectX::Direct3D11::IDirect3DDevice const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicSpace)->SetDirect3D11Device(*(void**)(&value)));
    }
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace<D>::CameraAdded(Windows::Foundation::TypedEventHandler<Windows::Graphics::Holographic::HolographicSpace, Windows::Graphics::Holographic::HolographicSpaceCameraAddedEventArgs> const& handler) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace<D>::CameraRemoved(Windows::Foundation::TypedEventHandler<Windows::Graphics::Holographic::HolographicSpace, Windows::Graphics::Holographic::HolographicSpaceCameraRemovedEventArgs> const& handler) const
    {
        winrt::event_token cookie;
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace2<D>::UserPresence() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicSpace2)->get_UserPresence(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace2<D>::UserPresenceChanged(Windows::Foundation::TypedEventHandler<Windows::Graphics::Holographic::HolographicSpace, Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpace2<D>::WaitForNextFrameReadyWithHeadStart(Windows::Foundation::TimeSpan const& requestedHeadStartDuration) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpaceStatics<D>::CreateForCoreWindow(Windows::UI::Core::CoreWindow const& window) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicSpaceStatics2<D>::IsAvailableChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token;
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicViewConfiguration<D>::RequestRenderTargetSize(Windows::Foundation::Size const& size) const
    {
    ...
    {
        Windows::Graphics::DirectX::DirectXPixelFormat value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicViewConfiguration)->get_PixelFormat(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicViewConfiguration<D>::PixelFormat(Windows::Graphics::DirectX::DirectXPixelFormat const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Holographic_IHolographicViewConfiguration<D>::Kind() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Holographic::IHolographicViewConfiguration)->get_Kind(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicCamera, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicCamera const& object, hstring const& name)
        {
            if (name == L"RenderTargetSize") return
            {
                [object] { return object.RenderTargetSize(); }
            };
            if (name == L"ViewportScaleFactor") return
            {
                [object] { return object.ViewportScaleFactor(); },
                [object](auto&& value) { object.ViewportScaleFactor(value); }
            };
            ...
            if (name == L"LeftViewportParameters") return
            {
                [object] { return object.LeftViewportParameters(); }
            };
            if (name == L"RightViewportParameters") return
            {
                [object] { return object.RightViewportParameters(); }
            };
            if (name == L"Display") return
            {
                [object] { return object.Display(); }
            };
            if (name == L"IsPrimaryLayerEnabled") return
            {
                [object] { return object.IsPrimaryLayerEnabled(); },
                [object](auto&& value) { object.IsPrimaryLayerEnabled(value); }
            };
            if (name == L"MaxQuadLayerCount") return
            {
                [object] { return object.MaxQuadLayerCount(); }
            };
            if (name == L"QuadLayers") return
            {
                [object] { return object.QuadLayers(); }
            };
            if (name == L"CanOverrideViewport") return
            {
                [object] { return object.CanOverrideViewport(); }
            };
            if (name == L"IsHardwareContentProtectionSupported") return
            {
                [object] { return object.IsHardwareContentProtectionSupported(); }
            };
            if (name == L"IsHardwareContentProtectionEnabled") return
            {
                [object] { return object.IsHardwareContentProtectionEnabled(); },
                [object](auto&& value) { object.IsHardwareContentProtectionEnabled(value); }
            };
            if (name == L"ViewConfiguration") return
            {
                [object] { return object.ViewConfiguration(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicCameraPose, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicCameraPose const& object, hstring const& name)
        {
            if (name == L"HolographicCamera") return
            {
                [object] { return object.HolographicCamera(); }
            };
            if (name == L"Viewport") return
            {
                [object] { return object.Viewport(); }
            };
            if (name == L"ProjectionTransform") return
            {
                [object] { return object.ProjectionTransform(); }
            };
            if (name == L"NearPlaneDistance") return
            {
                [object] { return object.NearPlaneDistance(); }
            };
            if (name == L"FarPlaneDistance") return
            {
                [object] { return object.FarPlaneDistance(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicCameraRenderingParameters, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicCameraRenderingParameters const& object, hstring const& name)
        {
            if (name == L"Direct3D11Device") return
            {
                [object] { return object.Direct3D11Device(); }
            };
            if (name == L"Direct3D11BackBuffer") return
            {
                [object] { return object.Direct3D11BackBuffer(); }
            };
            if (name == L"ReprojectionMode") return
            {
                [object] { return object.ReprojectionMode(); },
                [object](auto&& value) { object.ReprojectionMode(value); }
            };
            if (name == L"IsContentProtectionEnabled") return
            {
                [object] { return object.IsContentProtectionEnabled(); },
                [object](auto&& value) { object.IsContentProtectionEnabled(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicCameraViewportParameters, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicCameraViewportParameters const& object, hstring const& name)
        {
            if (name == L"HiddenAreaMesh") return
            {
                [object] { return object.HiddenAreaMesh(); }
            };
            if (name == L"VisibleAreaMesh") return
            {
                [object] { return object.VisibleAreaMesh(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicDisplay, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicDisplay const& object, hstring const& name)
        {
            if (name == L"DisplayName") return
            {
                [object] { return object.DisplayName(); }
            };
            if (name == L"MaxViewportSize") return
            {
                [object] { return object.MaxViewportSize(); }
            };
            if (name == L"IsStereo") return
            {
                [object] { return object.IsStereo(); }
            };
            if (name == L"IsOpaque") return
            {
                [object] { return object.IsOpaque(); }
            };
            if (name == L"AdapterId") return
            {
                [object] { return object.AdapterId(); }
            };
            if (name == L"SpatialLocator") return
            {
                [object] { return object.SpatialLocator(); }
            };
            if (name == L"RefreshRate") return
            {
                [object] { return object.RefreshRate(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicFrame, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicFrame const& object, hstring const& name)
        {
            if (name == L"AddedCameras") return
            {
                [object] { return object.AddedCameras(); }
            };
            if (name == L"RemovedCameras") return
            {
                [object] { return object.RemovedCameras(); }
            };
            if (name == L"Duration") return
            {
                [object] { return object.Duration(); }
            };
            if (name == L"CurrentPrediction") return
            {
                [object] { return object.CurrentPrediction(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicFramePrediction, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicFramePrediction const& object, hstring const& name)
        {
            if (name == L"CameraPoses") return
            {
                [object] { return object.CameraPoses(); }
            };
    ...
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicFramePresentationReport, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicFramePresentationReport const& object, hstring const& name)
        {
            if (name == L"CompositorGpuDuration") return
            {
                [object] { return object.CompositorGpuDuration(); }
            };
            if (name == L"AppGpuDuration") return
            {
                [object] { return object.AppGpuDuration(); }
            };
            if (name == L"AppGpuOverrun") return
            {
                [object] { return object.AppGpuOverrun(); }
            };
            if (name == L"MissedPresentationOpportunityCount") return
            {
                [object] { return object.MissedPresentationOpportunityCount(); }
            };
            if (name == L"PresentationCount") return
            {
                [object] { return object.PresentationCount(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicQuadLayer, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicQuadLayer const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicQuadLayerUpdateParameters, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicQuadLayerUpdateParameters const& object, hstring const& name)
        {
            if (name == L"CanAcquireWithHardwareProtection") return
            {
                [object] { return object.CanAcquireWithHardwareProtection(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicSpace, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicSpace const& object, hstring const& name)
        {
            if (name == L"PrimaryAdapterId") return
            {
                [object] { return object.PrimaryAdapterId(); }
            };
            if (name == L"UserPresence") return
            {
                [object] { return object.UserPresence(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicSpaceCameraAddedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicSpaceCameraAddedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicSpaceCameraRemovedEventArgs, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicSpaceCameraRemovedEventArgs const& object, hstring const& name)
        {
            if (name == L"Camera") return
            {
                [object] { return object.Camera(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Holographic::HolographicViewConfiguration, U>
    {
        static xaml_binding bind(Windows::Graphics::Holographic::HolographicViewConfiguration const& object, hstring const& name)
        {
            if (name == L"NativeRenderTargetSize") return
            {
                [object] { return object.NativeRenderTargetSize(); }
            };
            if (name == L"RenderTargetSize") return
            {
                [object] { return object.RenderTargetSize(); }
            };
            if (name == L"SupportedPixelFormats") return
            {
                [object] { return object.SupportedPixelFormats(); }
            };
            if (name == L"PixelFormat") return
            {
                [object] { return object.PixelFormat(); },
