...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Storage::Search::ContentIndexer, U>
    {
        static xaml_binding bind(Windows::Storage::Search::ContentIndexer const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::Search::ContentIndexerQuery, U>
    {
        static xaml_binding bind(Windows::Storage::Search::ContentIndexerQuery const& object, hstring const& name)
        {
            if (name == L"QueryFolder") return
            {
                [object] { return object.QueryFolder(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::Search::IndexableContent, U>
    {
        static xaml_binding bind(Windows::Storage::Search::IndexableContent const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"Stream") return
            {
                ...
                [object](auto&& value) { object.Stream(value); }
            };
            if (name == L"StreamContentType") return
            {
                [object] { return object.StreamContentType(); },
                [object](auto&& value) { object.StreamContentType(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::Search::QueryOptions, U>
    {
        static xaml_binding bind(Windows::Storage::Search::QueryOptions const& object, hstring const& name)
        {
            if (name == L"FileTypeFilter") return
            {
                [object] { return object.FileTypeFilter(); }
            };
            if (name == L"FolderDepth") return
            {
                [object] { return object.FolderDepth(); },
                [object](auto&& value) { object.FolderDepth(value); }
            };
            if (name == L"ApplicationSearchFilter") return
            {
                [object] { return object.ApplicationSearchFilter(); },
                [object](auto&& value) { object.ApplicationSearchFilter(value); }
            };
            if (name == L"UserSearchFilter") return
            {
                [object] { return object.UserSearchFilter(); },
                [object](auto&& value) { object.UserSearchFilter(value); }
            };
            ...
            if (name == L"IndexerOption") return
            {
                [object] { return object.IndexerOption(); },
                [object](auto&& value) { object.IndexerOption(value); }
            };
            if (name == L"SortOrder") return
            {
                [object] { return object.SortOrder(); }
            };
            if (name == L"GroupPropertyName") return
            {
                [object] { return object.GroupPropertyName(); }
            };
            if (name == L"DateStackOption") return
            {
                [object] { return object.DateStackOption(); }
            };
            if (name == L"StorageProviderIdFilter") return
            {
                [object] { return object.StorageProviderIdFilter(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::Search::SortEntryVector, U>
    {
        static xaml_binding bind(Windows::Storage::Search::SortEntryVector const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::Search::StorageFileQueryResult, U>
    {
        static xaml_binding bind(Windows::Storage::Search::StorageFileQueryResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::Search::StorageFolderQueryResult, U>
    {
        static xaml_binding bind(Windows::Storage::Search::StorageFolderQueryResult const& object, hstring const& name)
        {
            if (name == L"Folder") return
            {
                [object] { return object.Folder(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Search::StorageItemQueryResult, U>
    {
        static xaml_binding bind(Windows::Storage::Search::StorageItemQueryResult const& object, hstring const& name)
        {
            if (name == L"Folder") return
            {
                [object] { return object.Folder(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Search::StorageLibraryChangeTrackerTriggerDetails, U>
    {
        static xaml_binding bind(Windows::Storage::Search::StorageLibraryChangeTrackerTriggerDetails const& object, hstring const& name)
        {
            if (name == L"Folder") return
            {
                [object] { return object.Folder(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Search::StorageLibraryContentChangedTriggerDetails, U>
    {
        static xaml_binding bind(Windows::Storage::Search::StorageLibraryContentChangedTriggerDetails const& object, hstring const& name)
        {
            if (name == L"Folder") return
            {
                [object] { return object.Folder(); }
    ...
    template <typename U> struct bindable<Windows::Storage::Search::ValueAndLanguage, U>
    {
        static xaml_binding bind(Windows::Storage::Search::ValueAndLanguage const& object, hstring const& name)
        {
            if (name == L"Language") return
            {
                [object] { return object.Language(); },
