...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_SerialCommunication_IErrorReceivedEventArgs<D>::Error() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::SerialCommunication::IErrorReceivedEventArgs)->get_Error(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Devices_SerialCommunication_IPinChangedEventArgs<D>::PinChange() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::SerialCommunication::IPinChangedEventArgs)->get_PinChange(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Devices_SerialCommunication_ISerialDevice<D>::Handshake() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::SerialCommunication::ISerialDevice)->get_Handshake(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Devices_SerialCommunication_ISerialDevice<D>::Parity() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::SerialCommunication::ISerialDevice)->get_Parity(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Devices_SerialCommunication_ISerialDevice<D>::StopBits() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::SerialCommunication::ISerialDevice)->get_StopBits(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Devices::SerialCommunication::ErrorReceivedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::SerialCommunication::ErrorReceivedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::SerialCommunication::PinChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::SerialCommunication::PinChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"PinChange") return
            {
                [object] { return object.PinChange(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::SerialCommunication::SerialDevice, U>
    {
        static xaml_binding bind(Windows::Devices::SerialCommunication::SerialDevice const& object, hstring const& name)
        {
            if (name == L"BaudRate") return
            {
                [object] { return object.BaudRate(); },
                [object](auto&& value) { object.BaudRate(value); }
            };
            if (name == L"BreakSignalState") return
            {
                [object] { return object.BreakSignalState(); },
                [object](auto&& value) { object.BreakSignalState(value); }
            };
            if (name == L"BytesReceived") return
            {
                [object] { return object.BytesReceived(); }
            };
            if (name == L"CarrierDetectState") return
            {
                [object] { return object.CarrierDetectState(); }
            };
            if (name == L"ClearToSendState") return
            {
                [object] { return object.ClearToSendState(); }
            };
            if (name == L"DataBits") return
            {
                [object] { return object.DataBits(); },
                [object](auto&& value) { object.DataBits(value); }
            };
            if (name == L"DataSetReadyState") return
            {
                [object] { return object.DataSetReadyState(); }
            };
            if (name == L"Handshake") return
            {
                [object] { return object.Handshake(); },
                [object](auto&& value) { object.Handshake(value); }
            };
            if (name == L"IsDataTerminalReadyEnabled") return
            {
                [object] { return object.IsDataTerminalReadyEnabled(); },
                [object](auto&& value) { object.IsDataTerminalReadyEnabled(value); }
            };
            if (name == L"IsRequestToSendEnabled") return
            {
                [object] { return object.IsRequestToSendEnabled(); },
                [object](auto&& value) { object.IsRequestToSendEnabled(value); }
            };
            if (name == L"Parity") return
            {
                [object] { return object.Parity(); },
                [object](auto&& value) { object.Parity(value); }
            };
            if (name == L"PortName") return
            {
                [object] { return object.PortName(); }
            };
            if (name == L"ReadTimeout") return
            {
                [object] { return object.ReadTimeout(); },
                [object](auto&& value) { object.ReadTimeout(value); }
            };
            if (name == L"StopBits") return
            {
                [object] { return object.StopBits(); },
                [object](auto&& value) { object.StopBits(value); }
            };
            if (name == L"UsbVendorId") return
            {
                [object] { return object.UsbVendorId(); }
            };
            if (name == L"UsbProductId") return
            {
                [object] { return object.UsbProductId(); }
            };
            if (name == L"WriteTimeout") return
            {
                [object] { return object.WriteTimeout(); },
                [object](auto&& value) { object.WriteTimeout(value); }
            };
