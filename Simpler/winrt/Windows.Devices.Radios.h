...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Radios::Radio, U>
    {
        static xaml_binding bind(Windows::Devices::Radios::Radio const& object, hstring const& name)
        {
