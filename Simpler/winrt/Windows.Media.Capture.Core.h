...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Capture::Core::VariablePhotoCapturedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Capture::Core::VariablePhotoCapturedEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"UsedFrameControllerIndex") return
            {
                [object] { return object.UsedFrameControllerIndex(); }
            };
            if (name == L"CapturedFrameControlValues") return
            {
                [object] { return object.CapturedFrameControlValues(); }
            };
            return {};
        }
    };
