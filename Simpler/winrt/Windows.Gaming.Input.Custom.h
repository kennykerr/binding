...
{
    template <typename D> auto consume_Windows_Gaming_Input_Custom_ICustomGameControllerFactory<D>::CreateGameController(Windows::Gaming::Input::Custom::IGameControllerProvider const& provider) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_ICustomGameControllerFactory<D>::OnGameControllerAdded(Windows::Gaming::Input::IGameController const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Custom::ICustomGameControllerFactory)->OnGameControllerAdded(*(void**)(&value)));
    }
    template <typename D> auto consume_Windows_Gaming_Input_Custom_ICustomGameControllerFactory<D>::OnGameControllerRemoved(Windows::Gaming::Input::IGameController const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGameControllerFactoryManagerStatics<D>::RegisterCustomFactoryForGipInterface(Windows::Gaming::Input::Custom::ICustomGameControllerFactory const& factory, winrt::guid const& interfaceId) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGameControllerFactoryManagerStatics<D>::RegisterCustomFactoryForHardwareId(Windows::Gaming::Input::Custom::ICustomGameControllerFactory const& factory, uint16_t hardwareVendorId, uint16_t hardwareProductId) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGameControllerFactoryManagerStatics2<D>::TryGetFactoryControllerFromGameController(Windows::Gaming::Input::Custom::ICustomGameControllerFactory const& factory, Windows::Gaming::Input::IGameController const& gameController) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGipFirmwareUpdateResult<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::Input::Custom::IGipFirmwareUpdateResult)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGipGameControllerInputSink<D>::OnMessageReceived(uint64_t timestamp, Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, uint8_t messageId, uint8_t sequenceId, array_view<uint8_t const> messageBuffer) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGipGameControllerProvider<D>::SendMessage(Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, uint8_t messageId, array_view<uint8_t const> messageBuffer) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGipGameControllerProvider<D>::SendReceiveMessage(Windows::Gaming::Input::Custom::GipMessageClass const& messageClass, uint8_t messageId, array_view<uint8_t const> requestMessageBuffer, array_view<uint8_t> responseMessageBuffer) const
    {
    ...
    template <typename D> auto consume_Windows_Gaming_Input_Custom_IGipGameControllerProvider<D>::UpdateFirmwareAsync(Windows::Storage::Streams::IInputStream const& firmwareImage) const
    {
        void* result{};
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::Custom::GipFirmwareUpdateResult, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Custom::GipFirmwareUpdateResult const& object, hstring const& name)
        {
            if (name == L"ExtendedErrorCode") return
            {
                [object] { return object.ExtendedErrorCode(); }
            };
            if (name == L"FinalComponentId") return
            {
                [object] { return object.FinalComponentId(); }
            };
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::Custom::GipGameControllerProvider, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Custom::GipGameControllerProvider const& object, hstring const& name)
        {
            if (name == L"FirmwareVersionInfo") return
            {
                [object] { return object.FirmwareVersionInfo(); }
            };
            if (name == L"HardwareProductId") return
            {
                [object] { return object.HardwareProductId(); }
            };
            if (name == L"HardwareVendorId") return
            {
                [object] { return object.HardwareVendorId(); }
            };
            if (name == L"HardwareVersionInfo") return
            {
                [object] { return object.HardwareVersionInfo(); }
            };
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::Custom::HidGameControllerProvider, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Custom::HidGameControllerProvider const& object, hstring const& name)
        {
            if (name == L"FirmwareVersionInfo") return
            {
                [object] { return object.FirmwareVersionInfo(); }
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::Custom::XusbGameControllerProvider, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Custom::XusbGameControllerProvider const& object, hstring const& name)
        {
            if (name == L"FirmwareVersionInfo") return
            {
                [object] { return object.FirmwareVersionInfo(); }
