...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_ICurrentAppSimulator<D>::ReloadSimulatorAsync(Windows::Storage::StorageFile const& simulatorSettingsFile) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_ICurrentAppSimulatorWithConsumables<D>::RequestProductPurchaseAsync(param::hstring const& productId, param::hstring const& offerId, Windows::ApplicationModel::Store::ProductPurchaseDisplayProperties const& displayProperties) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_ICurrentAppWithConsumables<D>::RequestProductPurchaseAsync(param::hstring const& productId, param::hstring const& offerId, Windows::ApplicationModel::Store::ProductPurchaseDisplayProperties const& displayProperties) const
    {
        void* requestProductPurchaseWithDisplayPropertiesOperation{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_ILicenseInformation<D>::LicenseChanged(Windows::ApplicationModel::Store::LicenseChangedEventHandler const& handler) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_IProductListingWithConsumables<D>::ProductType() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::IProductListingWithConsumables)->get_ProductType(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::ApplicationModel::Store::ProductType value;
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::IProductListingWithMetadata)->get_ProductType(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_IProductPurchaseDisplayProperties<D>::Image(Windows::Foundation::Uri const& value) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_IPurchaseResults<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Store::IPurchaseResults)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::LicenseInformation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::LicenseInformation const& object, hstring const& name)
        {
            if (name == L"ProductLicenses") return
            {
                [object] { return object.ProductLicenses(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::ListingInformation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::ListingInformation const& object, hstring const& name)
        {
            if (name == L"CurrentMarket") return
            {
                [object] { return object.CurrentMarket(); }
            };
            if (name == L"Description") return
            {
                [object] { return object.Description(); }
            };
            if (name == L"ProductListings") return
            {
                [object] { return object.ProductListings(); }
            };
            ...
            if (name == L"AgeRating") return
            {
                [object] { return object.AgeRating(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::ProductLicense, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::ProductLicense const& object, hstring const& name)
        {
            ...
            if (name == L"IsConsumable") return
            {
                [object] { return object.IsConsumable(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::ProductListing, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::ProductListing const& object, hstring const& name)
        {
            if (name == L"ProductId") return
            {
                [object] { return object.ProductId(); }
            ...
            if (name == L"ProductType") return
            {
                [object] { return object.ProductType(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::ProductPurchaseDisplayProperties, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::ProductPurchaseDisplayProperties const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); },
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::PurchaseResults, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::PurchaseResults const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
            };
            if (name == L"TransactionId") return
            {
                [object] { return object.TransactionId(); }
            };
            if (name == L"ReceiptXml") return
            {
                [object] { return object.ReceiptXml(); }
            };
            if (name == L"OfferId") return
            {
                [object] { return object.OfferId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::UnfulfilledConsumable, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::UnfulfilledConsumable const& object, hstring const& name)
        {
            if (name == L"ProductId") return
            {
                [object] { return object.ProductId(); }
