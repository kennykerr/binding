...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Payments_Provider_IPaymentAppCanMakePaymentTriggerDetails<D>::ReportCanMakePaymentResult(Windows::ApplicationModel::Payments::PaymentCanMakePaymentResult const& value) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Payments_Provider_IPaymentTransaction<D>::UpdateShippingAddressAsync(Windows::ApplicationModel::Payments::PaymentAddress const& shippingAddress) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Payments_Provider_IPaymentTransaction<D>::UpdateSelectedShippingOptionAsync(Windows::ApplicationModel::Payments::PaymentShippingOption const& selectedShippingOption) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Payments_Provider_IPaymentTransaction<D>::AcceptAsync(Windows::ApplicationModel::Payments::PaymentToken const& paymentToken) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Payments_Provider_IPaymentTransactionAcceptResult<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::Payments::Provider::IPaymentTransactionAcceptResult)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Payments::Provider::PaymentAppCanMakePaymentTriggerDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Payments::Provider::PaymentAppCanMakePaymentTriggerDetails const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Payments::Provider::PaymentTransaction, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Payments::Provider::PaymentTransaction const& object, hstring const& name)
        {
            if (name == L"PaymentRequest") return
            {
                [object] { return object.PaymentRequest(); }
            };
            if (name == L"PayerEmail") return
            {
                [object] { return object.PayerEmail(); },
                [object](auto&& value) { object.PayerEmail(value); }
            };
            if (name == L"PayerName") return
            {
                [object] { return object.PayerName(); },
                [object](auto&& value) { object.PayerName(value); }
            };
            if (name == L"PayerPhoneNumber") return
            {
                [object] { return object.PayerPhoneNumber(); },
                [object](auto&& value) { object.PayerPhoneNumber(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Payments::Provider::PaymentTransactionAcceptResult, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Payments::Provider::PaymentTransactionAcceptResult const& object, hstring const& name)
        {
