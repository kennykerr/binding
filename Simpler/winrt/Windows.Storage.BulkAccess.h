...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Storage::BulkAccess::FileInformation, U>
    {
        static xaml_binding bind(Windows::Storage::BulkAccess::FileInformation const& object, hstring const& name)
        {
            ...
            if (name == L"DocumentProperties") return
            {
                [object] { return object.DocumentProperties(); }
            };
            if (name == L"BasicProperties") return
            {
                [object] { return object.BasicProperties(); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::BulkAccess::FolderInformation, U>
    {
        static xaml_binding bind(Windows::Storage::BulkAccess::FolderInformation const& object, hstring const& name)
        {
            if (name == L"MusicProperties") return
            {
                [object] { return object.MusicProperties(); }
