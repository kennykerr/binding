...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Core::AnimationMetrics::AnimationDescription, U>
    {
        static xaml_binding bind(Windows::UI::Core::AnimationMetrics::AnimationDescription const& object, hstring const& name)
        {
            if (name == L"Animations") return
            {
                [object] { return object.Animations(); }
            };
            if (name == L"StaggerDelay") return
            {
                [object] { return object.StaggerDelay(); }
            };
            if (name == L"StaggerDelayFactor") return
            {
                [object] { return object.StaggerDelayFactor(); }
            };
            if (name == L"DelayLimit") return
            {
                [object] { return object.DelayLimit(); }
            };
            if (name == L"ZOrder") return
            {
                [object] { return object.ZOrder(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Core::AnimationMetrics::OpacityAnimation, U>
    {
        static xaml_binding bind(Windows::UI::Core::AnimationMetrics::OpacityAnimation const& object, hstring const& name)
        {
            ...
            if (name == L"Control1") return
            {
                [object] { return object.Control1(); }
            };
            if (name == L"Control2") return
            {
                [object] { return object.Control2(); }
            };
            if (name == L"InitialOpacity") return
            {
                [object] { return object.InitialOpacity(); }
            };
            if (name == L"FinalOpacity") return
            {
                [object] { return object.FinalOpacity(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Core::AnimationMetrics::PropertyAnimation, U>
    {
        static xaml_binding bind(Windows::UI::Core::AnimationMetrics::PropertyAnimation const& object, hstring const& name)
        {
            if (name == L"Type") return
            {
                [object] { return object.Type(); }
    ...
    template <typename U> struct bindable<Windows::UI::Core::AnimationMetrics::ScaleAnimation, U>
    {
        static xaml_binding bind(Windows::UI::Core::AnimationMetrics::ScaleAnimation const& object, hstring const& name)
        {
            if (name == L"Type") return
            {
                [object] { return object.Type(); }
            ...
            if (name == L"InitialScaleX") return
            {
                [object] { return object.InitialScaleX(); }
            };
            if (name == L"InitialScaleY") return
            {
                [object] { return object.InitialScaleY(); }
            };
            if (name == L"FinalScaleX") return
            {
                [object] { return object.FinalScaleX(); }
            };
            if (name == L"FinalScaleY") return
            {
                [object] { return object.FinalScaleY(); }
            };
            if (name == L"NormalizedOrigin") return
            {
                [object] { return object.NormalizedOrigin(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Core::AnimationMetrics::TranslationAnimation, U>
    {
        static xaml_binding bind(Windows::UI::Core::AnimationMetrics::TranslationAnimation const& object, hstring const& name)
        {
            if (name == L"Type") return
            {
                [object] { return object.Type(); }
