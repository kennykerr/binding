...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveBlobGetResult, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveBlobGetResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveBlobInfo, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveBlobInfo const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveBlobInfoGetResult, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveBlobInfoGetResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveContainer, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveContainer const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveContainerInfo, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveContainerInfo const& object, hstring const& name)
        {
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            };
            if (name == L"TotalSize") return
            {
                [object] { return object.TotalSize(); }
            };
            if (name == L"DisplayName") return
            {
                [object] { return object.DisplayName(); }
            };
            if (name == L"LastModifiedTime") return
            {
                [object] { return object.LastModifiedTime(); }
            };
            if (name == L"NeedsSync") return
            {
                [object] { return object.NeedsSync(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveContainerInfoGetResult, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveContainerInfoGetResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveOperationResult, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveOperationResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveProvider, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveProvider const& object, hstring const& name)
        {
            if (name == L"User") return
            {
                [object] { return object.User(); }
            };
            if (name == L"ContainersChangedSinceLastSync") return
            {
                [object] { return object.ContainersChangedSinceLastSync(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::XboxLive::Storage::GameSaveProviderGetResult, U>
    {
        static xaml_binding bind(Windows::Gaming::XboxLive::Storage::GameSaveProviderGetResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
