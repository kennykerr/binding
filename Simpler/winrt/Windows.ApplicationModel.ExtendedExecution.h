...
namespace winrt::impl
{
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionRevokedEventArgs<D>::Reason() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionRevokedEventArgs)->get_Reason(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_ApplicationModel_ExtendedExecution_IExtendedExecutionSession<D>::Reason() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession)->get_Reason(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionRevokedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionRevokedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionSession, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionSession const& object, hstring const& name)
        {
            if (name == L"Reason") return
            {
                [object] { return object.Reason(); },
                [object](auto&& value) { object.Reason(value); }
            };
            ...
            if (name == L"PercentProgress") return
            {
                [object] { return object.PercentProgress(); },
                [object](auto&& value) { object.PercentProgress(value); }
            };
            return {};
        }
    };
