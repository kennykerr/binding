...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Foundation::Uri, U>
    {
        static xaml_binding bind(Windows::Foundation::Uri const& object, hstring const& name)
        {
            if (name == L"AbsoluteUri") return
            {
                [object] { return object.AbsoluteUri(); }
            };
            if (name == L"DisplayUri") return
            {
                [object] { return object.DisplayUri(); }
            };
            ...
            if (name == L"Fragment") return
            {
                [object] { return object.Fragment(); }
            };
            ...
            if (name == L"Query") return
            {
                [object] { return object.Query(); }
            };
            if (name == L"QueryParsed") return
            {
                [object] { return object.QueryParsed(); }
            };
            if (name == L"RawUri") return
            {
                [object] { return object.RawUri(); }
            };
            if (name == L"SchemeName") return
            {
                [object] { return object.SchemeName(); }
            };
            ...
            if (name == L"Suspicious") return
            {
                [object] { return object.Suspicious(); }
            };
            if (name == L"AbsoluteCanonicalUri") return
            {
                [object] { return object.AbsoluteCanonicalUri(); }
            };
            if (name == L"DisplayIri") return
            {
                [object] { return object.DisplayIri(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Foundation::WwwFormUrlDecoder, U>
    {
        static xaml_binding bind(Windows::Foundation::WwwFormUrlDecoder const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Foundation::WwwFormUrlDecoderEntry, U>
    {
        static xaml_binding bind(Windows::Foundation::WwwFormUrlDecoderEntry const& object, hstring const& name)
        {
