...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::System::Threading::ThreadPoolTimer, U>
    {
        static xaml_binding bind(Windows::System::Threading::ThreadPoolTimer const& object, hstring const& name)
        {
