...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalysisInkDrawing<D>::DrawingKind() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::Inking::Analysis::IInkAnalysisInkDrawing)->get_DrawingKind(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalysisNode<D>::Kind() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::Inking::Analysis::IInkAnalysisNode)->get_Kind(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalysisResult<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::Inking::Analysis::IInkAnalysisResult)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalysisRoot<D>::FindNodes(Windows::UI::Input::Inking::Analysis::InkAnalysisNodeKind const& nodeKind) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalyzer<D>::AddDataForStroke(Windows::UI::Input::Inking::InkStroke const& stroke) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::Inking::Analysis::IInkAnalyzer)->AddDataForStroke(*(void**)(&stroke)));
    }
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalyzer<D>::AddDataForStrokes(param::iterable<Windows::UI::Input::Inking::InkStroke> const& strokes) const
    {
    ...
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalyzer<D>::ReplaceDataForStroke(Windows::UI::Input::Inking::InkStroke const& stroke) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Input::Inking::Analysis::IInkAnalyzer)->ReplaceDataForStroke(*(void**)(&stroke)));
    }
    template <typename D> auto consume_Windows_UI_Input_Inking_Analysis_IInkAnalyzer<D>::SetStrokeDataKind(uint32_t strokeId, Windows::UI::Input::Inking::Analysis::InkAnalysisStrokeKind const& strokeKind) const
    {
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisInkBullet, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisInkBullet const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
            ...
            if (name == L"RotatedBoundingRect") return
            {
                [object] { return object.RotatedBoundingRect(); }
            };
            ...
            if (name == L"RecognizedText") return
            {
                [object] { return object.RecognizedText(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisInkDrawing, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisInkDrawing const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            ...
            if (name == L"DrawingKind") return
            {
                [object] { return object.DrawingKind(); }
            };
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisInkWord, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisInkWord const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            ...
            if (name == L"TextAlternates") return
            {
                [object] { return object.TextAlternates(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisLine, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisLine const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            ...
            if (name == L"IndentLevel") return
            {
                [object] { return object.IndentLevel(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisListItem, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisListItem const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisNode, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisNode const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisParagraph, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisParagraph const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisResult, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisRoot, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisRoot const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalysisWritingRegion, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalysisWritingRegion const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::UI::Input::Inking::Analysis::InkAnalyzer, U>
    {
        static xaml_binding bind(Windows::UI::Input::Inking::Analysis::InkAnalyzer const& object, hstring const& name)
        {
            if (name == L"AnalysisRoot") return
            {
                [object] { return object.AnalysisRoot(); }
            };
            if (name == L"IsAnalyzing") return
            {
                [object] { return object.IsAnalyzing(); }
            };
            return {};
        }
    };
