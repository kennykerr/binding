...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::CameraIntrinsics, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::CameraIntrinsics const& object, hstring const& name)
        {
            if (name == L"FocalLength") return
            {
                [object] { return object.FocalLength(); }
            };
            if (name == L"PrincipalPoint") return
            {
                [object] { return object.PrincipalPoint(); }
            };
            if (name == L"RadialDistortion") return
            {
                [object] { return object.RadialDistortion(); }
            };
            if (name == L"TangentialDistortion") return
            {
                [object] { return object.TangentialDistortion(); }
            };
            if (name == L"ImageWidth") return
            {
                [object] { return object.ImageWidth(); }
            };
            if (name == L"ImageHeight") return
            {
                [object] { return object.ImageHeight(); }
            };
            if (name == L"UndistortedProjectionTransform") return
            {
                [object] { return object.UndistortedProjectionTransform(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameControlCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameControlCapabilities const& object, hstring const& name)
        {
            ...
            if (name == L"PhotoConfirmationSupported") return
            {
                [object] { return object.PhotoConfirmationSupported(); }
            };
            if (name == L"Flash") return
            {
                [object] { return object.Flash(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameController, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameController const& object, hstring const& name)
        {
            ...
            if (name == L"PhotoConfirmationEnabled") return
            {
                [object] { return object.PhotoConfirmationEnabled(); },
                [object](auto&& value) { object.PhotoConfirmationEnabled(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameExposureCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameExposureCapabilities const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameExposureCompensationCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameExposureCompensationCapabilities const& object, hstring const& name)
        {
            if (name == L"Supported") return
            {
                [object] { return object.Supported(); }
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameExposureCompensationControl, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameExposureCompensationControl const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameExposureControl, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameExposureControl const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameFlashCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameFlashCapabilities const& object, hstring const& name)
        {
            if (name == L"Supported") return
            {
                [object] { return object.Supported(); }
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameFlashControl, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameFlashControl const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameFocusCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameFocusCapabilities const& object, hstring const& name)
        {
            if (name == L"Supported") return
            {
                [object] { return object.Supported(); }
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameFocusControl, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameFocusControl const& object, hstring const& name)
        {
            if (name == L"Value") return
            {
                [object] { return object.Value(); },
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameIsoSpeedCapabilities, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameIsoSpeedCapabilities const& object, hstring const& name)
        {
            if (name == L"Supported") return
            {
                [object] { return object.Supported(); }
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::FrameIsoSpeedControl, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::FrameIsoSpeedControl const& object, hstring const& name)
        {
            if (name == L"Auto") return
            {
                [object] { return object.Auto(); },
    ...
    template <typename U> struct bindable<Windows::Media::Devices::Core::VariablePhotoSequenceController, U>
    {
        static xaml_binding bind(Windows::Media::Devices::Core::VariablePhotoSequenceController const& object, hstring const& name)
        {
            if (name == L"Supported") return
            {
                [object] { return object.Supported(); }
            ...
            if (name == L"FrameCapabilities") return
            {
                [object] { return object.FrameCapabilities(); }
            };
            if (name == L"DesiredFrameControllers") return
            {
                [object] { return object.DesiredFrameControllers(); }
            };
            return {};
        }
    };
