...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountPartnerAccountInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountPartnerAccountInfo const& object, hstring const& name)
        {
            ...
            if (name == L"AccountKind") return
            {
                [object] { return object.AccountKind(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderAddAccountOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderAddAccountOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
            };
            if (name == L"ContentKinds") return
            {
                [object] { return object.ContentKinds(); }
            };
            if (name == L"PartnerAccountInfos") return
            {
                [object] { return object.PartnerAccountInfos(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderResolveErrorsOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderResolveErrorsOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderSettingsOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserDataAccounts::Provider::UserDataAccountProviderSettingsOperation const& object, hstring const& name)
        {
            if (name == L"Kind") return
            {
                [object] { return object.Kind(); }
