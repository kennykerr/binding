...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Gpio::GpioChangeCounter, U>
    {
        static xaml_binding bind(Windows::Devices::Gpio::GpioChangeCounter const& object, hstring const& name)
        {
            if (name == L"Polarity") return
            {
                [object] { return object.Polarity(); },
                [object](auto&& value) { object.Polarity(value); }
            };
            if (name == L"IsStarted") return
            {
                [object] { return object.IsStarted(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Gpio::GpioChangeReader, U>
    {
        static xaml_binding bind(Windows::Devices::Gpio::GpioChangeReader const& object, hstring const& name)
        {
            ...
            if (name == L"IsEmpty") return
            {
                [object] { return object.IsEmpty(); }
            };
            if (name == L"IsOverflowed") return
            {
                [object] { return object.IsOverflowed(); }
            };
            if (name == L"Polarity") return
            {
                [object] { return object.Polarity(); },
    ...
    template <typename U> struct bindable<Windows::Devices::Gpio::GpioController, U>
    {
        static xaml_binding bind(Windows::Devices::Gpio::GpioController const& object, hstring const& name)
        {
            if (name == L"PinCount") return
            {
                [object] { return object.PinCount(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Gpio::GpioPin, U>
    {
        static xaml_binding bind(Windows::Devices::Gpio::GpioPin const& object, hstring const& name)
        {
            if (name == L"DebounceTimeout") return
            {
                [object] { return object.DebounceTimeout(); },
                [object](auto&& value) { object.DebounceTimeout(value); }
            };
            if (name == L"PinNumber") return
            {
                [object] { return object.PinNumber(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Gpio::GpioPinValueChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Gpio::GpioPinValueChangedEventArgs const& object, hstring const& name)
        {
