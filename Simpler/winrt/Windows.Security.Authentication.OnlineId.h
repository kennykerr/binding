...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Security_Authentication_OnlineId_IOnlineIdSystemTicketResult<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::OnlineId::IOnlineIdSystemTicketResult)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdAuthenticator, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdAuthenticator const& object, hstring const& name)
        {
            if (name == L"ApplicationId") return
            {
                [object] { return object.ApplicationId(); },
                [object](auto&& value) { object.ApplicationId(value); }
            };
            if (name == L"CanSignOut") return
            {
                [object] { return object.CanSignOut(); }
            };
            if (name == L"AuthenticatedSafeCustomerId") return
            {
                [object] { return object.AuthenticatedSafeCustomerId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdServiceTicket, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdServiceTicket const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdServiceTicketRequest, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdServiceTicketRequest const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdSystemAuthenticatorForUser, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdSystemAuthenticatorForUser const& object, hstring const& name)
        {
            if (name == L"ApplicationId") return
            {
                [object] { return object.ApplicationId(); },
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdSystemIdentity, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdSystemIdentity const& object, hstring const& name)
        {
            if (name == L"Ticket") return
            {
                [object] { return object.Ticket(); }
            };
            if (name == L"Id") return
            {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::OnlineIdSystemTicketResult, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::OnlineIdSystemTicketResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::SignOutUserOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::SignOutUserOperation const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::UserAuthenticationOperation, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::UserAuthenticationOperation const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::OnlineId::UserIdentity, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::OnlineId::UserIdentity const& object, hstring const& name)
        {
            if (name == L"Tickets") return
            {
                [object] { return object.Tickets(); }
            };
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"SafeCustomerId") return
            {
                [object] { return object.SafeCustomerId(); }
            };
            if (name == L"SignInName") return
            {
                [object] { return object.SignInName(); }
            };
            ...
            if (name == L"IsBetaAccount") return
            {
                [object] { return object.IsBetaAccount(); }
            };
            if (name == L"IsConfirmedPC") return
            {
                [object] { return object.IsConfirmedPC(); }
            };
            return {};
        }
    };
