...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::ArcadeStick, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ArcadeStick const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
            };
            if (name == L"IsWireless") return
            {
                [object] { return object.IsWireless(); }
            };
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::FlightStick, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::FlightStick const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
            ...
            if (name == L"HatSwitchKind") return
            {
                [object] { return object.HatSwitchKind(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::Input::Gamepad, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Gamepad const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
            ...
            if (name == L"Vibration") return
            {
                [object] { return object.Vibration(); },
                [object](auto&& value) { object.Vibration(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::Input::Headset, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::Headset const& object, hstring const& name)
        {
            if (name == L"CaptureDeviceId") return
            {
                [object] { return object.CaptureDeviceId(); }
            };
            if (name == L"RenderDeviceId") return
            {
                [object] { return object.RenderDeviceId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::Input::RacingWheel, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::RacingWheel const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
            ...
            if (name == L"HasClutch") return
            {
                [object] { return object.HasClutch(); }
            };
            if (name == L"HasHandbrake") return
            {
                [object] { return object.HasHandbrake(); }
            };
            if (name == L"HasPatternShifter") return
            {
                [object] { return object.HasPatternShifter(); }
            };
            if (name == L"MaxPatternShifterGear") return
            {
                [object] { return object.MaxPatternShifterGear(); }
            };
            if (name == L"MaxWheelAngle") return
            {
                [object] { return object.MaxWheelAngle(); }
            };
            if (name == L"WheelMotor") return
            {
                [object] { return object.WheelMotor(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::Input::RawGameController, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::RawGameController const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
            ...
            if (name == L"AxisCount") return
            {
                [object] { return object.AxisCount(); }
            };
            if (name == L"ButtonCount") return
            {
                [object] { return object.ButtonCount(); }
            };
            if (name == L"ForceFeedbackMotors") return
            {
                [object] { return object.ForceFeedbackMotors(); }
            };
            ...
            if (name == L"SwitchCount") return
            {
                [object] { return object.SwitchCount(); }
            };
            if (name == L"SimpleHapticsControllers") return
            {
                [object] { return object.SimpleHapticsControllers(); }
            };
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::UINavigationController, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::UINavigationController const& object, hstring const& name)
        {
            if (name == L"Headset") return
            {
                [object] { return object.Headset(); }
