...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Background::DeviceServicingDetails, U>
    {
        static xaml_binding bind(Windows::Devices::Background::DeviceServicingDetails const& object, hstring const& name)
        {
            ...
            if (name == L"ExpectedDuration") return
            {
                [object] { return object.ExpectedDuration(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Background::DeviceUseDetails, U>
    {
        static xaml_binding bind(Windows::Devices::Background::DeviceUseDetails const& object, hstring const& name)
        {
            if (name == L"DeviceId") return
            {
                [object] { return object.DeviceId(); }
