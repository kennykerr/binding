...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Graphics::Capture::Direct3D11CaptureFrame, U>
    {
        static xaml_binding bind(Windows::Graphics::Capture::Direct3D11CaptureFrame const& object, hstring const& name)
        {
            ...
            if (name == L"ContentSize") return
            {
                [object] { return object.ContentSize(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Capture::Direct3D11CaptureFramePool, U>
    {
        static xaml_binding bind(Windows::Graphics::Capture::Direct3D11CaptureFramePool const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Capture::GraphicsCaptureItem, U>
    {
        static xaml_binding bind(Windows::Graphics::Capture::GraphicsCaptureItem const& object, hstring const& name)
        {
