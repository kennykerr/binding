...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Media_AppRecording_IAppRecordingManager<D>::StartRecordingToFileAsync(Windows::Storage::StorageFile const& file) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Media_AppRecording_IAppRecordingManager<D>::RecordTimeSpanToFileAsync(Windows::Foundation::DateTime const& startTime, Windows::Foundation::TimeSpan const& duration, Windows::Storage::StorageFile const& file) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Media_AppRecording_IAppRecordingManager<D>::SaveScreenshotToFilesAsync(Windows::Storage::StorageFolder const& folder, param::hstring const& filenamePrefix, Windows::Media::AppRecording::AppRecordingSaveScreenshotOption const& option, param::async_iterable<hstring> const& requestedFormats) const
    {
        void* operation{};
    ...
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingManager, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingManager const& object, hstring const& name)
        {
            if (name == L"SupportedScreenshotMediaEncodingSubtypes") return
            {
                [object] { return object.SupportedScreenshotMediaEncodingSubtypes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingResult, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingSaveScreenshotResult, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingSaveScreenshotResult const& object, hstring const& name)
        {
            if (name == L"Succeeded") return
            {
                [object] { return object.Succeeded(); }
            ...
            if (name == L"SavedScreenshotInfos") return
            {
                [object] { return object.SavedScreenshotInfos(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingSavedScreenshotInfo, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingSavedScreenshotInfo const& object, hstring const& name)
        {
            if (name == L"File") return
            {
                [object] { return object.File(); }
            };
            if (name == L"MediaEncodingSubtype") return
            {
                [object] { return object.MediaEncodingSubtype(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingStatus, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingStatus const& object, hstring const& name)
        {
            if (name == L"CanRecord") return
            {
                [object] { return object.CanRecord(); }
            };
            if (name == L"CanRecordTimeSpan") return
            {
                [object] { return object.CanRecordTimeSpan(); }
            };
            if (name == L"HistoricalBufferDuration") return
            {
                [object] { return object.HistoricalBufferDuration(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::AppRecording::AppRecordingStatusDetails, U>
    {
        static xaml_binding bind(Windows::Media::AppRecording::AppRecordingStatusDetails const& object, hstring const& name)
        {
            if (name == L"IsAnyAppBroadcasting") return
            {
                [object] { return object.IsAnyAppBroadcasting(); }
            };
            if (name == L"IsCaptureResourceUnavailable") return
            {
                [object] { return object.IsCaptureResourceUnavailable(); }
            };
            if (name == L"IsGameStreamInProgress") return
            {
                [object] { return object.IsGameStreamInProgress(); }
            };
            if (name == L"IsTimeSpanRecordingDisabled") return
            {
                [object] { return object.IsTimeSpanRecordingDisabled(); }
            };
            if (name == L"IsGpuConstrained") return
            {
                [object] { return object.IsGpuConstrained(); }
            };
            if (name == L"IsAppInactive") return
            {
                [object] { return object.IsAppInactive(); }
            };
            if (name == L"IsBlockedForApp") return
            {
                [object] { return object.IsBlockedForApp(); }
            };
            if (name == L"IsDisabledByUser") return
            {
                [object] { return object.IsDisabledByUser(); }
            };
            if (name == L"IsDisabledBySystem") return
            {
                [object] { return object.IsDisabledBySystem(); }
            };
            return {};
        }
    };
