...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Services::Maps::OfflineMaps::OfflineMapPackage, U>
    {
        static xaml_binding bind(Windows::Services::Maps::OfflineMaps::OfflineMapPackage const& object, hstring const& name)
        {
            ...
            if (name == L"EnclosingRegionName") return
            {
                [object] { return object.EnclosingRegionName(); }
            };
            if (name == L"EstimatedSizeInBytes") return
            {
                [object] { return object.EstimatedSizeInBytes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::Maps::OfflineMaps::OfflineMapPackageQueryResult, U>
    {
        static xaml_binding bind(Windows::Services::Maps::OfflineMaps::OfflineMapPackageQueryResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
            };
            if (name == L"Packages") return
            {
                [object] { return object.Packages(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Services::Maps::OfflineMaps::OfflineMapPackageStartDownloadResult, U>
    {
        static xaml_binding bind(Windows::Services::Maps::OfflineMaps::OfflineMapPackageStartDownloadResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
