...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Casting::CastingConnection, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingConnection const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Casting::CastingConnectionErrorOccurredEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingConnectionErrorOccurredEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Casting::CastingDevice, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingDevice const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
    ...
    template <typename U> struct bindable<Windows::Media::Casting::CastingDevicePicker, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingDevicePicker const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Casting::CastingDevicePickerFilter, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingDevicePickerFilter const& object, hstring const& name)
        {
            ...
            if (name == L"SupportsPictures") return
            {
                [object] { return object.SupportsPictures(); },
                [object](auto&& value) { object.SupportsPictures(value); }
            };
            if (name == L"SupportedCastingSources") return
            {
                [object] { return object.SupportedCastingSources(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Casting::CastingDeviceSelectedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingDeviceSelectedEventArgs const& object, hstring const& name)
        {
            if (name == L"SelectedCastingDevice") return
            {
                [object] { return object.SelectedCastingDevice(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Casting::CastingSource, U>
    {
        static xaml_binding bind(Windows::Media::Casting::CastingSource const& object, hstring const& name)
        {
