...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Xaml::Interop::NotifyCollectionChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Xaml::Interop::NotifyCollectionChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"Action") return
            {
                [object] { return object.Action(); }
            };
            if (name == L"NewItems") return
            {
                [object] { return object.NewItems(); }
            };
            if (name == L"OldItems") return
            {
                [object] { return object.OldItems(); }
            };
            if (name == L"NewStartingIndex") return
            {
                [object] { return object.NewStartingIndex(); }
            };
            if (name == L"OldStartingIndex") return
            {
                [object] { return object.OldStartingIndex(); }
            };
            return {};
        }
    };
