...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Security_Authentication_Identity_Core_IMicrosoftAccountMultiFactorAuthenticationManager<D>::DenySessionAsync(Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorSessionInfo const& authenticationSessionInfo) const
    {
        void* asyncOperation{};
    ...
    template <typename D> auto consume_Windows_Security_Authentication_Identity_Core_IMicrosoftAccountMultiFactorGetSessionsResult<D>::ServiceResponse() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorGetSessionsResult)->get_ServiceResponse(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorServiceResponse value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorOneTimeCodedInfo)->get_ServiceResponse(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Security_Authentication_Identity_Core_IMicrosoftAccountMultiFactorSessionInfo<D>::ApprovalStatus() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorSessionInfo)->get_ApprovalStatus(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Security_Authentication_Identity_Core_IMicrosoftAccountMultiFactorSessionInfo<D>::AuthenticationType() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorSessionInfo)->get_AuthenticationType(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorServiceResponse value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo)->get_ServiceResponse(put_abi(value)));
        return value;
    }
    template <typename D>
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorGetSessionsResult, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorGetSessionsResult const& object, hstring const& name)
        {
            if (name == L"Sessions") return
            {
                [object] { return object.Sessions(); }
            };
            if (name == L"ServiceResponse") return
            {
                [object] { return object.ServiceResponse(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorOneTimeCodedInfo, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorOneTimeCodedInfo const& object, hstring const& name)
        {
            if (name == L"Code") return
            {
                [object] { return object.Code(); }
            };
            if (name == L"TimeInterval") return
            {
                [object] { return object.TimeInterval(); }
            };
            if (name == L"TimeToLive") return
            {
                [object] { return object.TimeToLive(); }
            };
            if (name == L"ServiceResponse") return
            {
                [object] { return object.ServiceResponse(); }
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorSessionInfo, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorSessionInfo const& object, hstring const& name)
        {
            if (name == L"UserAccountId") return
            {
                [object] { return object.UserAccountId(); }
            };
            if (name == L"SessionId") return
            {
                [object] { return object.SessionId(); }
            };
            if (name == L"DisplaySessionId") return
            {
                [object] { return object.DisplaySessionId(); }
            };
            if (name == L"ApprovalStatus") return
            {
                [object] { return object.ApprovalStatus(); }
            };
            if (name == L"AuthenticationType") return
            {
                [object] { return object.AuthenticationType(); }
            };
            if (name == L"RequestTime") return
            {
                [object] { return object.RequestTime(); }
            };
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Identity::Core::MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo const& object, hstring const& name)
        {
            if (name == L"Sessions") return
            {
                [object] { return object.Sessions(); }
            };
            if (name == L"UnregisteredAccounts") return
            {
                [object] { return object.UnregisteredAccounts(); }
            };
            if (name == L"ServiceResponse") return
            {
                [object] { return object.ServiceResponse(); }
