...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Devices_ILowLevelDevicesAggregateProviderFactory<D>::Create(Windows::Devices::Adc::Provider::IAdcControllerProvider const& adc, Windows::Devices::Pwm::Provider::IPwmControllerProvider const& pwm, Windows::Devices::Gpio::Provider::IGpioControllerProvider const& gpio, Windows::Devices::I2c::Provider::II2cControllerProvider const& i2c, Windows::Devices::Spi::Provider::ISpiControllerProvider const& spi) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Devices_ILowLevelDevicesControllerStatics<D>::DefaultProvider(Windows::Devices::ILowLevelDevicesAggregateProvider const& value) const
    {
    ...
    template <typename U> struct bindable<Windows::Devices::LowLevelDevicesAggregateProvider, U>
    {
        static xaml_binding bind(Windows::Devices::LowLevelDevicesAggregateProvider const& object, hstring const& name)
        {
            if (name == L"AdcControllerProvider") return
            {
                [object] { return object.AdcControllerProvider(); }
            };
            if (name == L"PwmControllerProvider") return
            {
                [object] { return object.PwmControllerProvider(); }
            };
            if (name == L"GpioControllerProvider") return
            {
                [object] { return object.GpioControllerProvider(); }
            };
            if (name == L"I2cControllerProvider") return
            {
                [object] { return object.I2cControllerProvider(); }
            };
            if (name == L"SpiControllerProvider") return
            {
                [object] { return object.SpiControllerProvider(); }
            };
            return {};
        }
    };
