...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapCodecInformation, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapCodecInformation const& object, hstring const& name)
        {
            if (name == L"CodecId") return
            {
                [object] { return object.CodecId(); }
            };
            if (name == L"FileExtensions") return
            {
                [object] { return object.FileExtensions(); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); }
            };
            if (name == L"MimeTypes") return
            {
                [object] { return object.MimeTypes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapDecoder, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapDecoder const& object, hstring const& name)
        {
            if (name == L"BitmapContainerProperties") return
            {
                [object] { return object.BitmapContainerProperties(); }
            };
            if (name == L"DecoderInformation") return
            {
                [object] { return object.DecoderInformation(); }
            };
            ...
            if (name == L"OrientedPixelWidth") return
            {
                [object] { return object.OrientedPixelWidth(); }
            };
            if (name == L"OrientedPixelHeight") return
            {
                [object] { return object.OrientedPixelHeight(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapEncoder, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapEncoder const& object, hstring const& name)
        {
            if (name == L"EncoderInformation") return
            {
                [object] { return object.EncoderInformation(); }
            };
            if (name == L"BitmapProperties") return
            {
                [object] { return object.BitmapProperties(); }
            ...
            if (name == L"IsThumbnailGenerated") return
            {
                [object] { return object.IsThumbnailGenerated(); },
                [object](auto&& value) { object.IsThumbnailGenerated(value); }
            };
            if (name == L"GeneratedThumbnailWidth") return
            {
                [object] { return object.GeneratedThumbnailWidth(); },
                [object](auto&& value) { object.GeneratedThumbnailWidth(value); }
            };
            if (name == L"GeneratedThumbnailHeight") return
            {
                [object] { return object.GeneratedThumbnailHeight(); },
                [object](auto&& value) { object.GeneratedThumbnailHeight(value); }
            };
            if (name == L"BitmapTransform") return
            {
                [object] { return object.BitmapTransform(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapFrame, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapFrame const& object, hstring const& name)
        {
            if (name == L"BitmapProperties") return
            {
                [object] { return object.BitmapProperties(); }
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapPropertySet, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapPropertySet const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapTransform, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapTransform const& object, hstring const& name)
        {
            if (name == L"ScaledWidth") return
            {
                [object] { return object.ScaledWidth(); },
                [object](auto&& value) { object.ScaledWidth(value); }
            };
            if (name == L"ScaledHeight") return
            {
                [object] { return object.ScaledHeight(); },
                [object](auto&& value) { object.ScaledHeight(value); }
            };
            if (name == L"InterpolationMode") return
            {
                [object] { return object.InterpolationMode(); },
                [object](auto&& value) { object.InterpolationMode(value); }
            };
            if (name == L"Flip") return
            {
                [object] { return object.Flip(); },
                [object](auto&& value) { object.Flip(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::BitmapTypedValue, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::BitmapTypedValue const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::ImageStream, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::ImageStream const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); },
    ...
    template <typename U> struct bindable<Windows::Graphics::Imaging::SoftwareBitmap, U>
    {
        static xaml_binding bind(Windows::Graphics::Imaging::SoftwareBitmap const& object, hstring const& name)
        {
            if (name == L"BitmapPixelFormat") return
            {
                [object] { return object.BitmapPixelFormat(); }
