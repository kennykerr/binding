...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Media_DialProtocol_IDialAppStateDetails<D>::State() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Media::DialProtocol::IDialAppStateDetails)->get_State(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialApp, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialApp const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialAppStateDetails, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialAppStateDetails const& object, hstring const& name)
        {
            if (name == L"State") return
            {
                [object] { return object.State(); }
            };
            if (name == L"FullXml") return
            {
                [object] { return object.FullXml(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialDevice, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialDevice const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
    ...
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialDevicePicker, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialDevicePicker const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialDevicePickerFilter, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialDevicePickerFilter const& object, hstring const& name)
        {
            if (name == L"SupportedAppNames") return
            {
                [object] { return object.SupportedAppNames(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialDeviceSelectedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialDeviceSelectedEventArgs const& object, hstring const& name)
        {
            if (name == L"SelectedDialDevice") return
            {
                [object] { return object.SelectedDialDevice(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::DialProtocol::DialDisconnectButtonClickedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::DialProtocol::DialDisconnectButtonClickedEventArgs const& object, hstring const& name)
        {
