...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSession, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSession const& object, hstring const& name)
        {
            if (name == L"AgentState") return
            {
                [object] { return object.AgentState(); }
            };
            if (name == L"Signal") return
            {
                [object] { return object.Signal(); }
            };
            if (name == L"IsIndicatorLightAvailable") return
            {
                [object] { return object.IsIndicatorLightAvailable(); }
            };
            if (name == L"IsScreenAvailable") return
            {
                [object] { return object.IsScreenAvailable(); }
            };
            if (name == L"IsUserAuthenticated") return
            {
                [object] { return object.IsUserAuthenticated(); }
            };
            if (name == L"IsVoiceActivationAvailable") return
            {
                [object] { return object.IsVoiceActivationAvailable(); }
            };
            if (name == L"IsInterruptible") return
            {
                [object] { return object.IsInterruptible(); }
            };
            if (name == L"IsInterrupted") return
            {
                [object] { return object.IsInterrupted(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSignal, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSignal const& object, hstring const& name)
        {
            if (name == L"IsSignalVerificationRequired") return
            {
                [object] { return object.IsSignalVerificationRequired(); },
                [object](auto&& value) { object.IsSignalVerificationRequired(value); }
            };
            if (name == L"SignalId") return
            {
                [object] { return object.SignalId(); },
                [object](auto&& value) { object.SignalId(value); }
            };
            if (name == L"SignalName") return
            {
                [object] { return object.SignalName(); },
                [object](auto&& value) { object.SignalName(value); }
            };
            if (name == L"SignalContext") return
            {
                [object] { return object.SignalContext(); },
                [object](auto&& value) { object.SignalContext(value); }
            };
            if (name == L"SignalStart") return
            {
                [object] { return object.SignalStart(); },
                [object](auto&& value) { object.SignalStart(value); }
            };
            if (name == L"SignalEnd") return
            {
                [object] { return object.SignalEnd(); },
                [object](auto&& value) { object.SignalEnd(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSystemStateChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::ConversationalAgent::ConversationalAgentSystemStateChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"SystemStateChangeType") return
            {
                [object] { return object.SystemStateChangeType(); }
            };
            return {};
        }
    };
