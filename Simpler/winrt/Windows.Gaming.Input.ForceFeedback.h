...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::ForceFeedback::ConditionForceEffect, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ForceFeedback::ConditionForceEffect const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::ForceFeedback::ConstantForceEffect, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ForceFeedback::ConstantForceEffect const& object, hstring const& name)
        {
            if (name == L"Gain") return
            {
                [object] { return object.Gain(); },
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::ForceFeedback::ForceFeedbackMotor, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ForceFeedback::ForceFeedbackMotor const& object, hstring const& name)
        {
            if (name == L"AreEffectsPaused") return
            {
                [object] { return object.AreEffectsPaused(); }
            };
            if (name == L"MasterGain") return
            {
                [object] { return object.MasterGain(); },
                [object](auto&& value) { object.MasterGain(value); }
            };
            if (name == L"IsEnabled") return
            {
                [object] { return object.IsEnabled(); }
            };
            if (name == L"SupportedAxes") return
            {
                [object] { return object.SupportedAxes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Gaming::Input::ForceFeedback::PeriodicForceEffect, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ForceFeedback::PeriodicForceEffect const& object, hstring const& name)
        {
            if (name == L"Gain") return
            {
                [object] { return object.Gain(); },
    ...
    template <typename U> struct bindable<Windows::Gaming::Input::ForceFeedback::RampForceEffect, U>
    {
        static xaml_binding bind(Windows::Gaming::Input::ForceFeedback::RampForceEffect const& object, hstring const& name)
        {
            if (name == L"Gain") return
            {
                [object] { return object.Gain(); },
