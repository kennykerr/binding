...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSource, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSource const& object, hstring const& name)
        {
            if (name == L"IsLive") return
            {
                [object] { return object.IsLive(); }
            };
            if (name == L"DesiredLiveOffset") return
            {
                [object] { return object.DesiredLiveOffset(); },
                [object](auto&& value) { object.DesiredLiveOffset(value); }
            };
            if (name == L"InitialBitrate") return
            {
                [object] { return object.InitialBitrate(); },
                [object](auto&& value) { object.InitialBitrate(value); }
            };
            if (name == L"CurrentDownloadBitrate") return
            {
                [object] { return object.CurrentDownloadBitrate(); }
            };
            if (name == L"CurrentPlaybackBitrate") return
            {
                [object] { return object.CurrentPlaybackBitrate(); }
            };
            if (name == L"AvailableBitrates") return
            {
                [object] { return object.AvailableBitrates(); }
            };
            if (name == L"DesiredMinBitrate") return
            {
                [object] { return object.DesiredMinBitrate(); },
                [object](auto&& value) { object.DesiredMinBitrate(value); }
            };
            if (name == L"DesiredMaxBitrate") return
            {
                [object] { return object.DesiredMaxBitrate(); },
                [object](auto&& value) { object.DesiredMaxBitrate(value); }
            };
            if (name == L"AudioOnlyPlayback") return
            {
                [object] { return object.AudioOnlyPlayback(); }
            };
            if (name == L"InboundBitsPerSecond") return
            {
                [object] { return object.InboundBitsPerSecond(); }
            };
            if (name == L"InboundBitsPerSecondWindow") return
            {
                [object] { return object.InboundBitsPerSecondWindow(); },
                [object](auto&& value) { object.InboundBitsPerSecondWindow(value); }
            };
            if (name == L"AdvancedSettings") return
            {
                [object] { return object.AdvancedSettings(); }
            };
            if (name == L"MinLiveOffset") return
            {
                [object] { return object.MinLiveOffset(); }
            };
            if (name == L"MaxSeekableWindowSize") return
            {
                [object] { return object.MaxSeekableWindowSize(); }
            };
            if (name == L"DesiredSeekableWindowSize") return
            {
                [object] { return object.DesiredSeekableWindowSize(); },
                [object](auto&& value) { object.DesiredSeekableWindowSize(value); }
            };
            if (name == L"Diagnostics") return
            {
                [object] { return object.Diagnostics(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceAdvancedSettings, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceAdvancedSettings const& object, hstring const& name)
        {
            if (name == L"AllSegmentsIndependent") return
            {
                [object] { return object.AllSegmentsIndependent(); },
                [object](auto&& value) { object.AllSegmentsIndependent(value); }
            };
            if (name == L"DesiredBitrateHeadroomRatio") return
            {
                [object] { return object.DesiredBitrateHeadroomRatio(); },
                [object](auto&& value) { object.DesiredBitrateHeadroomRatio(value); }
            };
            if (name == L"BitrateDowngradeTriggerRatio") return
            {
                [object] { return object.BitrateDowngradeTriggerRatio(); },
                [object](auto&& value) { object.BitrateDowngradeTriggerRatio(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCorrelatedTimes, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCorrelatedTimes const& object, hstring const& name)
        {
            if (name == L"Position") return
            {
                [object] { return object.Position(); }
            };
            if (name == L"PresentationTimeStamp") return
            {
                [object] { return object.PresentationTimeStamp(); }
            };
            if (name == L"ProgramDateTime") return
            {
                [object] { return object.ProgramDateTime(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationResult, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationResult const& object, hstring const& name)
        {
            ...
            if (name == L"HttpResponseMessage") return
            {
                [object] { return object.HttpResponseMessage(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDiagnosticAvailableEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDiagnosticAvailableEventArgs const& object, hstring const& name)
        {
            if (name == L"DiagnosticType") return
            {
                [object] { return object.DiagnosticType(); }
            };
            ...
            if (name == L"SegmentId") return
            {
                [object] { return object.SegmentId(); }
            };
            if (name == L"ResourceType") return
            {
                [object] { return object.ResourceType(); }
            };
            if (name == L"ResourceUri") return
            {
                [object] { return object.ResourceUri(); }
            };
            if (name == L"ResourceByteRangeOffset") return
            {
                [object] { return object.ResourceByteRangeOffset(); }
            };
            if (name == L"ResourceByteRangeLength") return
            {
                [object] { return object.ResourceByteRangeLength(); }
            };
            ...
            if (name == L"ResourceDuration") return
            {
                [object] { return object.ResourceDuration(); }
            };
            if (name == L"ResourceContentType") return
            {
                [object] { return object.ResourceContentType(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadBitrateChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadBitrateChangedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadCompletedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadCompletedEventArgs const& object, hstring const& name)
        {
            if (name == L"ResourceType") return
            {
                [object] { return object.ResourceType(); }
            ...
            if (name == L"Statistics") return
            {
                [object] { return object.Statistics(); }
            };
            if (name == L"Position") return
            {
                [object] { return object.Position(); }
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadFailedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadFailedEventArgs const& object, hstring const& name)
        {
            if (name == L"ResourceType") return
            {
                [object] { return object.ResourceType(); }
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadRequestedEventArgs const& object, hstring const& name)
        {
            if (name == L"ResourceType") return
            {
                [object] { return object.ResourceType(); }
    ...
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadResult, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadResult const& object, hstring const& name)
        {
            if (name == L"ResourceUri") return
            {
                [object] { return object.ResourceUri(); },
                [object](auto&& value) { object.ResourceUri(value); }
            };
            if (name == L"InputStream") return
            {
                [object] { return object.InputStream(); },
                [object](auto&& value) { object.InputStream(value); }
            };
            if (name == L"Buffer") return
            {
                [object] { return object.Buffer(); },
                [object](auto&& value) { object.Buffer(value); }
            };
            ...
            if (name == L"ExtendedStatus") return
            {
                ...
                [object](auto&& value) { object.ExtendedStatus(value); }
            };
            if (name == L"ResourceByteRangeOffset") return
            {
                [object] { return object.ResourceByteRangeOffset(); },
                [object](auto&& value) { object.ResourceByteRangeOffset(value); }
            };
            if (name == L"ResourceByteRangeLength") return
            {
                [object] { return object.ResourceByteRangeLength(); },
                [object](auto&& value) { object.ResourceByteRangeLength(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadStatistics, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceDownloadStatistics const& object, hstring const& name)
        {
            if (name == L"ContentBytesReceivedCount") return
            {
                [object] { return object.ContentBytesReceivedCount(); }
            };
            if (name == L"TimeToHeadersReceived") return
            {
                [object] { return object.TimeToHeadersReceived(); }
            };
            if (name == L"TimeToFirstByteReceived") return
            {
                [object] { return object.TimeToFirstByteReceived(); }
            };
            if (name == L"TimeToLastByteReceived") return
            {
                [object] { return object.TimeToLastByteReceived(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Streaming::Adaptive::AdaptiveMediaSourcePlaybackBitrateChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Streaming::Adaptive::AdaptiveMediaSourcePlaybackBitrateChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"OldValue") return
            {
                [object] { return object.OldValue(); }
            ...
            if (name == L"AudioOnly") return
            {
                [object] { return object.AudioOnly(); }
            };
            return {};
        }
    };
