...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Devices_Haptics_ISimpleHapticsController<D>::SendHapticFeedback(Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& feedback) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Haptics::ISimpleHapticsController)->SendHapticFeedback(*(void**)(&feedback)));
    }
    template <typename D> auto consume_Windows_Devices_Haptics_ISimpleHapticsController<D>::SendHapticFeedback(Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& feedback, double intensity) const
    {
    ...
    template <typename D> auto consume_Windows_Devices_Haptics_ISimpleHapticsController<D>::SendHapticFeedbackForDuration(Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& feedback, double intensity, Windows::Foundation::TimeSpan const& playDuration) const
    {
    ...
    template <typename D> auto consume_Windows_Devices_Haptics_ISimpleHapticsController<D>::SendHapticFeedbackForPlayCount(Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& feedback, double intensity, int32_t playCount, Windows::Foundation::TimeSpan const& replayPauseInterval) const
    {
    ...
    template <typename U> struct bindable<Windows::Devices::Haptics::SimpleHapticsController, U>
    {
        static xaml_binding bind(Windows::Devices::Haptics::SimpleHapticsController const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"SupportedFeedback") return
            {
                [object] { return object.SupportedFeedback(); }
            };
            if (name == L"IsIntensitySupported") return
            {
                [object] { return object.IsIntensitySupported(); }
            };
            if (name == L"IsPlayCountSupported") return
            {
                [object] { return object.IsPlayCountSupported(); }
            };
            if (name == L"IsPlayDurationSupported") return
            {
                [object] { return object.IsPlayDurationSupported(); }
            };
            if (name == L"IsReplayPauseIntervalSupported") return
            {
                [object] { return object.IsReplayPauseIntervalSupported(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Haptics::SimpleHapticsControllerFeedback, U>
    {
        static xaml_binding bind(Windows::Devices::Haptics::SimpleHapticsControllerFeedback const& object, hstring const& name)
        {
            if (name == L"Waveform") return
            {
                [object] { return object.Waveform(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Haptics::VibrationDevice, U>
    {
        static xaml_binding bind(Windows::Devices::Haptics::VibrationDevice const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
