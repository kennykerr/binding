...
{
    template <typename D> auto consume_Windows_ApplicationModel_Store_LicenseManagement_ILicenseManagerStatics<D>::AddLicenseAsync(Windows::Storage::Streams::IBuffer const& license) const
    {
        void* action{};
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Store_LicenseManagement_ILicenseManagerStatics2<D>::RefreshLicensesAsync(Windows::ApplicationModel::Store::LicenseManagement::LicenseRefreshOption const& refreshOption) const
    {
        void* action{};
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionInfo const& object, hstring const& name)
        {
            if (name == L"SatisfiedByDevice") return
            {
                [object] { return object.SatisfiedByDevice(); }
            };
            if (name == L"SatisfiedByOpenLicense") return
            {
                [object] { return object.SatisfiedByOpenLicense(); }
            };
            if (name == L"SatisfiedByTrial") return
            {
                [object] { return object.SatisfiedByTrial(); }
            };
            if (name == L"SatisfiedByPass") return
            {
                [object] { return object.SatisfiedByPass(); }
            };
            if (name == L"SatisfiedByInstallMedia") return
            {
                [object] { return object.SatisfiedByInstallMedia(); }
            };
            if (name == L"SatisfiedBySignedInUser") return
            {
                [object] { return object.SatisfiedBySignedInUser(); }
            };
            if (name == L"IsSatisfied") return
            {
                [object] { return object.IsSatisfied(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionResult, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionResult const& object, hstring const& name)
        {
            if (name == L"LicenseSatisfactionInfos") return
            {
                [object] { return object.LicenseSatisfactionInfos(); }
            };
