...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Data::Text::AlternateWordForm, U>
    {
        static xaml_binding bind(Windows::Data::Text::AlternateWordForm const& object, hstring const& name)
        {
            if (name == L"SourceTextSegment") return
            {
                [object] { return object.SourceTextSegment(); }
            };
            if (name == L"AlternateText") return
            {
                [object] { return object.AlternateText(); }
            };
            if (name == L"NormalizationFormat") return
            {
                [object] { return object.NormalizationFormat(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Text::SelectableWordSegment, U>
    {
        static xaml_binding bind(Windows::Data::Text::SelectableWordSegment const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Data::Text::SelectableWordsSegmenter, U>
    {
        static xaml_binding bind(Windows::Data::Text::SelectableWordsSegmenter const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Data::Text::TextConversionGenerator, U>
    {
        static xaml_binding bind(Windows::Data::Text::TextConversionGenerator const& object, hstring const& name)
        {
            if (name == L"ResolvedLanguage") return
            {
                [object] { return object.ResolvedLanguage(); }
            };
            if (name == L"LanguageAvailableButNotInstalled") return
            {
                [object] { return object.LanguageAvailableButNotInstalled(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Text::TextPhoneme, U>
    {
        static xaml_binding bind(Windows::Data::Text::TextPhoneme const& object, hstring const& name)
        {
            if (name == L"DisplayText") return
            {
                [object] { return object.DisplayText(); }
            };
            if (name == L"ReadingText") return
            {
                [object] { return object.ReadingText(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Text::TextPredictionGenerator, U>
    {
        static xaml_binding bind(Windows::Data::Text::TextPredictionGenerator const& object, hstring const& name)
        {
            if (name == L"ResolvedLanguage") return
            {
                [object] { return object.ResolvedLanguage(); }
    ...
    template <typename U> struct bindable<Windows::Data::Text::TextReverseConversionGenerator, U>
    {
        static xaml_binding bind(Windows::Data::Text::TextReverseConversionGenerator const& object, hstring const& name)
        {
            if (name == L"ResolvedLanguage") return
            {
                [object] { return object.ResolvedLanguage(); }
    ...
    template <typename U> struct bindable<Windows::Data::Text::WordSegment, U>
    {
        static xaml_binding bind(Windows::Data::Text::WordSegment const& object, hstring const& name)
        {
            if (name == L"Text") return
            {
                [object] { return object.Text(); }
            ...
            if (name == L"AlternateForms") return
            {
                [object] { return object.AlternateForms(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Text::WordsSegmenter, U>
    {
        static xaml_binding bind(Windows::Data::Text::WordsSegmenter const& object, hstring const& name)
        {
            if (name == L"ResolvedLanguage") return
            {
                [object] { return object.ResolvedLanguage(); }
