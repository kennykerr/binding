...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Management::MdmAlert, U>
    {
        static xaml_binding bind(Windows::Management::MdmAlert const& object, hstring const& name)
        {
            ...
            if (name == L"Mark") return
            {
                [object] { return object.Mark(); },
                [object](auto&& value) { object.Mark(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Management::MdmSession, U>
    {
        static xaml_binding bind(Windows::Management::MdmSession const& object, hstring const& name)
        {
            if (name == L"Alerts") return
            {
                [object] { return object.Alerts(); }
            };
