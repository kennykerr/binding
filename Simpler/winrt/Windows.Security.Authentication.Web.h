...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::Authentication::Web::WebAuthenticationResult, U>
    {
        static xaml_binding bind(Windows::Security::Authentication::Web::WebAuthenticationResult const& object, hstring const& name)
        {
            ...
            if (name == L"ResponseErrorDetail") return
            {
                [object] { return object.ResponseErrorDetail(); }
            };
            return {};
        }
    };
