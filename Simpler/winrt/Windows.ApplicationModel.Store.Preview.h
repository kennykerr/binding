...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Store::Preview::DeliveryOptimizationSettings, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::Preview::DeliveryOptimizationSettings const& object, hstring const& name)
        {
            if (name == L"DownloadMode") return
            {
                [object] { return object.DownloadMode(); }
            };
            if (name == L"DownloadModeSource") return
            {
                [object] { return object.DownloadModeSource(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::Preview::StoreHardwareManufacturerInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::Preview::StoreHardwareManufacturerInfo const& object, hstring const& name)
        {
            if (name == L"HardwareManufacturerId") return
            {
                [object] { return object.HardwareManufacturerId(); }
            };
            if (name == L"StoreContentModifierId") return
            {
                [object] { return object.StoreContentModifierId(); }
            };
            if (name == L"ModelName") return
            {
                [object] { return object.ModelName(); }
            };
            if (name == L"ManufacturerName") return
            {
                [object] { return object.ManufacturerName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::Preview::StorePreviewProductInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::Preview::StorePreviewProductInfo const& object, hstring const& name)
        {
            ...
            if (name == L"SkuInfoList") return
            {
                [object] { return object.SkuInfoList(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::Preview::StorePreviewPurchaseResults, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::Preview::StorePreviewPurchaseResults const& object, hstring const& name)
        {
            if (name == L"ProductPurchaseStatus") return
            {
                [object] { return object.ProductPurchaseStatus(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Store::Preview::StorePreviewSkuInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Store::Preview::StorePreviewSkuInfo const& object, hstring const& name)
        {
            if (name == L"ProductId") return
            {
                [object] { return object.ProductId(); }
            };
            if (name == L"SkuId") return
            {
                [object] { return object.SkuId(); }
            };
            if (name == L"SkuType") return
            {
                [object] { return object.SkuType(); }
            };
            if (name == L"Title") return
            {
                [object] { return object.Title(); }
            ...
            if (name == L"FormattedListPrice") return
            {
                [object] { return object.FormattedListPrice(); }
            };
            if (name == L"ExtendedData") return
            {
                [object] { return object.ExtendedData(); }
            };
            return {};
        }
    };
