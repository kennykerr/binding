...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::Protection::ComponentLoadFailedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Protection::ComponentLoadFailedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Protection::MediaProtectionManager, U>
    {
        static xaml_binding bind(Windows::Media::Protection::MediaProtectionManager const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Protection::MediaProtectionPMPServer, U>
    {
        static xaml_binding bind(Windows::Media::Protection::MediaProtectionPMPServer const& object, hstring const& name)
        {
            if (name == L"Properties") return
            {
                [object] { return object.Properties(); }
    ...
    template <typename U> struct bindable<Windows::Media::Protection::RevocationAndRenewalInformation, U>
    {
        static xaml_binding bind(Windows::Media::Protection::RevocationAndRenewalInformation const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Media::Protection::RevocationAndRenewalItem, U>
    {
        static xaml_binding bind(Windows::Media::Protection::RevocationAndRenewalItem const& object, hstring const& name)
        {
            if (name == L"Reasons") return
            {
                [object] { return object.Reasons(); }
            };
            if (name == L"HeaderHash") return
            {
                [object] { return object.HeaderHash(); }
            };
            if (name == L"PublicKeyHash") return
            {
                [object] { return object.PublicKeyHash(); }
            };
            if (name == L"Name") return
            {
                [object] { return object.Name(); }
            };
            if (name == L"RenewalId") return
            {
                [object] { return object.RenewalId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::Protection::ServiceRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Media::Protection::ServiceRequestedEventArgs const& object, hstring const& name)
        {
            ...
            if (name == L"MediaPlaybackItem") return
            {
                [object] { return object.MediaPlaybackItem(); }
            };
            return {};
        }
    };
