...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::Print3DWorkflow, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::Print3DWorkflow const& object, hstring const& name)
        {
            if (name == L"DeviceID") return
            {
                [object] { return object.DeviceID(); }
            };
            if (name == L"IsPrintReady") return
            {
                [object] { return object.IsPrintReady(); },
                [object](auto&& value) { object.IsPrintReady(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::Print3DWorkflowPrintRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::Print3DWorkflowPrintRequestedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::Print3DWorkflowPrinterChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::Print3DWorkflowPrinterChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"NewDeviceId") return
            {
                [object] { return object.NewDeviceId(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::PrintNotificationEventDetails, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::PrintNotificationEventDetails const& object, hstring const& name)
        {
            if (name == L"PrinterName") return
            {
                [object] { return object.PrinterName(); }
            };
            if (name == L"EventData") return
            {
                [object] { return object.EventData(); },
                [object](auto&& value) { object.EventData(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::PrintTaskConfiguration, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::PrintTaskConfiguration const& object, hstring const& name)
        {
            if (name == L"PrinterExtensionContext") return
            {
                [object] { return object.PrinterExtensionContext(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::PrintTaskConfigurationSaveRequest, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::PrintTaskConfigurationSaveRequest const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Printers::Extensions::PrintTaskConfigurationSaveRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Printers::Extensions::PrintTaskConfigurationSaveRequestedEventArgs const& object, hstring const& name)
        {
