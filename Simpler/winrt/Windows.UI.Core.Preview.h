...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Core::Preview::SystemNavigationCloseRequestedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Core::Preview::SystemNavigationCloseRequestedPreviewEventArgs const& object, hstring const& name)
        {
