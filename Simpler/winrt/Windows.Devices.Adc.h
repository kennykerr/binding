...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Adc::AdcChannel, U>
    {
        static xaml_binding bind(Windows::Devices::Adc::AdcChannel const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Adc::AdcController, U>
    {
        static xaml_binding bind(Windows::Devices::Adc::AdcController const& object, hstring const& name)
        {
            if (name == L"ChannelCount") return
            {
                [object] { return object.ChannelCount(); }
            };
            if (name == L"ResolutionInBits") return
            {
                [object] { return object.ResolutionInBits(); }
            };
            ...
            if (name == L"ChannelMode") return
            {
                [object] { return object.ChannelMode(); },
                [object](auto&& value) { object.ChannelMode(value); }
            };
            return {};
        }
    };
