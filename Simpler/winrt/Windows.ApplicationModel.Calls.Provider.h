...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Calls::Provider::PhoneCallOrigin, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Calls::Provider::PhoneCallOrigin const& object, hstring const& name)
        {
            ...
            if (name == L"CategoryDescription") return
            {
                [object] { return object.CategoryDescription(); },
                [object](auto&& value) { object.CategoryDescription(value); }
            };
            ...
            if (name == L"DisplayPicture") return
            {
                [object] { return object.DisplayPicture(); },
                [object](auto&& value) { object.DisplayPicture(value); }
            };
            return {};
        }
    };
