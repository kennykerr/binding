...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Power::Battery, U>
    {
        static xaml_binding bind(Windows::Devices::Power::Battery const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Power::BatteryReport, U>
    {
        static xaml_binding bind(Windows::Devices::Power::BatteryReport const& object, hstring const& name)
        {
            if (name == L"ChargeRateInMilliwatts") return
            {
                [object] { return object.ChargeRateInMilliwatts(); }
            };
            if (name == L"DesignCapacityInMilliwattHours") return
            {
                [object] { return object.DesignCapacityInMilliwattHours(); }
            };
            if (name == L"FullChargeCapacityInMilliwattHours") return
            {
                [object] { return object.FullChargeCapacityInMilliwattHours(); }
            };
            if (name == L"RemainingCapacityInMilliwattHours") return
            {
                [object] { return object.RemainingCapacityInMilliwattHours(); }
            };
