...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Composition::Core::CompositorController, U>
    {
        static xaml_binding bind(Windows::UI::Composition::Core::CompositorController const& object, hstring const& name)
        {
