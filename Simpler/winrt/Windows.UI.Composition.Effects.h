...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Composition::Effects::SceneLightingEffect, U>
    {
        static xaml_binding bind(Windows::UI::Composition::Effects::SceneLightingEffect const& object, hstring const& name)
        {
            if (name == L"AmbientAmount") return
            {
                [object] { return object.AmbientAmount(); },
                [object](auto&& value) { object.AmbientAmount(value); }
            };
            if (name == L"DiffuseAmount") return
            {
                [object] { return object.DiffuseAmount(); },
                [object](auto&& value) { object.DiffuseAmount(value); }
            };
            if (name == L"NormalMapSource") return
            {
                [object] { return object.NormalMapSource(); },
                [object](auto&& value) { object.NormalMapSource(value); }
            };
            if (name == L"SpecularAmount") return
            {
                [object] { return object.SpecularAmount(); },
                [object](auto&& value) { object.SpecularAmount(value); }
            };
            if (name == L"SpecularShine") return
            {
                [object] { return object.SpecularShine(); },
                [object](auto&& value) { object.SpecularShine(value); }
            };
            ...
            if (name == L"ReflectanceModel") return
            {
                [object] { return object.ReflectanceModel(); },
                [object](auto&& value) { object.ReflectanceModel(value); }
            };
            return {};
        }
    };
