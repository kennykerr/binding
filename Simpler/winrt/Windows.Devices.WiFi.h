...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::WiFi::WiFiAdapter, U>
    {
        static xaml_binding bind(Windows::Devices::WiFi::WiFiAdapter const& object, hstring const& name)
        {
            if (name == L"NetworkAdapter") return
            {
                [object] { return object.NetworkAdapter(); }
            };
            if (name == L"NetworkReport") return
            {
                [object] { return object.NetworkReport(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::WiFi::WiFiAvailableNetwork, U>
    {
        static xaml_binding bind(Windows::Devices::WiFi::WiFiAvailableNetwork const& object, hstring const& name)
        {
            if (name == L"Uptime") return
            {
                [object] { return object.Uptime(); }
            };
            if (name == L"Ssid") return
            {
                [object] { return object.Ssid(); }
            };
            if (name == L"Bssid") return
            {
                [object] { return object.Bssid(); }
            };
            if (name == L"ChannelCenterFrequencyInKilohertz") return
            {
                [object] { return object.ChannelCenterFrequencyInKilohertz(); }
            };
            if (name == L"NetworkRssiInDecibelMilliwatts") return
            {
                [object] { return object.NetworkRssiInDecibelMilliwatts(); }
            };
            if (name == L"SignalBars") return
            {
                [object] { return object.SignalBars(); }
            };
            if (name == L"NetworkKind") return
            {
                [object] { return object.NetworkKind(); }
            };
            if (name == L"PhyKind") return
            {
                [object] { return object.PhyKind(); }
            };
            if (name == L"SecuritySettings") return
            {
                [object] { return object.SecuritySettings(); }
            };
            if (name == L"BeaconInterval") return
            {
                [object] { return object.BeaconInterval(); }
            };
            if (name == L"IsWiFiDirect") return
            {
                [object] { return object.IsWiFiDirect(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::WiFi::WiFiConnectionResult, U>
    {
        static xaml_binding bind(Windows::Devices::WiFi::WiFiConnectionResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::WiFi::WiFiNetworkReport, U>
    {
        static xaml_binding bind(Windows::Devices::WiFi::WiFiNetworkReport const& object, hstring const& name)
        {
            if (name == L"Timestamp") return
            {
                [object] { return object.Timestamp(); }
            };
            if (name == L"AvailableNetworks") return
            {
                [object] { return object.AvailableNetworks(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::WiFi::WiFiWpsConfigurationResult, U>
    {
        static xaml_binding bind(Windows::Devices::WiFi::WiFiWpsConfigurationResult const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
            };
            if (name == L"SupportedWpsKinds") return
            {
                [object] { return object.SupportedWpsKinds(); }
            };
            return {};
        }
    };
