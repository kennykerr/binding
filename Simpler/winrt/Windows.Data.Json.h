...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Data::Json::JsonArray, U>
    {
        static xaml_binding bind(Windows::Data::Json::JsonArray const& object, hstring const& name)
        {
            if (name == L"ValueType") return
            {
                [object] { return object.ValueType(); }
            };
    ...
    template <typename U> struct bindable<Windows::Data::Json::JsonObject, U>
    {
        static xaml_binding bind(Windows::Data::Json::JsonObject const& object, hstring const& name)
        {
            if (name == L"ValueType") return
            {
                [object] { return object.ValueType(); }
    ...
    template <typename U> struct bindable<Windows::Data::Json::JsonValue, U>
    {
        static xaml_binding bind(Windows::Data::Json::JsonValue const& object, hstring const& name)
        {
            if (name == L"ValueType") return
            {
                [object] { return object.ValueType(); }
