...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Media::AppBroadcasting::AppBroadcastingMonitor, U>
    {
        static xaml_binding bind(Windows::Media::AppBroadcasting::AppBroadcastingMonitor const& object, hstring const& name)
        {
            if (name == L"IsCurrentAppBroadcasting") return
            {
                [object] { return object.IsCurrentAppBroadcasting(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Media::AppBroadcasting::AppBroadcastingStatus, U>
    {
        static xaml_binding bind(Windows::Media::AppBroadcasting::AppBroadcastingStatus const& object, hstring const& name)
        {
            if (name == L"CanStartBroadcast") return
            {
                [object] { return object.CanStartBroadcast(); }
            };
    ...
    template <typename U> struct bindable<Windows::Media::AppBroadcasting::AppBroadcastingStatusDetails, U>
    {
        static xaml_binding bind(Windows::Media::AppBroadcasting::AppBroadcastingStatusDetails const& object, hstring const& name)
        {
