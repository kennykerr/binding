...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"ScreenPositionInRawPixels") return
            {
                [object] { return object.ScreenPositionInRawPixels(); }
            };
            if (name == L"IsReadingText") return
            {
                [object] { return object.IsReadingText(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::UI::Accessibility::ScreenReaderService, U>
    {
        static xaml_binding bind(Windows::UI::Accessibility::ScreenReaderService const& object, hstring const& name)
        {
            if (name == L"CurrentScreenReaderPosition") return
            {
                [object] { return object.CurrentScreenReaderPosition(); }
            };
            return {};
        }
    };
