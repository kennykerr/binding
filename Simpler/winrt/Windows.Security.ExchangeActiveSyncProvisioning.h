...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Security::ExchangeActiveSyncProvisioning::EasClientDeviceInformation, U>
    {
        static xaml_binding bind(Windows::Security::ExchangeActiveSyncProvisioning::EasClientDeviceInformation const& object, hstring const& name)
        {
            if (name == L"Id") return
            {
                [object] { return object.Id(); }
            };
            if (name == L"OperatingSystem") return
            {
                [object] { return object.OperatingSystem(); }
            };
            if (name == L"FriendlyName") return
            {
                [object] { return object.FriendlyName(); }
            };
            if (name == L"SystemManufacturer") return
            {
                [object] { return object.SystemManufacturer(); }
            };
            if (name == L"SystemProductName") return
            {
                [object] { return object.SystemProductName(); }
            };
            if (name == L"SystemSku") return
            {
                [object] { return object.SystemSku(); }
            };
            if (name == L"SystemHardwareVersion") return
            {
                [object] { return object.SystemHardwareVersion(); }
            };
            if (name == L"SystemFirmwareVersion") return
            {
                [object] { return object.SystemFirmwareVersion(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::ExchangeActiveSyncProvisioning::EasClientSecurityPolicy, U>
    {
        static xaml_binding bind(Windows::Security::ExchangeActiveSyncProvisioning::EasClientSecurityPolicy const& object, hstring const& name)
        {
            if (name == L"RequireEncryption") return
            {
                [object] { return object.RequireEncryption(); },
                [object](auto&& value) { object.RequireEncryption(value); }
            };
            if (name == L"MinPasswordLength") return
            {
                [object] { return object.MinPasswordLength(); },
                [object](auto&& value) { object.MinPasswordLength(value); }
            };
            if (name == L"DisallowConvenienceLogon") return
            {
                [object] { return object.DisallowConvenienceLogon(); },
                [object](auto&& value) { object.DisallowConvenienceLogon(value); }
            };
            if (name == L"MinPasswordComplexCharacters") return
            {
                [object] { return object.MinPasswordComplexCharacters(); },
                [object](auto&& value) { object.MinPasswordComplexCharacters(value); }
            };
            if (name == L"PasswordExpiration") return
            {
                [object] { return object.PasswordExpiration(); },
                [object](auto&& value) { object.PasswordExpiration(value); }
            };
            if (name == L"PasswordHistory") return
            {
                [object] { return object.PasswordHistory(); },
                [object](auto&& value) { object.PasswordHistory(value); }
            };
            if (name == L"MaxPasswordFailedAttempts") return
            {
                [object] { return object.MaxPasswordFailedAttempts(); },
                [object](auto&& value) { object.MaxPasswordFailedAttempts(value); }
            };
            if (name == L"MaxInactivityTimeLock") return
            {
                [object] { return object.MaxInactivityTimeLock(); },
                [object](auto&& value) { object.MaxInactivityTimeLock(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Security::ExchangeActiveSyncProvisioning::EasComplianceResults, U>
    {
        static xaml_binding bind(Windows::Security::ExchangeActiveSyncProvisioning::EasComplianceResults const& object, hstring const& name)
        {
            if (name == L"Compliant") return
            {
                [object] { return object.Compliant(); }
            };
            if (name == L"RequireEncryptionResult") return
            {
                [object] { return object.RequireEncryptionResult(); }
            };
            if (name == L"MinPasswordLengthResult") return
            {
                [object] { return object.MinPasswordLengthResult(); }
            };
            if (name == L"DisallowConvenienceLogonResult") return
            {
                [object] { return object.DisallowConvenienceLogonResult(); }
            };
            if (name == L"MinPasswordComplexCharactersResult") return
            {
                [object] { return object.MinPasswordComplexCharactersResult(); }
            };
            if (name == L"PasswordExpirationResult") return
            {
                [object] { return object.PasswordExpirationResult(); }
            };
            if (name == L"PasswordHistoryResult") return
            {
                [object] { return object.PasswordHistoryResult(); }
            };
            if (name == L"MaxPasswordFailedAttemptsResult") return
            {
                [object] { return object.MaxPasswordFailedAttemptsResult(); }
            };
            if (name == L"MaxInactivityTimeLockResult") return
            {
                [object] { return object.MaxInactivityTimeLockResult(); }
            };
            if (name == L"EncryptionProviderType") return
            {
                [object] { return object.EncryptionProviderType(); }
            };
            return {};
        }
    };
