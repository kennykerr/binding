...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Input::Core::RadialControllerIndependentInputSource, U>
    {
        static xaml_binding bind(Windows::UI::Input::Core::RadialControllerIndependentInputSource const& object, hstring const& name)
        {
