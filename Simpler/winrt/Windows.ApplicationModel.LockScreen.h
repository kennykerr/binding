...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::LockScreen::LockScreenBadge, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::LockScreen::LockScreenBadge const& object, hstring const& name)
        {
            if (name == L"Logo") return
            {
                [object] { return object.Logo(); }
            };
            if (name == L"Glyph") return
            {
                [object] { return object.Glyph(); }
            };
            if (name == L"Number") return
            {
                [object] { return object.Number(); }
            };
            if (name == L"AutomationName") return
            {
                [object] { return object.AutomationName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::LockScreen::LockScreenInfo, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::LockScreen::LockScreenInfo const& object, hstring const& name)
        {
            if (name == L"LockScreenImage") return
            {
                [object] { return object.LockScreenImage(); }
            };
            if (name == L"Badges") return
            {
                [object] { return object.Badges(); }
            };
            if (name == L"DetailText") return
            {
                [object] { return object.DetailText(); }
            };
            if (name == L"AlarmIcon") return
            {
                [object] { return object.AlarmIcon(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::LockScreen::LockScreenUnlockingEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::LockScreen::LockScreenUnlockingEventArgs const& object, hstring const& name)
        {
