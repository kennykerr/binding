...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::ColorSpace() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_ColorSpace(put_abi(value)));
        return value;
    }
    template <typename D> auto consume_Windows_Graphics_Display_Core_IHdmiDisplayMode<D>::PixelEncoding() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Display::Core::IHdmiDisplayMode)->get_PixelEncoding(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Graphics::Display::Core::HdmiDisplayMode, U>
    {
        static xaml_binding bind(Windows::Graphics::Display::Core::HdmiDisplayMode const& object, hstring const& name)
        {
            if (name == L"ResolutionWidthInRawPixels") return
            {
                [object] { return object.ResolutionWidthInRawPixels(); }
            };
            if (name == L"ResolutionHeightInRawPixels") return
            {
                [object] { return object.ResolutionHeightInRawPixels(); }
            };
            ...
            if (name == L"BitsPerPixel") return
            {
                [object] { return object.BitsPerPixel(); }
            };
            ...
            if (name == L"IsSdrLuminanceSupported") return
            {
                [object] { return object.IsSdrLuminanceSupported(); }
            };
            if (name == L"IsSmpte2084Supported") return
            {
                [object] { return object.IsSmpte2084Supported(); }
            };
            if (name == L"Is2086MetadataSupported") return
            {
                [object] { return object.Is2086MetadataSupported(); }
            };
            if (name == L"IsDolbyVisionLowLatencySupported") return
            {
                [object] { return object.IsDolbyVisionLowLatencySupported(); }
            };
            return {};
        }
    };
