...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectAdvertisement, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectAdvertisement const& object, hstring const& name)
        {
            if (name == L"InformationElements") return
            {
                [object] { return object.InformationElements(); },
                [object](auto&& value) { object.InformationElements(value); }
            };
            if (name == L"ListenStateDiscoverability") return
            {
                [object] { return object.ListenStateDiscoverability(); },
                [object](auto&& value) { object.ListenStateDiscoverability(value); }
            };
            if (name == L"IsAutonomousGroupOwnerEnabled") return
            {
                [object] { return object.IsAutonomousGroupOwnerEnabled(); },
                [object](auto&& value) { object.IsAutonomousGroupOwnerEnabled(value); }
            };
            if (name == L"LegacySettings") return
            {
                [object] { return object.LegacySettings(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectAdvertisementPublisher, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectAdvertisementPublisher const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectAdvertisementPublisherStatusChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectAdvertisementPublisherStatusChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"Status") return
            {
                [object] { return object.Status(); }
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectConnectionParameters, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectConnectionParameters const& object, hstring const& name)
        {
            if (name == L"GroupOwnerIntent") return
            {
                [object] { return object.GroupOwnerIntent(); },
                [object](auto&& value) { object.GroupOwnerIntent(value); }
            };
            if (name == L"PreferenceOrderedConfigurationMethods") return
            {
                [object] { return object.PreferenceOrderedConfigurationMethods(); }
            };
            if (name == L"PreferredPairingProcedure") return
            {
                [object] { return object.PreferredPairingProcedure(); },
                [object](auto&& value) { object.PreferredPairingProcedure(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectConnectionRequest, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectConnectionRequest const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectDevice, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectDevice const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectInformationElement, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectInformationElement const& object, hstring const& name)
        {
            if (name == L"Oui") return
            {
                [object] { return object.Oui(); },
                [object](auto&& value) { object.Oui(value); }
            };
            if (name == L"OuiType") return
            {
                [object] { return object.OuiType(); },
                [object](auto&& value) { object.OuiType(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::WiFiDirect::WiFiDirectLegacySettings, U>
    {
        static xaml_binding bind(Windows::Devices::WiFiDirect::WiFiDirectLegacySettings const& object, hstring const& name)
        {
