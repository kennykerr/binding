...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Lights::Lamp, U>
    {
        static xaml_binding bind(Windows::Devices::Lights::Lamp const& object, hstring const& name)
        {
            ...
            if (name == L"BrightnessLevel") return
            {
                ...
                [object](auto&& value) { object.BrightnessLevel(value); }
            };
            if (name == L"IsColorSettable") return
            {
                [object] { return object.IsColorSettable(); }
            };
    ...
    template <typename U> struct bindable<Windows::Devices::Lights::LampArray, U>
    {
        static xaml_binding bind(Windows::Devices::Lights::LampArray const& object, hstring const& name)
        {
            if (name == L"DeviceId") return
            {
                [object] { return object.DeviceId(); }
            ...
            if (name == L"LampArrayKind") return
            {
                [object] { return object.LampArrayKind(); }
            };
            if (name == L"LampCount") return
            {
                [object] { return object.LampCount(); }
            };
            if (name == L"MinUpdateInterval") return
            {
                [object] { return object.MinUpdateInterval(); }
            };
            ...
            if (name == L"SupportsVirtualKeys") return
            {
                [object] { return object.SupportsVirtualKeys(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Devices::Lights::LampAvailabilityChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::Devices::Lights::LampAvailabilityChangedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Lights::LampInfo, U>
    {
        static xaml_binding bind(Windows::Devices::Lights::LampInfo const& object, hstring const& name)
        {
            if (name == L"Index") return
            {
                [object] { return object.Index(); }
            };
            if (name == L"Purposes") return
            {
                [object] { return object.Purposes(); }
            };
            if (name == L"Position") return
            {
                [object] { return object.Position(); }
            };
            if (name == L"RedLevelCount") return
            {
                [object] { return object.RedLevelCount(); }
            };
            if (name == L"GreenLevelCount") return
            {
                [object] { return object.GreenLevelCount(); }
            };
            if (name == L"BlueLevelCount") return
            {
                [object] { return object.BlueLevelCount(); }
            };
            if (name == L"GainLevelCount") return
            {
                [object] { return object.GainLevelCount(); }
            };
            if (name == L"FixedColor") return
            {
                [object] { return object.FixedColor(); }
            };
            if (name == L"UpdateLatency") return
            {
                [object] { return object.UpdateLatency(); }
            };
            return {};
        }
    };
