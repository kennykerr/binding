...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivity, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivity const& object, hstring const& name)
        {
            ...
            if (name == L"ActivationUri") return
            {
                [object] { return object.ActivationUri(); },
                [object](auto&& value) { object.ActivationUri(value); }
            };
            if (name == L"ContentInfo") return
            {
                [object] { return object.ContentInfo(); },
                [object](auto&& value) { object.ContentInfo(value); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivityAttribution, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivityAttribution const& object, hstring const& name)
        {
            ...
            if (name == L"AlternateText") return
            {
                [object] { return object.AlternateText(); },
                [object](auto&& value) { object.AlternateText(value); }
            };
            if (name == L"AddImageQuery") return
            {
                [object] { return object.AddImageQuery(); },
                [object](auto&& value) { object.AddImageQuery(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivityRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivityRequestedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivitySession, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivitySession const& object, hstring const& name)
        {
            if (name == L"ActivityId") return
            {
                [object] { return object.ActivityId(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivitySessionHistoryItem, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivitySessionHistoryItem const& object, hstring const& name)
        {
            if (name == L"UserActivity") return
            {
                [object] { return object.UserActivity(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::UserActivities::UserActivityVisualElements, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::UserActivities::UserActivityVisualElements const& object, hstring const& name)
        {
            ...
            if (name == L"Attribution") return
            {
                [object] { return object.Attribution(); },
                [object](auto&& value) { object.Attribution(value); }
            };
            ...
            if (name == L"AttributionDisplayText") return
            {
                [object] { return object.AttributionDisplayText(); },
                [object](auto&& value) { object.AttributionDisplayText(value); }
            };
            return {};
        }
    };
