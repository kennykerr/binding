...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Devices::Custom::CustomDevice, U>
    {
        static xaml_binding bind(Windows::Devices::Custom::CustomDevice const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Devices::Custom::IOControlCode, U>
    {
        static xaml_binding bind(Windows::Devices::Custom::IOControlCode const& object, hstring const& name)
        {
            if (name == L"AccessMode") return
            {
                [object] { return object.AccessMode(); }
            };
            if (name == L"BufferingMethod") return
            {
                [object] { return object.BufferingMethod(); }
            };
            if (name == L"Function") return
            {
                [object] { return object.Function(); }
            };
            if (name == L"DeviceType") return
            {
                [object] { return object.DeviceType(); }
            };
            if (name == L"ControlCode") return
            {
                [object] { return object.ControlCode(); }
            };
            return {};
        }
    };
