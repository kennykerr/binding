...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs const& object, hstring const& name)
        {
            if (name == L"ViewId") return
            {
                [object] { return object.ViewId(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview const& object, hstring const& name)
        {
            if (name == L"IsScreenLocked") return
            {
                [object] { return object.IsScreenLocked(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions const& object, hstring const& name)
        {
            if (name == L"ShowWithFocus") return
            {
                [object] { return object.ShowWithFocus(); },
                [object](auto&& value) { object.ShowWithFocus(value); }
            };
            return {};
        }
    };
