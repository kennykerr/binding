...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Appointments::AppointmentsProvider::AddAppointmentOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Appointments::AppointmentsProvider::AddAppointmentOperation const& object, hstring const& name)
        {
            if (name == L"AppointmentInformation") return
            {
                [object] { return object.AppointmentInformation(); }
            };
            if (name == L"SourcePackageFamilyName") return
            {
                [object] { return object.SourcePackageFamilyName(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Appointments::AppointmentsProvider::RemoveAppointmentOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Appointments::AppointmentsProvider::RemoveAppointmentOperation const& object, hstring const& name)
        {
            if (name == L"AppointmentId") return
            {
                [object] { return object.AppointmentId(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Appointments::AppointmentsProvider::ReplaceAppointmentOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Appointments::AppointmentsProvider::ReplaceAppointmentOperation const& object, hstring const& name)
        {
            if (name == L"AppointmentId") return
            {
                [object] { return object.AppointmentId(); }
