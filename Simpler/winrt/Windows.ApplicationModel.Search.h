...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::LocalContentSuggestionSettings, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::LocalContentSuggestionSettings const& object, hstring const& name)
        {
            ...
            if (name == L"AqsFilter") return
            {
                [object] { return object.AqsFilter(); },
                [object](auto&& value) { object.AqsFilter(value); }
            };
            if (name == L"PropertiesToMatch") return
            {
                [object] { return object.PropertiesToMatch(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPane, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPane const& object, hstring const& name)
        {
            if (name == L"SearchHistoryEnabled") return
            {
                [object] { return object.SearchHistoryEnabled(); },
                [object](auto&& value) { object.SearchHistoryEnabled(value); }
            };
            if (name == L"SearchHistoryContext") return
            {
                [object] { return object.SearchHistoryContext(); },
                [object](auto&& value) { object.SearchHistoryContext(value); }
            };
            ...
            if (name == L"ShowOnKeyboardInput") return
            {
                [object] { return object.ShowOnKeyboardInput(); },
                [object](auto&& value) { object.ShowOnKeyboardInput(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneQueryChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneQueryChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"QueryText") return
            {
                [object] { return object.QueryText(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneQueryLinguisticDetails const& object, hstring const& name)
        {
            if (name == L"QueryTextAlternatives") return
            {
                [object] { return object.QueryTextAlternatives(); }
            };
            if (name == L"QueryTextCompositionStart") return
            {
                [object] { return object.QueryTextCompositionStart(); }
            };
            if (name == L"QueryTextCompositionLength") return
            {
                [object] { return object.QueryTextCompositionLength(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneQuerySubmittedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneQuerySubmittedEventArgs const& object, hstring const& name)
        {
            if (name == L"QueryText") return
            {
                [object] { return object.QueryText(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneResultSuggestionChosenEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneResultSuggestionChosenEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneSuggestionsRequest, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneSuggestionsRequest const& object, hstring const& name)
        {
            if (name == L"IsCanceled") return
            {
                [object] { return object.IsCanceled(); }
            };
            if (name == L"SearchSuggestionCollection") return
            {
                [object] { return object.SearchSuggestionCollection(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneSuggestionsRequestedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneSuggestionsRequestedEventArgs const& object, hstring const& name)
        {
            if (name == L"QueryText") return
            {
                [object] { return object.QueryText(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchPaneVisibilityChangedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchPaneVisibilityChangedEventArgs const& object, hstring const& name)
        {
            if (name == L"Visible") return
            {
                [object] { return object.Visible(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchQueryLinguisticDetails, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchQueryLinguisticDetails const& object, hstring const& name)
        {
            if (name == L"QueryTextAlternatives") return
            {
                [object] { return object.QueryTextAlternatives(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchSuggestionCollection, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchSuggestionCollection const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Search::SearchSuggestionsRequest, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Search::SearchSuggestionsRequest const& object, hstring const& name)
        {
            if (name == L"IsCanceled") return
            {
                [object] { return object.IsCanceled(); }
