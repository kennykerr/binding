...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Data_Pdf_IPdfPage<D>::Rotation() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Data::Pdf::IPdfPage)->get_Rotation(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::Data::Pdf::PdfDocument, U>
    {
        static xaml_binding bind(Windows::Data::Pdf::PdfDocument const& object, hstring const& name)
        {
            if (name == L"PageCount") return
            {
                [object] { return object.PageCount(); }
            };
            if (name == L"IsPasswordProtected") return
            {
                [object] { return object.IsPasswordProtected(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Pdf::PdfPage, U>
    {
        static xaml_binding bind(Windows::Data::Pdf::PdfPage const& object, hstring const& name)
        {
            ...
            if (name == L"Dimensions") return
            {
                [object] { return object.Dimensions(); }
            };
            if (name == L"Rotation") return
            {
                [object] { return object.Rotation(); }
            };
            if (name == L"PreferredZoom") return
            {
                [object] { return object.PreferredZoom(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Pdf::PdfPageDimensions, U>
    {
        static xaml_binding bind(Windows::Data::Pdf::PdfPageDimensions const& object, hstring const& name)
        {
            if (name == L"MediaBox") return
            {
                [object] { return object.MediaBox(); }
            };
            if (name == L"CropBox") return
            {
                [object] { return object.CropBox(); }
            };
            if (name == L"BleedBox") return
            {
                [object] { return object.BleedBox(); }
            };
            if (name == L"TrimBox") return
            {
                [object] { return object.TrimBox(); }
            };
            if (name == L"ArtBox") return
            {
                [object] { return object.ArtBox(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Data::Pdf::PdfPageRenderOptions, U>
    {
        static xaml_binding bind(Windows::Data::Pdf::PdfPageRenderOptions const& object, hstring const& name)
        {
            if (name == L"SourceRect") return
            {
                [object] { return object.SourceRect(); },
                [object](auto&& value) { object.SourceRect(value); }
            };
            if (name == L"DestinationWidth") return
            {
                [object] { return object.DestinationWidth(); },
                [object](auto&& value) { object.DestinationWidth(value); }
            };
            if (name == L"DestinationHeight") return
            {
                [object] { return object.DestinationHeight(); },
                [object](auto&& value) { object.DestinationHeight(value); }
            };
            ...
            if (name == L"IsIgnoringHighContrast") return
            {
                [object] { return object.IsIgnoringHighContrast(); },
                [object](auto&& value) { object.IsIgnoringHighContrast(value); }
            };
            if (name == L"BitmapEncoderId") return
            {
                [object] { return object.BitmapEncoderId(); },
                [object](auto&& value) { object.BitmapEncoderId(value); }
            };
            return {};
        }
    };
