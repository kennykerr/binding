...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IGeotagHelperStatics<D>::GetGeotagAsync(Windows::Storage::IStorageFile const& file) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IGeotagHelperStatics<D>::SetGeotagFromGeolocatorAsync(Windows::Storage::IStorageFile const& file, Windows::Devices::Geolocation::Geolocator const& geolocator) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IGeotagHelperStatics<D>::SetGeotagAsync(Windows::Storage::IStorageFile const& file, Windows::Devices::Geolocation::Geopoint const& geopoint) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IImageProperties<D>::DateTaken(Windows::Foundation::DateTime const& value) const
    {
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IImageProperties<D>::Orientation() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::FileProperties::IImageProperties)->get_Orientation(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IStorageItemExtraProperties<D>::SavePropertiesAsync(param::async_iterable<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::Foundation::IInspectable>> const& propertiesToSave) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IThumbnailProperties<D>::Type() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::FileProperties::IThumbnailProperties)->get_Type(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Storage_FileProperties_IVideoProperties<D>::Orientation() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::FileProperties::IVideoProperties)->get_Orientation(put_abi(value)));
        return value;
    }
    template <typename D>
    ...
    template <typename U> struct bindable<Windows::Storage::FileProperties::BasicProperties, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::BasicProperties const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
            };
            if (name == L"DateModified") return
            {
                [object] { return object.DateModified(); }
            };
            if (name == L"ItemDate") return
            {
                [object] { return object.ItemDate(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::Storage::FileProperties::DocumentProperties, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::DocumentProperties const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::Storage::FileProperties::ImageProperties, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::ImageProperties const& object, hstring const& name)
        {
            if (name == L"Rating") return
            {
                [object] { return object.Rating(); },
                [object](auto&& value) { object.Rating(value); }
            };
            if (name == L"Keywords") return
            {
                [object] { return object.Keywords(); }
            ...
            if (name == L"DateTaken") return
            {
                ...
                [object](auto&& value) { object.DateTaken(value); }
            };
            ...
            if (name == L"CameraManufacturer") return
            {
                ...
                [object](auto&& value) { object.CameraManufacturer(value); }
            };
            if (name == L"CameraModel") return
            {
                [object] { return object.CameraModel(); },
                [object](auto&& value) { object.CameraModel(value); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::FileProperties::MusicProperties, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::MusicProperties const& object, hstring const& name)
        {
            if (name == L"Album") return
            {
                [object] { return object.Album(); },
                [object](auto&& value) { object.Album(value); }
            };
            ...
            if (name == L"Composers") return
            {
                [object] { return object.Composers(); }
            };
            if (name == L"Conductors") return
            {
                [object] { return object.Conductors(); }
            };
            ...
            if (name == L"Producers") return
            {
                [object] { return object.Producers(); }
            };
            if (name == L"Publisher") return
            {
                [object] { return object.Publisher(); },
                [object](auto&& value) { object.Publisher(value); }
            };
            if (name == L"Writers") return
            {
                [object] { return object.Writers(); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::FileProperties::StorageItemThumbnail, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::StorageItemThumbnail const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); },
            ...
            if (name == L"OriginalWidth") return
            {
                [object] { return object.OriginalWidth(); }
            };
            if (name == L"OriginalHeight") return
            {
                [object] { return object.OriginalHeight(); }
            };
            if (name == L"ReturnedSmallerCachedSize") return
            {
                [object] { return object.ReturnedSmallerCachedSize(); }
            };
    ...
    template <typename U> struct bindable<Windows::Storage::FileProperties::VideoProperties, U>
    {
        static xaml_binding bind(Windows::Storage::FileProperties::VideoProperties const& object, hstring const& name)
        {
            if (name == L"Rating") return
            {
                [object] { return object.Rating(); },
            ...
            if (name == L"Directors") return
            {
                [object] { return object.Directors(); }
            };
            if (name == L"Orientation") return
            {
                [object] { return object.Orientation(); }
