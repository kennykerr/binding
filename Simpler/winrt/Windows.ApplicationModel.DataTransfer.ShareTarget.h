...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IQuickLink<D>::Thumbnail(Windows::Storage::Streams::RandomAccessStreamReference const& value) const
    {
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_ShareTarget_IShareOperation<D>::ReportCompleted(Windows::ApplicationModel::DataTransfer::ShareTarget::QuickLink const& quicklink) const
    {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::DataTransfer::ShareTarget::QuickLink, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::DataTransfer::ShareTarget::QuickLink const& object, hstring const& name)
        {
            ...
            if (name == L"SupportedDataFormats") return
            {
                [object] { return object.SupportedDataFormats(); }
            };
            if (name == L"SupportedFileTypes") return
            {
                [object] { return object.SupportedFileTypes(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::DataTransfer::ShareTarget::ShareOperation, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::DataTransfer::ShareTarget::ShareOperation const& object, hstring const& name)
        {
            if (name == L"Data") return
            {
                [object] { return object.Data(); }
            };
            if (name == L"QuickLinkId") return
            {
                [object] { return object.QuickLinkId(); }
            };
