...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryClientStatics<D>::Register(param::hstring const& id, Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationSettings const& settings) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_System_Diagnostics_Telemetry_IPlatformTelemetryRegistrationResult<D>::Status() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::System::Diagnostics::Telemetry::IPlatformTelemetryRegistrationResult)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationResult, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationResult const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationSettings, U>
    {
        static xaml_binding bind(Windows::System::Diagnostics::Telemetry::PlatformTelemetryRegistrationSettings const& object, hstring const& name)
        {
            if (name == L"StorageSize") return
            {
                [object] { return object.StorageSize(); },
                [object](auto&& value) { object.StorageSize(value); }
            };
            if (name == L"UploadQuotaSize") return
            {
                [object] { return object.UploadQuotaSize(); },
                [object](auto&& value) { object.UploadQuotaSize(value); }
            };
            return {};
        }
    };
