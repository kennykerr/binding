...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommand, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommand const& object, hstring const& name)
        {
            if (name == L"CommandName") return
            {
                [object] { return object.CommandName(); }
            };
            if (name == L"Properties") return
            {
                [object] { return object.Properties(); }
            };
            if (name == L"SpeechRecognitionResult") return
            {
                [object] { return object.SpeechRecognitionResult(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandCompletedEventArgs, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandCompletedEventArgs const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandConfirmationResult, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandConfirmationResult const& object, hstring const& name)
        {
            if (name == L"Confirmed") return
            {
                [object] { return object.Confirmed(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTile, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandContentTile const& object, hstring const& name)
        {
            ...
            if (name == L"TextLine1") return
            {
                [object] { return object.TextLine1(); },
                [object](auto&& value) { object.TextLine1(value); }
            };
            if (name == L"TextLine2") return
            {
                [object] { return object.TextLine2(); },
                [object](auto&& value) { object.TextLine2(value); }
            };
            if (name == L"TextLine3") return
            {
                [object] { return object.TextLine3(); },
                [object](auto&& value) { object.TextLine3(value); }
            };
            ...
            if (name == L"AppContext") return
            {
                [object] { return object.AppContext(); },
                [object](auto&& value) { object.AppContext(value); }
            };
            if (name == L"AppLaunchArgument") return
            {
                [object] { return object.AppLaunchArgument(); },
                [object](auto&& value) { object.AppLaunchArgument(value); }
            };
            if (name == L"ContentTileType") return
            {
                [object] { return object.ContentTileType(); },
                [object](auto&& value) { object.ContentTileType(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandDefinition, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandDefinition const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandDisambiguationResult, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandDisambiguationResult const& object, hstring const& name)
        {
            if (name == L"SelectedItem") return
            {
                [object] { return object.SelectedItem(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandResponse, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandResponse const& object, hstring const& name)
        {
            ...
            if (name == L"RepeatMessage") return
            {
                [object] { return object.RepeatMessage(); },
                [object](auto&& value) { object.RepeatMessage(value); }
            };
            if (name == L"AppLaunchArgument") return
            {
                [object] { return object.AppLaunchArgument(); },
            ...
            if (name == L"VoiceCommandContentTiles") return
            {
                [object] { return object.VoiceCommandContentTiles(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandServiceConnection, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandServiceConnection const& object, hstring const& name)
        {
            if (name == L"Language") return
            {
                [object] { return object.Language(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::VoiceCommands::VoiceCommandUserMessage const& object, hstring const& name)
        {
            ...
            if (name == L"SpokenMessage") return
            {
                [object] { return object.SpokenMessage(); },
                [object](auto&& value) { object.SpokenMessage(value); }
            };
            return {};
        }
    };
