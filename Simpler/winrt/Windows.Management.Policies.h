...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::Management::Policies::NamedPolicyData, U>
    {
        static xaml_binding bind(Windows::Management::Policies::NamedPolicyData const& object, hstring const& name)
        {
            if (name == L"Area") return
            {
                [object] { return object.Area(); }
            };
            ...
            if (name == L"IsManaged") return
            {
                [object] { return object.IsManaged(); }
            };
            if (name == L"IsUserPolicy") return
            {
                [object] { return object.IsUserPolicy(); }
            };
