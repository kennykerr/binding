...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::UI::Composition::Diagnostics::CompositionDebugSettings, U>
    {
        static xaml_binding bind(Windows::UI::Composition::Diagnostics::CompositionDebugSettings const& object, hstring const& name)
        {
            if (name == L"HeatMaps") return
            {
                [object] { return object.HeatMaps(); }
            };
            return {};
        }
    };
