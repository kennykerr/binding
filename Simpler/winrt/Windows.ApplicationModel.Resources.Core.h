...
namespace winrt::impl
{
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::NamedResource, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::NamedResource const& object, hstring const& name)
        {
            if (name == L"Uri") return
            {
                [object] { return object.Uri(); }
            };
            if (name == L"Candidates") return
            {
                [object] { return object.Candidates(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceCandidate, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceCandidate const& object, hstring const& name)
        {
            if (name == L"Qualifiers") return
            {
                [object] { return object.Qualifiers(); }
            };
            if (name == L"IsMatch") return
            {
                [object] { return object.IsMatch(); }
            };
            if (name == L"IsMatchAsDefault") return
            {
                [object] { return object.IsMatchAsDefault(); }
            };
            if (name == L"IsDefault") return
            {
                [object] { return object.IsDefault(); }
            };
            if (name == L"ValueAsString") return
            {
                [object] { return object.ValueAsString(); }
            };
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceCandidateVectorView, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceCandidateVectorView const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceContext, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceContext const& object, hstring const& name)
        {
            if (name == L"QualifierValues") return
            {
                [object] { return object.QualifierValues(); }
            };
            if (name == L"Languages") return
            {
                [object] { return object.Languages(); },
                [object](auto&& value) { object.Languages(value); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceContextLanguagesVectorView, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceContextLanguagesVectorView const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceManager, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceManager const& object, hstring const& name)
        {
            if (name == L"MainResourceMap") return
            {
                [object] { return object.MainResourceMap(); }
            };
            if (name == L"AllResourceMaps") return
            {
                [object] { return object.AllResourceMaps(); }
            };
            if (name == L"DefaultContext") return
            {
                [object] { return object.DefaultContext(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceMap, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceMap const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceMapIterator, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceMapIterator const& object, hstring const& name)
        {
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceMapMapView, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceMapMapView const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceMapMapViewIterator, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceMapMapViewIterator const& object, hstring const& name)
        {
            if (name == L"Current") return
            {
                [object] { return object.Current(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceQualifier, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceQualifier const& object, hstring const& name)
        {
            if (name == L"QualifierName") return
            {
                [object] { return object.QualifierName(); }
            };
            if (name == L"QualifierValue") return
            {
                [object] { return object.QualifierValue(); }
            };
            if (name == L"IsDefault") return
            {
                [object] { return object.IsDefault(); }
            ...
            if (name == L"Score") return
            {
                [object] { return object.Score(); }
            };
            return {};
        }
    };
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceQualifierMapView, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceQualifierMapView const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceQualifierObservableMap, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceQualifierObservableMap const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
    ...
    template <typename U> struct bindable<Windows::ApplicationModel::Resources::Core::ResourceQualifierVectorView, U>
    {
        static xaml_binding bind(Windows::ApplicationModel::Resources::Core::ResourceQualifierVectorView const& object, hstring const& name)
        {
            if (name == L"Size") return
            {
                [object] { return object.Size(); }
